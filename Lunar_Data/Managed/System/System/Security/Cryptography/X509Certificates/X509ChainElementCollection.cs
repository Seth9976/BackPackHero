...
namespace System.Security.Cryptography.X509Certificates
{
	...
	{
		// Token: 0x0600170C RID: 5900 RVA: 0x0005B632 File Offset: 0x00059832
		...
		// (get) Token: 0x0600170D RID: 5901 RVA: 0x0005B645 File Offset: 0x00059845
		public int Count
		{
			get
			{
		...
		// (get) Token: 0x0600170E RID: 5902 RVA: 0x0005B652 File Offset: 0x00059852
		...
		// (get) Token: 0x06001710 RID: 5904 RVA: 0x0005B672 File Offset: 0x00059872
		...
		// Token: 0x06001711 RID: 5905 RVA: 0x0005B67F File Offset: 0x0005987F
		...
		/// <exception cref="T:System.ArgumentException">
		///   <paramref name="index" /> plus the current count is greater than the length of the array. </exception>
		// Token: 0x06001712 RID: 5906 RVA: 0x0005B67F File Offset: 0x0005987F
		...
		// Token: 0x06001713 RID: 5907 RVA: 0x0005B68E File Offset: 0x0005988E
		...
		// Token: 0x06001714 RID: 5908 RVA: 0x0005B68E File Offset: 0x0005988E
		IEnumerator IEnumerable.GetEnumerator()
		{
			return new X509ChainElementEnumerator(this._list);
		}

		// Token: 0x06001715 RID: 5909 RVA: 0x0005B69B File Offset: 0x0005989B
		internal void Add(X509Certificate2 certificate)
		{
			this._list.Add(new X509ChainElement(certificate));
		}

		// Token: 0x06001716 RID: 5910 RVA: 0x0005B6AF File Offset: 0x000598AF
		internal void Clear()
		{
			this._list.Clear();
		}

		// Token: 0x06001717 RID: 5911 RVA: 0x0005B6BC File Offset: 0x000598BC
