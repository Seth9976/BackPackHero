...
namespace System.Diagnostics
{
	...
	{
		// Token: 0x060013A2 RID: 5026 RVA: 0x00051828 File Offset: 0x0004FA28
		public NullEventLog(EventLog coreEventLog)
			: base(coreEventLog)
		{
		}

		// Token: 0x060013A3 RID: 5027 RVA: 0x00003917 File Offset: 0x00001B17
		...
		// Token: 0x060013AD RID: 5037 RVA: 0x0000390E File Offset: 0x00001B0E
		public override bool Exists(string logName, string machineName)
		{
			return true;
		}

		// Token: 0x060013AE RID: 5038 RVA: 0x00051A4A File Offset: 0x0004FC4A
		...
		// Token: 0x060013AF RID: 5039 RVA: 0x00003062 File Offset: 0x00001262
		protected override int GetEntryCount()
		{
			return 0;
		}

		// Token: 0x060013B0 RID: 5040 RVA: 0x00002F6A File Offset: 0x0000116A
		protected override EventLogEntry GetEntry(int index)
		{
			return null;
		}

		// Token: 0x060013B1 RID: 5041 RVA: 0x00051C64 File Offset: 0x0004FE64
		protected override string GetLogDisplayName()
		{
			return base.CoreEventLog.Log;
		}

		// Token: 0x060013B2 RID: 5042 RVA: 0x00052264 File Offset: 0x00050464
		protected override string[] GetLogNames(string machineName)
		{
			return new string[0];
		}

		// Token: 0x060013B3 RID: 5043 RVA: 0x00002F6A File Offset: 0x0000116A
		public override string LogNameFromSourceName(string source, string machineName)
		{
			return null;
		}

		// Token: 0x060013B4 RID: 5044 RVA: 0x00003062 File Offset: 0x00001262
		public override bool SourceExists(string source, string machineName)
		{
			return false;
		}

		// Token: 0x060013B5 RID: 5045 RVA: 0x00003917 File Offset: 0x00001B17
		...
		// (get) Token: 0x060013B6 RID: 5046 RVA: 0x00052148 File Offset: 0x00050348
		...
		// (get) Token: 0x060013B7 RID: 5047 RVA: 0x0005214B File Offset: 0x0005034B
		...
		// (get) Token: 0x060013B8 RID: 5048 RVA: 0x00052152 File Offset: 0x00050352
		// (set) Token: 0x060013B9 RID: 5049 RVA: 0x0005215D File Offset: 0x0005035D
		...
		// Token: 0x060013BA RID: 5050 RVA: 0x00052169 File Offset: 0x00050369
		...
		// Token: 0x060013BB RID: 5051 RVA: 0x00052175 File Offset: 0x00050375
