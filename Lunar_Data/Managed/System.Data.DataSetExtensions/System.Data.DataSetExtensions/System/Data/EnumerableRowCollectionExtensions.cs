...
namespace System.Data
{
	...
	public static class EnumerableRowCollectionExtensions
	{
		...
		{
			IEnumerable<TRow> enumerable = source.OrderBy(keySelector);
		...
		{
			IEnumerable<TRow> enumerable = source.OrderBy(keySelector, comparer);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = source.OrderByDescending(keySelector);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = source.OrderByDescending(keySelector, comparer);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = ((IOrderedEnumerable<TRow>)source.EnumerableRows).ThenBy(keySelector);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = ((IOrderedEnumerable<TRow>)source.EnumerableRows).ThenBy(keySelector, comparer);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = ((IOrderedEnumerable<TRow>)source.EnumerableRows).ThenByDescending(keySelector);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<TRow> enumerable = ((IOrderedEnumerable<TRow>)source.EnumerableRows).ThenByDescending(keySelector, comparer);
			OrderedEnumerableRowCollection<TRow> orderedEnumerableRowCollection = new OrderedEnumerableRowCollection<TRow>(source, enumerable);
		...
		{
			IEnumerable<S> enumerable = source.Select(selector);
