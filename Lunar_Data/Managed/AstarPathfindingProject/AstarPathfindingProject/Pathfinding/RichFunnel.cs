...
namespace Pathfinding
{
	...
	{
		// Token: 0x06000197 RID: 407 RVA: 0x000080BC File Offset: 0x000062BC
		public RichFunnel()
		{
		...
		// Token: 0x06000198 RID: 408 RVA: 0x0000810C File Offset: 0x0000630C
		...
		// Token: 0x06000199 RID: 409 RVA: 0x0000815B File Offset: 0x0000635B
		...
		// (get) Token: 0x0600019A RID: 410 RVA: 0x00008194 File Offset: 0x00006394
		...
		// Token: 0x0600019B RID: 411 RVA: 0x000081C0 File Offset: 0x000063C0
		public void BuildFunnelCorridor(List<GraphNode> nodes, int start, int end)
		{
			...
			if (this.funnelSimplification)
			{
				...
				int[] array = ((this.path.seeker != null) ? this.path.seeker.tagPenalties : Path.ZeroTagPenalties);
				int num = ((this.path.seeker != null) ? this.path.seeker.traversableTags : (-1));
				...
				}, this.graph, nodes, list, array, num);
			...
			for (int k = 0; k < this.nodes.Count - 1; k++)
			{
				Vector3 vector;
				Vector3 vector2;
				if (this.nodes[k].GetPortal(this.nodes[k + 1], out vector, out vector2))
				{
					this.left.Add(vector);
					this.right.Add(vector2);
				}
				else
				{
		...
		// Token: 0x0600019C RID: 412 RVA: 0x000084C0 File Offset: 0x000066C0
		private void UpdateFunnelCorridor(int splitIndex, List<TriangleMeshNode> prefix)
		{
			...
			for (int i = 0; i < this.nodes.Count - 1; i++)
			{
				Vector3 vector;
				Vector3 vector2;
				if (this.nodes[i].GetPortal(this.nodes[i + 1], out vector, out vector2))
				{
					this.left.Add(vector);
					this.right.Add(vector2);
				}
		...
		// Token: 0x0600019D RID: 413 RVA: 0x00008598 File Offset: 0x00006798
		...
		// (get) Token: 0x0600019E RID: 414 RVA: 0x000085D4 File Offset: 0x000067D4
		...
		// Token: 0x0600019F RID: 415 RVA: 0x00008614 File Offset: 0x00006814
		...
		// Token: 0x060001A0 RID: 416 RVA: 0x0000866C File Offset: 0x0000686C
		...
		// Token: 0x060001A1 RID: 417 RVA: 0x00008768 File Offset: 0x00006968
		...
		// Token: 0x060001A2 RID: 418 RVA: 0x000089A5 File Offset: 0x00006BA5
		...
		// Token: 0x060001A3 RID: 419 RVA: 0x000089BC File Offset: 0x00006BBC
