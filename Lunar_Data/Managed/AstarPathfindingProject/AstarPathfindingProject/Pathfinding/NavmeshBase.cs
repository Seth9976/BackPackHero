...
namespace Pathfinding
{
	...
	public abstract class NavmeshBase : NavGraph, INavmesh, INavmeshHolder, ITransformedGraph, IRaycastableGraph
	{
		...
		// (get) Token: 0x060006B4 RID: 1716 RVA: 0x00022386 File Offset: 0x00020586
		...
		// (get) Token: 0x060006B6 RID: 1718 RVA: 0x0002238E File Offset: 0x0002058E
		...
		// Token: 0x060006B8 RID: 1720 RVA: 0x00022399 File Offset: 0x00020599
		public NavmeshTile GetTile(int x, int z)
		{
			return this.tiles[x + z * this.tileXCount];
		}

		// Token: 0x060006B9 RID: 1721 RVA: 0x000223AC File Offset: 0x000205AC
		...
		// Token: 0x060006BA RID: 1722 RVA: 0x000223D4 File Offset: 0x000205D4
		...
		// Token: 0x060006BB RID: 1723 RVA: 0x000223FA File Offset: 0x000205FA
		public static int GetTileIndex(int index)
		{
			return (index >> 12) & 524287;
		}

		// Token: 0x060006BC RID: 1724 RVA: 0x00022406 File Offset: 0x00020606
		public int GetVertexArrayIndex(int index)
		{
			return index & 4095;
		}

		// Token: 0x060006BD RID: 1725 RVA: 0x0002240F File Offset: 0x0002060F
		...
		// Token: 0x060006BE RID: 1726 RVA: 0x00022428 File Offset: 0x00020628
		public NavmeshTile[] GetTiles()
		{
			return this.tiles;
		}

		// Token: 0x060006BF RID: 1727 RVA: 0x00022430 File Offset: 0x00020630
		public Bounds GetTileBounds(IntRect rect)
		{
			return this.GetTileBounds(rect.xmin, rect.ymin, rect.Width, rect.Height);
		}

		// Token: 0x060006C0 RID: 1728 RVA: 0x00022452 File Offset: 0x00020652
		...
		// Token: 0x060006C1 RID: 1729 RVA: 0x0002246A File Offset: 0x0002066A
		...
		// Token: 0x060006C2 RID: 1730 RVA: 0x0002248C File Offset: 0x0002068C
		...
		// Token: 0x060006C3 RID: 1731 RVA: 0x000224EC File Offset: 0x000206EC
		...
		// Token: 0x060006C4 RID: 1732 RVA: 0x0002253C File Offset: 0x0002073C
		...
		// Token: 0x060006C5 RID: 1733 RVA: 0x00022550 File Offset: 0x00020750
		...
		// Token: 0x060006C6 RID: 1734 RVA: 0x000225D6 File Offset: 0x000207D6
		public override void RelocateNodes(Matrix4x4 deltaMatrix)
		{
			this.RelocateNodes(deltaMatrix * this.transform);
		}

		// Token: 0x060006C7 RID: 1735 RVA: 0x000225EC File Offset: 0x000207EC
		...
		// Token: 0x060006C8 RID: 1736 RVA: 0x00022684 File Offset: 0x00020884
		...
		// Token: 0x060006C9 RID: 1737 RVA: 0x000226F8 File Offset: 0x000208F8
		...
		// Token: 0x060006CA RID: 1738 RVA: 0x00022778 File Offset: 0x00020978
		...
		// Token: 0x060006CB RID: 1739 RVA: 0x0002281C File Offset: 0x00020A1C
		...
		// Token: 0x060006CC RID: 1740 RVA: 0x00022898 File Offset: 0x00020A98
		...
		// Token: 0x060006CD RID: 1741 RVA: 0x00022938 File Offset: 0x00020B38
		...
		// Token: 0x060006CE RID: 1742 RVA: 0x000229EC File Offset: 0x00020BEC
		public override float NearestNodeDistanceSqrLowerBound(Vector3 position, NNConstraint constraint)
		{
			...
			return projectionParams.SquaredRectPointDistanceOnPlane(new IntRect(0, 0, (int)((float)(1000 * this.tileXCount) * this.TileWorldSizeX), (int)((float)(1000 * this.tileZCount) * this.TileWorldSizeZ)), @float);
		}

		// Token: 0x060006CF RID: 1743 RVA: 0x00022A60 File Offset: 0x00020C60
				...
				for (int j = Math.Max(-i + num2, 0); j < num6; j++)
				{
					...
					do
					{
						...
						if (num9 >= 0 && num9 < this.tileXCount)
						{
							...
							if (navmeshTile != null && navmeshTile.bbTree.DistanceSqrLowerBound(@float, in projectionParams) <= num4)
							{
								NavmeshTile navmeshTile2 = navmeshTile;
								float3 float2 = @float;
								GraphNode[] nodes = navmeshTile.nodes;
								navmeshTile2.bbTree.QueryClosest(float2, constraint, in projectionParams, ref num4, ref empty, nodes, navmeshTile.tris, navmeshTile.vertsInGraphSpace);
							}
						}
						num8 = -num8;
					}
		...
		// Token: 0x060006D0 RID: 1744 RVA: 0x00022C44 File Offset: 0x00020E44
		...
		// Token: 0x060006D1 RID: 1745 RVA: 0x00022CB0 File Offset: 0x00020EB0
		...
		// Token: 0x060006D2 RID: 1746 RVA: 0x00022CF8 File Offset: 0x00020EF8
		...
		// Token: 0x060006D3 RID: 1747 RVA: 0x00022E94 File Offset: 0x00021094
		internal static void ConnectTiles(NavmeshTile tile1, NavmeshTile tile2, float tileWorldSizeX, float tileWorldSizeZ, float maxTileConnectionEdgeDistance)
		{
			...
			for (int i = 0; i < nodes2.Length; i++)
			{
				...
				for (int j = 0; j < vertexCount; j++)
				{
					Int3 vertexInGraphSpace = tile2.GetVertexInGraphSpace(triangleMeshNode.GetVertexIndex(j));
					Int3 vertexInGraphSpace2 = tile2.GetVertexInGraphSpace(triangleMeshNode.GetVertexIndex((j + 1) % vertexCount));
			...
			foreach (TriangleMeshNode triangleMeshNode2 in nodes)
			{
				...
				for (int l = 0; l < vertexCount2; l++)
				{
					Int3 vertexInGraphSpace3 = tile1.GetVertexInGraphSpace(triangleMeshNode2.GetVertexIndex(l));
					Int3 vertexInGraphSpace4 = tile1.GetVertexInGraphSpace(triangleMeshNode2.GetVertexIndex((l + 1) % vertexCount2));
					if (Math.Abs(vertexInGraphSpace3[num5] - num10) < 2 && Math.Abs(vertexInGraphSpace4[num5] - num10) < 2)
					{
						...
						if (num12 != num13)
						{
							for (int m = 0; m < num11; m++)
							{
								...
								{
									Int3 vertexInGraphSpace5 = tile2.GetVertexInGraphSpace(triangleMeshNode3.GetVertexIndex(n));
									Int3 vertexInGraphSpace6 = tile2.GetVertexInGraphSpace(triangleMeshNode3.GetVertexIndex((n + 1) % vertexCount3));
									if (Math.Abs(vertexInGraphSpace5[num5] - num10) < 2 && Math.Abs(vertexInGraphSpace6[num5] - num10) < 2)
									{
										...
										if (num14 != num15 && num13 > num14 && num12 < num15)
										{
											...
											if (flag || VectorMath.SqrDistanceSegmentSegment((Vector3)vertexInGraphSpace3, (Vector3)vertexInGraphSpace4, (Vector3)vertexInGraphSpace5, (Vector3)vertexInGraphSpace6) < maxTileConnectionEdgeDistance * maxTileConnectionEdgeDistance)
											{
												...
												triangleMeshNode2.AddPartialConnection(triangleMeshNode3, costMagnitude, Connection.PackShapeEdgeInfo((byte)l, (byte)n, flag, true, true));
												triangleMeshNode3.AddPartialConnection(triangleMeshNode2, costMagnitude, Connection.PackShapeEdgeInfo((byte)n, (byte)l, flag, true, true));
											}
										}
									}
								}
		...
		// Token: 0x060006D4 RID: 1748 RVA: 0x0002330E File Offset: 0x0002150E
		...
		// Token: 0x060006D5 RID: 1749 RVA: 0x0002332C File Offset: 0x0002152C
		...
		// Token: 0x060006D6 RID: 1750 RVA: 0x000233C4 File Offset: 0x000215C4
		...
		// Token: 0x060006D7 RID: 1751 RVA: 0x0002341C File Offset: 0x0002161C
		public void EndBatchTileUpdate()
		{
			...
			for (int j = 0; j < this.batchUpdatedTiles.Count; j++)
			{
				...
				if (j == 0)
				{
					intRect = new IntRect(num, num2, num, num2);
				}
				else
				{
					intRect = intRect.ExpandToContain(num, num2);
				}
				if (num > 0)
				{
			...
			base.DirtyBounds(this.GetTileBounds(intRect));
		}

		// Token: 0x060006D8 RID: 1752 RVA: 0x000235F8 File Offset: 0x000217F8
		public void ClearTiles(IntRect tileRect)
		{
			...
			IntRect intRect = new IntRect(0, 0, this.tileXCount - 1, this.tileZCount - 1);
			tileRect = IntRect.Intersection(tileRect, intRect);
		...
		// Token: 0x060006D9 RID: 1753 RVA: 0x0002367C File Offset: 0x0002187C
		...
		// Token: 0x060006DA RID: 1754 RVA: 0x000236EC File Offset: 0x000218EC
		private unsafe void PrepareNodeRecycling(int x, int z, UnsafeSpan<Int3> verts, UnsafeSpan<int> tris, TriangleMeshNode[] recycledNodeBuffer)
		{
			...
			for (int j = 0; j < nodes.Length; j++)
			{
				...
				int num2 = (@int.GetHashCode() * 31) ^ (int2.GetHashCode() * 196613) ^ (int3.GetHashCode() * 3145739);
				int num3;
		...
		// Token: 0x060006DB RID: 1755 RVA: 0x0002393C File Offset: 0x00021B3C
		public unsafe void ReplaceTile(int x, int z, Int3[] verts, int[] tris)
		{
			base.AssertSafeToUpdateGraph();
			int num = 1;
			int num2 = 1;
			...
			NavmeshBase.CreateNodes(navmeshTile, navmeshTile.tris, x + z * this.tileXCount, (uint)this.active.data.GetGraphIndex(this), default(UnsafeSpan<uint>), true, this.active, this.initialPenalty, this.RecalculateNormals);
		...
		internal unsafe static void CreateNodes(NavmeshTile tile, UnsafeSpan<int> tris, int tileIndex, uint graphIndex, UnsafeSpan<uint> tags, bool initializeNodes, AstarPath astar, uint initialPenalty, bool recalculateNormals)
		{
			TriangleMeshNode[] nodes = tile.nodes;
			...
			for (int i = 0; i < nodes.Length; i++)
			{
				...
				triangleMeshNode.Tag = ((tags.length > 0U) ? (*tags[i]) : 0U);
		...
		// Token: 0x060006DD RID: 1757 RVA: 0x00023DCC File Offset: 0x00021FCC
		public NavmeshBase()
		{
			this.navmeshUpdateData = new NavmeshUpdates.NavmeshUpdateSettings(this);
		}

		// Token: 0x060006DE RID: 1758 RVA: 0x00023E46 File Offset: 0x00022046
		public bool Linecast(Vector3 start, Vector3 end)
		{
			return this.Linecast(start, end, null);
		}

		// Token: 0x060006DF RID: 1759 RVA: 0x00023E51 File Offset: 0x00022051
		...
		// Token: 0x060006E0 RID: 1760 RVA: 0x00023E60 File Offset: 0x00022060
		...
		// Token: 0x060006E1 RID: 1761 RVA: 0x00023E7A File Offset: 0x0002207A
		...
		// Token: 0x060006E2 RID: 1762 RVA: 0x00023E8A File Offset: 0x0002208A
		...
		// Token: 0x060006E3 RID: 1763 RVA: 0x00023E9A File Offset: 0x0002209A
		...
		// Token: 0x060006E4 RID: 1764 RVA: 0x00023E51 File Offset: 0x00022051
		...
		// Token: 0x060006E5 RID: 1765 RVA: 0x00023EAC File Offset: 0x000220AC
		static NavmeshBase()
		{
		...
		// Token: 0x060006E6 RID: 1766 RVA: 0x00023FA8 File Offset: 0x000221A8
				...
				for (int i = 0; i < connections.Length; i++)
				{
					if (connections[i].isEdgeShared && connections[i].isOutgoing && connections[i].shapeEdge == num3)
					{
						...
						if (triangleMeshNode2 != null && triangleMeshNode2.Walkable && (filter == null || filter(triangleMeshNode2)))
						{
							...
							Side side = VectorMath.SideXZ(@int, int2, triangleMeshNode2.GetVertexInGraphSpace(adjacentShapeEdge));
							Side side2 = VectorMath.SideXZ(@int, int2, triangleMeshNode2.GetVertexInGraphSpace((adjacentShapeEdge + 1) % 3));
		...
		// Token: 0x060006E7 RID: 1767 RVA: 0x000243A4 File Offset: 0x000225A4
				...
				for (int i = 0; i < this.tiles.Length; i++)
				{
					if (this.tiles[i] != null)
					{
						...
						if (num2 > 1024 || i % this.tileXCount == this.tileXCount - 1 || i == this.tiles.Length - 1)
						{
							...
							{
								using (GraphGizmoHelper gizmoHelper = GraphGizmoHelper.GetGizmoHelper(gizmos, this.active, nodeHasher2, redrawScope))
								{
		...
		// Token: 0x060006E8 RID: 1768 RVA: 0x00024634 File Offset: 0x00022834
		...
		// Token: 0x060006E9 RID: 1769 RVA: 0x00024784 File Offset: 0x00022984
		...
		// Token: 0x060006EA RID: 1770 RVA: 0x000248EC File Offset: 0x00022AEC
		...
		// Token: 0x060006EB RID: 1771 RVA: 0x00024AB4 File Offset: 0x00022CB4
			...
			for (int i = 0; i < this.tileZCount; i++)
			{
				for (int j = 0; j < this.tileXCount; j++)
				{
					...
					else
					{
						...
						navmeshTile3.tris = new UnsafeSpan<int>(Allocator.Persistent, num5);
						for (int k = 0; k < navmeshTile3.tris.Length; k++)
						{
							*navmeshTile3.tris[k] = reader.ReadInt32();
						}
						navmeshTile3.verts = new UnsafeSpan<Int3>(Allocator.Persistent, reader.ReadInt32());
						...
						{
							navmeshTile3.vertsInGraphSpace = new UnsafeSpan<Int3>(Allocator.Persistent, reader.ReadInt32());
		...
		// Token: 0x060006EC RID: 1772 RVA: 0x00024E34 File Offset: 0x00023034
		protected override void PostDeserialization(GraphSerializationContext ctx)
		{
			if (ctx.meta.version < AstarSerializer.V4_3_68 && this.tiles != null)
			{
				...
				this.GetNodes(delegate(GraphNode node)
				{
					...
					if ((func = <>9__4) == null)
					{
						func = (<>9__4 = (Connection conn) => !triNode.ContainsOutgoingConnection(conn.node));
					}
