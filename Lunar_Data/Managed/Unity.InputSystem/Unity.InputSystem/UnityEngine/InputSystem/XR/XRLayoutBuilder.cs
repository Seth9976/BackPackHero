...
namespace UnityEngine.InputSystem.XR
{
	...
	{
		// Token: 0x060009C1 RID: 2497 RVA: 0x00035718 File Offset: 0x00033918
		...
		// Token: 0x060009C2 RID: 2498 RVA: 0x0003577C File Offset: 0x0003397C
		...
		// Token: 0x060009C3 RID: 2499 RVA: 0x000357E0 File Offset: 0x000339E0
		...
		// Token: 0x060009C4 RID: 2500 RVA: 0x00035944 File Offset: 0x00033B44
		...
		// Token: 0x060009C5 RID: 2501 RVA: 0x000359D4 File Offset: 0x00033BD4
		private bool IsSubControl(string name)
		{
			return name.Contains('/');
		}

		// Token: 0x060009C6 RID: 2502 RVA: 0x000359E0 File Offset: 0x00033BE0
		...
		// Token: 0x060009C7 RID: 2503 RVA: 0x00035A00 File Offset: 0x00033C00
		...
		// Token: 0x060009C8 RID: 2504 RVA: 0x00035A50 File Offset: 0x00033C50
		private InputControlLayout Build()
		{
			...
			for (int i = 0; i < this.descriptor.inputFeatures.Count; i++)
			{
				...
				case FeatureType.Axis1D:
					...
					break;
				case FeatureType.Axis2D:
					builder.AddControl(text).WithLayout("Vector2").WithByteOffset(num)
