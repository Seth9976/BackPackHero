...
namespace UnityEngine.Audio
{
	...
	{
		// Token: 0x0600017B RID: 379 RVA: 0x00002FCC File Offset: 0x000011CC
		...
		// Token: 0x0600017C RID: 380 RVA: 0x0000300C File Offset: 0x0000120C
		...
		// Token: 0x0600017D RID: 381 RVA: 0x00003040 File Offset: 0x00001240
		...
		// Token: 0x0600017E RID: 382 RVA: 0x0000307C File Offset: 0x0000127C
		public PlayableHandle GetHandle()
		{
			return this.m_Handle;
		}

		// Token: 0x0600017F RID: 383 RVA: 0x00003094 File Offset: 0x00001294
		public static implicit operator Playable(AudioClipPlayable playable)
		{
			return new Playable(playable.GetHandle());
		}

		// Token: 0x06000180 RID: 384 RVA: 0x000030B4 File Offset: 0x000012B4
		public static explicit operator AudioClipPlayable(Playable playable)
		{
			return new AudioClipPlayable(playable.GetHandle());
		}

		// Token: 0x06000181 RID: 385 RVA: 0x000030D4 File Offset: 0x000012D4
		public bool Equals(AudioClipPlayable other)
		{
			return this.GetHandle() == other.GetHandle();
		}

		// Token: 0x06000182 RID: 386 RVA: 0x000030F8 File Offset: 0x000012F8
		public AudioClip GetClip()
		{
			return AudioClipPlayable.GetClipInternal(ref this.m_Handle);
		}

		// Token: 0x06000183 RID: 387 RVA: 0x00003115 File Offset: 0x00001315
		public void SetClip(AudioClip value)
		{
			AudioClipPlayable.SetClipInternal(ref this.m_Handle, value);
		}

		// Token: 0x06000184 RID: 388 RVA: 0x00003128 File Offset: 0x00001328
		public bool GetLooped()
		{
			return AudioClipPlayable.GetLoopedInternal(ref this.m_Handle);
		}

		// Token: 0x06000185 RID: 389 RVA: 0x00003145 File Offset: 0x00001345
		public void SetLooped(bool value)
		{
			AudioClipPlayable.SetLoopedInternal(ref this.m_Handle, value);
		}

		// Token: 0x06000186 RID: 390 RVA: 0x00003158 File Offset: 0x00001358
		internal float GetVolume()
		{
			return AudioClipPlayable.GetVolumeInternal(ref this.m_Handle);
		}

		// Token: 0x06000187 RID: 391 RVA: 0x00003178 File Offset: 0x00001378
		...
		// Token: 0x06000188 RID: 392 RVA: 0x000031C4 File Offset: 0x000013C4
		internal float GetStereoPan()
		{
			return AudioClipPlayable.GetStereoPanInternal(ref this.m_Handle);
		}

		// Token: 0x06000189 RID: 393 RVA: 0x000031E4 File Offset: 0x000013E4
		...
		// Token: 0x0600018A RID: 394 RVA: 0x00003230 File Offset: 0x00001430
		internal float GetSpatialBlend()
		{
			return AudioClipPlayable.GetSpatialBlendInternal(ref this.m_Handle);
		}

		// Token: 0x0600018B RID: 395 RVA: 0x00003250 File Offset: 0x00001450
		...
		// Token: 0x0600018C RID: 396 RVA: 0x0000329C File Offset: 0x0000149C
		[EditorBrowsable(1)]
		...
		// Token: 0x06000192 RID: 402 RVA: 0x000033A6 File Offset: 0x000015A6
		public void Seek(double startTime, double startDelay)
		{
			this.Seek(startTime, startDelay, 0.0);
		}

		// Token: 0x06000193 RID: 403 RVA: 0x000033BC File Offset: 0x000015BC
