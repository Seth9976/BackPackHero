...
namespace UnityEngine
{
	...
	public sealed class AudioListener : AudioBehaviour
	{
		...
		// Token: 0x0600005B RID: 91 RVA: 0x0000276C File Offset: 0x0000096C
		...
		// Token: 0x0600005C RID: 92 RVA: 0x0000278E File Offset: 0x0000098E
		public static void GetOutputData(float[] samples, int channel)
		{
			AudioListener.GetOutputDataHelper(samples, channel);
		}

		// Token: 0x0600005D RID: 93 RVA: 0x0000279C File Offset: 0x0000099C
		...
		// Token: 0x0600005E RID: 94 RVA: 0x000027BF File Offset: 0x000009BF
