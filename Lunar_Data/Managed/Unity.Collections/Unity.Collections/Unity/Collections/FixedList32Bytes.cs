...
namespace Unity.Collections
{
	...
	public struct FixedList32Bytes<[global::System.Runtime.CompilerServices.IsUnmanaged] T> : INativeList<T>, IIndexable<T>, IEnumerable<T>, IEnumerable, IEquatable<FixedList32Bytes<T>>, IComparable<FixedList32Bytes<T>>, IEquatable<FixedList64Bytes<T>>, IComparable<FixedList64Bytes<T>>, IEquatable<FixedList128Bytes<T>>, IComparable<FixedList128Bytes<T>>, IEquatable<FixedList512Bytes<T>>, IComparable<FixedList512Bytes<T>>, IEquatable<FixedList4096Bytes<T>>, IComparable<FixedList4096Bytes<T>> where T : struct, ValueType
	{
		...
		// (get) Token: 0x060001C1 RID: 449 RVA: 0x000052CF File Offset: 0x000034CF
		// (set) Token: 0x060001C2 RID: 450 RVA: 0x000052D7 File Offset: 0x000034D7
		[CreateProperty]
		public int Length
		{
			get
		...
		// (get) Token: 0x060001C3 RID: 451 RVA: 0x000052E1 File Offset: 0x000034E1
		[CreateProperty]
		...
		// (get) Token: 0x060001C4 RID: 452 RVA: 0x000052E9 File Offset: 0x000034E9
		public bool IsEmpty
		{
			get
			{
		...
		// (get) Token: 0x060001C5 RID: 453 RVA: 0x000052F4 File Offset: 0x000034F4
		...
		// (get) Token: 0x060001C6 RID: 454 RVA: 0x00005304 File Offset: 0x00003504
		...
		// (get) Token: 0x060001C7 RID: 455 RVA: 0x0000532A File Offset: 0x0000352A
		// (set) Token: 0x060001C8 RID: 456 RVA: 0x00002C2B File Offset: 0x00000E2B
		public int Capacity
		{
			get
			{
		...
		// Token: 0x060001CB RID: 459 RVA: 0x00005358 File Offset: 0x00003558
		public unsafe ref T ElementAt(int index)
		{
			return UnsafeUtility.ArrayElementAsRef<T>((void*)this.Buffer, index);
		}

		// Token: 0x060001CC RID: 460 RVA: 0x00005366 File Offset: 0x00003566
		public unsafe override int GetHashCode()
		{
			return (int)CollectionHelper.Hash((void*)this.Buffer, this.LengthInBytes);
		}

		// Token: 0x060001CD RID: 461 RVA: 0x0000537C File Offset: 0x0000357C
		...
		// Token: 0x060001CE RID: 462 RVA: 0x000053A8 File Offset: 0x000035A8
		...
		// Token: 0x060001CF RID: 463 RVA: 0x000053EA File Offset: 0x000035EA
		public void AddNoResize(in T item)
		{
			this.Add(in item);
		}

		// Token: 0x060001D0 RID: 464 RVA: 0x000053F3 File Offset: 0x000035F3
		public unsafe void AddRangeNoResize(void* ptr, int length)
		{
			this.AddRange(ptr, length);
		}

		// Token: 0x060001D1 RID: 465 RVA: 0x000053FD File Offset: 0x000035FD
		public void Clear()
		{
			this.Length = 0;
		}

		// Token: 0x060001D2 RID: 466 RVA: 0x00005408 File Offset: 0x00003608
		...
		// Token: 0x060001D3 RID: 467 RVA: 0x00005466 File Offset: 0x00003666
		...
		// Token: 0x060001D4 RID: 468 RVA: 0x0000547F File Offset: 0x0000367F
		public void RemoveAtSwapBack(int index)
		{
			this.RemoveRangeSwapBack(index, 1);
		}

		// Token: 0x060001D5 RID: 469 RVA: 0x0000548C File Offset: 0x0000368C
		...
		// Token: 0x060001D6 RID: 470 RVA: 0x000054EA File Offset: 0x000036EA
		...
		// Token: 0x060001D7 RID: 471 RVA: 0x000054F6 File Offset: 0x000036F6
		public void RemoveAt(int index)
		{
			this.RemoveRange(index, 1);
		}

		// Token: 0x060001D8 RID: 472 RVA: 0x00005500 File Offset: 0x00003700
		...
		// Token: 0x060001D9 RID: 473 RVA: 0x0000555C File Offset: 0x0000375C
		...
		// Token: 0x060001DA RID: 474 RVA: 0x00005568 File Offset: 0x00003768
		[NotBurstCompatible]
		...
		// Token: 0x060001DB RID: 475 RVA: 0x000055AF File Offset: 0x000037AF
		...
		// Token: 0x060001DC RID: 476 RVA: 0x000055D8 File Offset: 0x000037D8
		...
		// Token: 0x060001DD RID: 477 RVA: 0x00005628 File Offset: 0x00003828
		public static bool operator !=(in FixedList32Bytes<T> a, in FixedList32Bytes<T> b)
		{
			return !((in a) == (in b));
		}

		// Token: 0x060001DE RID: 478 RVA: 0x00005634 File Offset: 0x00003834
		...
		// Token: 0x060001DF RID: 479 RVA: 0x000056DC File Offset: 0x000038DC
		public bool Equals(FixedList32Bytes<T> other)
		{
			return this.CompareTo(other) == 0;
		}

		// Token: 0x060001E0 RID: 480 RVA: 0x000056E8 File Offset: 0x000038E8
		...
		// Token: 0x060001E1 RID: 481 RVA: 0x00005738 File Offset: 0x00003938
		public static bool operator !=(in FixedList32Bytes<T> a, in FixedList64Bytes<T> b)
		{
			return !((in a) == (in b));
		}

		// Token: 0x060001E2 RID: 482 RVA: 0x00005744 File Offset: 0x00003944
		...
		// Token: 0x060001E3 RID: 483 RVA: 0x000057EC File Offset: 0x000039EC
		public bool Equals(FixedList64Bytes<T> other)
		{
			return this.CompareTo(other) == 0;
		}

		// Token: 0x060001E4 RID: 484 RVA: 0x000057F8 File Offset: 0x000039F8
		...
		// Token: 0x060001E5 RID: 485 RVA: 0x0000580C File Offset: 0x00003A0C
		...
		// Token: 0x060001E6 RID: 486 RVA: 0x0000586A File Offset: 0x00003A6A
		public static implicit operator FixedList32Bytes<T>(in FixedList64Bytes<T> other)
		{
			return new FixedList32Bytes<T>(in other);
		}

		// Token: 0x060001E7 RID: 487 RVA: 0x00005874 File Offset: 0x00003A74
		...
		// Token: 0x060001E8 RID: 488 RVA: 0x000058C4 File Offset: 0x00003AC4
		public static bool operator !=(in FixedList32Bytes<T> a, in FixedList128Bytes<T> b)
		{
			return !((in a) == (in b));
		}

		// Token: 0x060001E9 RID: 489 RVA: 0x000058D0 File Offset: 0x00003AD0
		...
		// Token: 0x060001EA RID: 490 RVA: 0x00005978 File Offset: 0x00003B78
		public bool Equals(FixedList128Bytes<T> other)
		{
			return this.CompareTo(other) == 0;
		}

		// Token: 0x060001EB RID: 491 RVA: 0x00005984 File Offset: 0x00003B84
		...
		// Token: 0x060001EC RID: 492 RVA: 0x00005998 File Offset: 0x00003B98
		...
		// Token: 0x060001ED RID: 493 RVA: 0x000059F6 File Offset: 0x00003BF6
		public static implicit operator FixedList32Bytes<T>(in FixedList128Bytes<T> other)
		{
			return new FixedList32Bytes<T>(in other);
		}

		// Token: 0x060001EE RID: 494 RVA: 0x00005A00 File Offset: 0x00003C00
		...
		// Token: 0x060001EF RID: 495 RVA: 0x00005A50 File Offset: 0x00003C50
		public static bool operator !=(in FixedList32Bytes<T> a, in FixedList512Bytes<T> b)
		{
			return !((in a) == (in b));
		}

		// Token: 0x060001F0 RID: 496 RVA: 0x00005A5C File Offset: 0x00003C5C
		...
		// Token: 0x060001F1 RID: 497 RVA: 0x00005B04 File Offset: 0x00003D04
		public bool Equals(FixedList512Bytes<T> other)
		{
			return this.CompareTo(other) == 0;
		}

		// Token: 0x060001F2 RID: 498 RVA: 0x00005B10 File Offset: 0x00003D10
		...
		// Token: 0x060001F3 RID: 499 RVA: 0x00005B24 File Offset: 0x00003D24
		...
		// Token: 0x060001F4 RID: 500 RVA: 0x00005B82 File Offset: 0x00003D82
		public static implicit operator FixedList32Bytes<T>(in FixedList512Bytes<T> other)
		{
			return new FixedList32Bytes<T>(in other);
		}

		// Token: 0x060001F5 RID: 501 RVA: 0x00005B8C File Offset: 0x00003D8C
		...
		// Token: 0x060001F6 RID: 502 RVA: 0x00005BDC File Offset: 0x00003DDC
		public static bool operator !=(in FixedList32Bytes<T> a, in FixedList4096Bytes<T> b)
		{
			return !((in a) == (in b));
		}

		// Token: 0x060001F7 RID: 503 RVA: 0x00005BE8 File Offset: 0x00003DE8
		...
		// Token: 0x060001F8 RID: 504 RVA: 0x00005C90 File Offset: 0x00003E90
		public bool Equals(FixedList4096Bytes<T> other)
		{
			return this.CompareTo(other) == 0;
		}

		// Token: 0x060001F9 RID: 505 RVA: 0x00005C9C File Offset: 0x00003E9C
		...
		// Token: 0x060001FA RID: 506 RVA: 0x00005CB0 File Offset: 0x00003EB0
		...
		// Token: 0x060001FB RID: 507 RVA: 0x00005D0E File Offset: 0x00003F0E
		...
		// Token: 0x060001FD RID: 509 RVA: 0x00005D9B File Offset: 0x00003F9B
		public FixedList32Bytes<T>.Enumerator GetEnumerator()
		{
			return new FixedList32Bytes<T>.Enumerator(ref this);
		}

		// Token: 0x060001FE RID: 510 RVA: 0x00004A65 File Offset: 0x00002C65
		IEnumerator IEnumerable.GetEnumerator()
		{
			throw new NotImplementedException();
		}

		// Token: 0x060001FF RID: 511 RVA: 0x00004A65 File Offset: 0x00002C65
		...
		{
			// Token: 0x06000200 RID: 512 RVA: 0x00005DA3 File Offset: 0x00003FA3
			...
			// Token: 0x06000201 RID: 513 RVA: 0x00002C2B File Offset: 0x00000E2B
			public void Dispose()
			{
			}

			// Token: 0x06000202 RID: 514 RVA: 0x00005DB8 File Offset: 0x00003FB8
			...
			// Token: 0x06000203 RID: 515 RVA: 0x00005DDB File Offset: 0x00003FDB
			public void Reset()
			{
				this.m_Index = -1;
			}
			...
			// (get) Token: 0x06000204 RID: 516 RVA: 0x00005DE4 File Offset: 0x00003FE4
			public T Current
			{
				get
				{
			...
			// (get) Token: 0x06000205 RID: 517 RVA: 0x00005DF7 File Offset: 0x00003FF7
