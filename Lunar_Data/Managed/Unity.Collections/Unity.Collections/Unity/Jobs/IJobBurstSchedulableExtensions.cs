...
namespace Unity.Jobs
{
	...
	public static class IJobBurstSchedulableExtensions
	{
		...
		{
			IntPtr intPtr = *IJobBurstSchedulableExtensions.JobBurstSchedulableProducer<T>.jobReflectionData.Data;
			JobsUtility.JobScheduleParameters jobScheduleParameters = new JobsUtility.JobScheduleParameters(UnsafeUtility.AddressOf<T>(ref jobData), intPtr, dependsOn, ScheduleMode.Single);
		...
		{
			IntPtr intPtr = *IJobBurstSchedulableExtensions.JobBurstSchedulableProducer<T>.jobReflectionData.Data;
			JobsUtility.JobScheduleParameters jobScheduleParameters = new JobsUtility.JobScheduleParameters(UnsafeUtility.AddressOf<T>(ref jobData), intPtr, default(JobHandle), ScheduleMode.Run);
