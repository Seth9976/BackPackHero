...
namespace UnityEngine
{
	...
	public struct ModifiableContactPair
	{
		...
		public unsafe uint GetFaceIndex(int i)
		{
			...
			{
				IntPtr intPtr;
				intPtr..ctor(this.contacts.ToInt64() + (long)(this.numContacts * sizeof(ModifiableContact)) + (long)((this.numContacts + i) * 4));
		...
		{
			IntPtr intPtr;
			intPtr..ctor(this.contacts.ToInt64() + (long)(index * sizeof(ModifiableContact)));
		...
		{
			IntPtr intPtr;
			intPtr..ctor(this.contacts.ToInt64() - (long)(this.numContacts * sizeof(ModifiableContactPatch)));
