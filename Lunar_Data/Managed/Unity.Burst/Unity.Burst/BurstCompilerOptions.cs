...
namespace Unity.Burst
{
	...
	public sealed class BurstCompilerOptions
	{
		...
		// Token: 0x0600003F RID: 63 RVA: 0x000026A0 File Offset: 0x000008A0
		...
		// Token: 0x06000040 RID: 64 RVA: 0x000026CC File Offset: 0x000008CC
		...
		// (get) Token: 0x06000042 RID: 66 RVA: 0x000026F2 File Offset: 0x000008F2
		private bool IsGlobal { get; }

		// Token: 0x1700000B RID: 11
		// (get) Token: 0x06000043 RID: 67 RVA: 0x000026FA File Offset: 0x000008FA
		...
		// (get) Token: 0x06000044 RID: 68 RVA: 0x0000270E File Offset: 0x0000090E
		// (set) Token: 0x06000045 RID: 69 RVA: 0x00002718 File Offset: 0x00000918
		...
		// (get) Token: 0x06000046 RID: 70 RVA: 0x00002766 File Offset: 0x00000966
		// (set) Token: 0x06000047 RID: 71 RVA: 0x0000276E File Offset: 0x0000096E
		...
		// (get) Token: 0x06000048 RID: 72 RVA: 0x0000278B File Offset: 0x0000098B
		// (set) Token: 0x06000049 RID: 73 RVA: 0x00002793 File Offset: 0x00000993
		...
		// (get) Token: 0x0600004A RID: 74 RVA: 0x000027B6 File Offset: 0x000009B6
		// (set) Token: 0x0600004B RID: 75 RVA: 0x000027BE File Offset: 0x000009BE
		...
		// (get) Token: 0x0600004C RID: 76 RVA: 0x000027E1 File Offset: 0x000009E1
		// (set) Token: 0x0600004D RID: 77 RVA: 0x000027E9 File Offset: 0x000009E9
		...
		// (get) Token: 0x0600004E RID: 78 RVA: 0x0000280C File Offset: 0x00000A0C
		// (set) Token: 0x0600004F RID: 79 RVA: 0x0000280F File Offset: 0x00000A0F
		...
		// (get) Token: 0x06000050 RID: 80 RVA: 0x00002811 File Offset: 0x00000A11
		// (set) Token: 0x06000051 RID: 81 RVA: 0x00002814 File Offset: 0x00000A14
		...
		// (get) Token: 0x06000052 RID: 82 RVA: 0x00002816 File Offset: 0x00000A16
		// (set) Token: 0x06000053 RID: 83 RVA: 0x0000281E File Offset: 0x00000A1E
		...
		// (get) Token: 0x06000054 RID: 84 RVA: 0x0000283B File Offset: 0x00000A3B
		...
		// (get) Token: 0x06000055 RID: 85 RVA: 0x0000284C File Offset: 0x00000A4C
		// (set) Token: 0x06000056 RID: 86 RVA: 0x00002854 File Offset: 0x00000A54
		internal Action OptionsChanged { get; set; }

		// Token: 0x06000057 RID: 87 RVA: 0x00002860 File Offset: 0x00000A60
		...
		// Token: 0x06000058 RID: 88 RVA: 0x000028BA File Offset: 0x00000ABA
		...
		// Token: 0x06000059 RID: 89 RVA: 0x000028D9 File Offset: 0x00000AD9
		...
		// Token: 0x0600005A RID: 90 RVA: 0x000028F8 File Offset: 0x00000AF8
		...
		// Token: 0x0600005B RID: 91 RVA: 0x00002988 File Offset: 0x00000B88
		...
		// Token: 0x0600005C RID: 92 RVA: 0x000029B4 File Offset: 0x00000BB4
		...
		// Token: 0x0600005D RID: 93 RVA: 0x00002AB0 File Offset: 0x00000CB0
		internal bool TryGetOptions(MemberInfo member, bool isJit, out string flagsOut, bool isForILPostProcessing = false)
		{
			...
			flagsOut = this.GetOptions(isJit, burstCompileAttribute, isForILPostProcessing, false);
			return true;
		}

		// Token: 0x0600005E RID: 94 RVA: 0x00002AF8 File Offset: 0x00000CF8
		internal string GetOptions(bool isJit, BurstCompileAttribute attr = null, bool isForILPostProcessing = false, bool isForCompilerClient = false)
		{
			...
			if (isJit && !isForCompilerClient && ((attr != null && attr.CompileSynchronously) || this.RequiresSynchronousCompilation))
			{
		...
		// Token: 0x0600005F RID: 95 RVA: 0x00002D50 File Offset: 0x00000F50
		...
		// Token: 0x06000060 RID: 96 RVA: 0x00002D6B File Offset: 0x00000F6B
		...
		// Token: 0x06000061 RID: 97 RVA: 0x00002D9C File Offset: 0x00000F9C
		...
		// Token: 0x06000062 RID: 98 RVA: 0x00002DAE File Offset: 0x00000FAE
		...
		// Token: 0x06000064 RID: 100 RVA: 0x00002E12 File Offset: 0x00001012
