...
namespace UnityEngine.Rendering
{
	...
	{
		// Token: 0x0600040C RID: 1036 RVA: 0x0001496C File Offset: 0x00012B6C
		public unsafe static void Initialize()
		{
			...
			ConstantBuffer.UpdateData<Hammersley.Hammersley2dSeq16>(in hammersley2dSeq);
			ConstantBuffer.UpdateData<Hammersley.Hammersley2dSeq32>(in hammersley2dSeq2);
			ConstantBuffer.UpdateData<Hammersley.Hammersley2dSeq64>(in hammersley2dSeq3);
			ConstantBuffer.UpdateData<Hammersley.Hammersley2dSeq256>(in hammersley2dSeq4);
		}

		// Token: 0x0600040D RID: 1037 RVA: 0x00014A79 File Offset: 0x00012C79
		...
		[GenerateHLSL(PackingRules.Exact, true, false, false, 1, false, false, false, -1, "C:\\Users\\jaspe\\Lunar Vampire Cards\\Library\\PackageCache\\com.unity.render-pipelines.core@12.1.10\\Runtime\\ShaderLibrary\\Sampling\\Hammersley.cs", needAccessors = false, generateCBuffer = true)]
