...
namespace UnityEngine
{
	...
	public class Physics2D
	{
		...
		[StaticAccessor("PhysicsQuery2D", StaticAccessorType.DoubleColon)]
		private static ColliderDistance2D Distance_Internal([Writable] [NotNull("ArgumentNullException")] Collider2D colliderA, [NotNull("ArgumentNullException")] [Writable] Collider2D colliderB)
		{
