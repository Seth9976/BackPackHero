...
namespace System.ComponentModel.Composition.ReflectionModel
{
	...
	internal class ReflectionComposablePart : ComposablePart, ICompositionElement
	{
		...
		private void EnsureGettable()
		{
			...
			foreach (ImportDefinition importDefinition in this.ImportDefinitions.Where((ImportDefinition definition) => definition.IsPrerequisite))
			{
		...
		{
			IEnumerable<ImportDefinition> enumerable = this.ImportDefinitions.Where((ImportDefinition import) => !import.IsPrerequisite);
