...
namespace UnityEngine.VFX
{
	...
	public class VisualEffect : Behaviour
	{
		...
		{
			Vector3 vector;
			this.GetCurrentPadding_Injected(nameID, out vector);
			return vector;
		}
		...
		{
			VFXOutputEventArgs vfxoutputEventArgs = new VFXOutputEventArgs(eventNameId, source.m_cachedEventAttribute);
			source.outputEventReceived.Invoke(vfxoutputEventArgs);
		}
