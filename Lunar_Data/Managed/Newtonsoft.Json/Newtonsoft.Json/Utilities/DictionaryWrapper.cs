...
namespace Newtonsoft.Json.Utilities
{
	...
	internal class DictionaryWrapper<[Nullable(2)] TKey, [Nullable(2)] TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IWrappedDictionary, IDictionary, ICollection
	{
		...
		// (get) Token: 0x060004C5 RID: 1221 RVA: 0x000140A0 File Offset: 0x000122A0
		// (set) Token: 0x060004C6 RID: 1222 RVA: 0x000140F7 File Offset: 0x000122F7
		[Nullable(2)]
		...
		{
			// Token: 0x06000E8C RID: 3724 RVA: 0x0004131B File Offset: 0x0003F51B
			...
			// (get) Token: 0x06000E8D RID: 3725 RVA: 0x0004132F File Offset: 0x0003F52F
			...
			// (get) Token: 0x06000E8E RID: 3726 RVA: 0x0004133C File Offset: 0x0003F53C
			public object Key
			{
				get
				{
			...
			// (get) Token: 0x06000E8F RID: 3727 RVA: 0x00041358 File Offset: 0x0003F558
			[Nullable(2)]
			public object Value
			{
				[NullableContext(2)]
			...
			// (get) Token: 0x06000E90 RID: 3728 RVA: 0x00041374 File Offset: 0x0003F574
			...
			// Token: 0x06000E91 RID: 3729 RVA: 0x000413BB File Offset: 0x0003F5BB
			public bool MoveNext()
			{
				return this._e.MoveNext();
			}

			// Token: 0x06000E92 RID: 3730 RVA: 0x000413C8 File Offset: 0x0003F5C8
			public void Reset()
			{
				this._e.Reset();
			}
