...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06002F8A RID: 12170 RVA: 0x000A9248 File Offset: 0x000A7448
		...
		// Token: 0x06002F8B RID: 12171 RVA: 0x000A95C5 File Offset: 0x000A77C5
		public void Dispose()
		{
			this.Dispose(true);
		}
		...
		// Token: 0x06002F8C RID: 12172 RVA: 0x000A95C5 File Offset: 0x000A77C5
		public void Clear()
		{
			this.Dispose(true);
		}

		// Token: 0x06002F8D RID: 12173 RVA: 0x000A95D0 File Offset: 0x000A77D0
		...
		// (get) Token: 0x06002F8E RID: 12174 RVA: 0x000A96B5 File Offset: 0x000A78B5
		...
		// (get) Token: 0x06002F8F RID: 12175 RVA: 0x000A96BD File Offset: 0x000A78BD
		...
		// (get) Token: 0x06002F90 RID: 12176 RVA: 0x000A96C5 File Offset: 0x000A78C5
		...
		// Token: 0x06002F93 RID: 12179 RVA: 0x000A96D0 File Offset: 0x000A78D0
		...
		// Token: 0x06002F94 RID: 12180 RVA: 0x000A984C File Offset: 0x000A7A4C
		...
		// Token: 0x06002F95 RID: 12181 RVA: 0x000A9970 File Offset: 0x000A7B70
		public void Reset()
		{
			this.m_depadBuffer = null;
			if (this.m_cipherMode == CipherMode.CBC)
		...
		// Token: 0x06002F96 RID: 12182 RVA: 0x000A99CC File Offset: 0x000A7BCC
			...
			for (int j = 0; j < num4; j++)
			{
				...
				else
				{
					...
					if (this.m_cipherMode == CipherMode.CBC)
					{
						...
						Buffer.Memcpy((byte*)ptr7, (byte*)ptr6, this.m_blockSizeBytes, true);
						array7 = null;
					}
				}
		...
		// Token: 0x06002F97 RID: 12183 RVA: 0x000AA064 File Offset: 0x000A8264
		[SecuritySafeCritical]
		...
		// Token: 0x06002F98 RID: 12184 RVA: 0x000AA744 File Offset: 0x000A8944
		[SecurityCritical]
		...
		// Token: 0x06002F99 RID: 12185 RVA: 0x000AA934 File Offset: 0x000A8B34
		[SecurityCritical]
		...
		// Token: 0x06002F9A RID: 12186 RVA: 0x000AAB50 File Offset: 0x000A8D50
		...
		// Token: 0x06002F9B RID: 12187 RVA: 0x000AAE20 File Offset: 0x000A9020
		private static int rot1(int val)
		{
			return ((val << 8) & -256) | ((val >> 24) & 255);
		}

		// Token: 0x06002F9C RID: 12188 RVA: 0x000AAE36 File Offset: 0x000A9036
		private static int rot2(int val)
		{
			return ((val << 16) & -65536) | ((val >> 16) & 65535);
		}

		// Token: 0x06002F9D RID: 12189 RVA: 0x000AAE4D File Offset: 0x000A904D
		private static int rot3(int val)
		{
			return ((val << 24) & -16777216) | ((val >> 8) & 16777215);
		}

		// Token: 0x06002F9E RID: 12190 RVA: 0x000AAE64 File Offset: 0x000A9064
		...
		// Token: 0x06002F9F RID: 12191 RVA: 0x000AAEB8 File Offset: 0x000A90B8
