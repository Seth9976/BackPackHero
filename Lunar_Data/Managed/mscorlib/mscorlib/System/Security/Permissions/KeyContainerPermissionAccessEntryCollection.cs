...
namespace System.Security.Permissions
{
	...
	{
		// Token: 0x06002C6A RID: 11370 RVA: 0x0009FA65 File Offset: 0x0009DC65
		internal KeyContainerPermissionAccessEntryCollection()
		{
			this._list = new ArrayList();
		}

		// Token: 0x06002C6B RID: 11371 RVA: 0x0009FA78 File Offset: 0x0009DC78
		...
		// (get) Token: 0x06002C6C RID: 11372 RVA: 0x0009FAAA File Offset: 0x0009DCAA
		public int Count
		{
			get
			{
		...
		// Token: 0x06002C70 RID: 11376 RVA: 0x0009FACA File Offset: 0x0009DCCA
		...
		// Token: 0x06002C71 RID: 11377 RVA: 0x0009FAD8 File Offset: 0x0009DCD8
		public void Clear()
		{
			this._list.Clear();
		}
		...
		// Token: 0x06002C72 RID: 11378 RVA: 0x0009FAE5 File Offset: 0x0009DCE5
		...
		/// <exception cref="T:System.ArgumentException">
		///   <paramref name="array" /> is multidimensional.-or- The number of elements in the collection is greater than the available space from <paramref name="index" /> to the end of the destination <paramref name="array" />. </exception>
		// Token: 0x06002C73 RID: 11379 RVA: 0x0009FAE5 File Offset: 0x0009DCE5
		...
		// Token: 0x06002C74 RID: 11380 RVA: 0x0009FAF4 File Offset: 0x0009DCF4
		...
		/// <summary>Returns a <see cref="T:System.Security.Permissions.KeyContainerPermissionAccessEntryEnumerator" /> object that can be used to iterate through the objects in the collection.</summary>
		/// <returns>A <see cref="T:System.Security.Permissions.KeyContainerPermissionAccessEntryEnumerator" /> object that can be used to iterate through the collection. </returns>
		// Token: 0x06002C75 RID: 11381 RVA: 0x0009FAF4 File Offset: 0x0009DCF4
		...
		// Token: 0x06002C76 RID: 11382 RVA: 0x0009FB04 File Offset: 0x0009DD04
		...
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="accessEntry" /> is null.</exception>
		// Token: 0x06002C77 RID: 11383 RVA: 0x0009FB4C File Offset: 0x0009DD4C
