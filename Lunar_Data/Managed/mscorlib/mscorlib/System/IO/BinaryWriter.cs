...
namespace System.IO
{
	...
	public class BinaryWriter : IDisposable, IAsyncDisposable
	{
		...
		// Token: 0x0600691B RID: 26907 RVA: 0x0016734B File Offset: 0x0016554B
		...
		// Token: 0x0600691C RID: 26908 RVA: 0x00167389 File Offset: 0x00165589
		...
		// Token: 0x0600691D RID: 26909 RVA: 0x0016739A File Offset: 0x0016559A
		...
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="output" /> or <paramref name="encoding" /> is null. </exception>
		// Token: 0x0600691E RID: 26910 RVA: 0x001673A8 File Offset: 0x001655A8
		...
		// Token: 0x0600691F RID: 26911 RVA: 0x00167422 File Offset: 0x00165622
		...
		// Token: 0x06006920 RID: 26912 RVA: 0x0016742B File Offset: 0x0016562B
		...
		// Token: 0x06006921 RID: 26913 RVA: 0x00167422 File Offset: 0x00165622
		public void Dispose()
		{
			this.Dispose(true);
		}
		...
		// (get) Token: 0x06006922 RID: 26914 RVA: 0x0016744F File Offset: 0x0016564F
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006923 RID: 26915 RVA: 0x0016745D File Offset: 0x0016565D
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006924 RID: 26916 RVA: 0x0016746A File Offset: 0x0016566A
		public virtual long Seek(int offset, SeekOrigin origin)
		{
			return this.OutStream.Seek((long)offset, origin);
		}

		// Token: 0x06006925 RID: 26917 RVA: 0x0016747A File Offset: 0x0016567A
		public virtual void Write(ReadOnlySpan<byte> buffer)
		{
			this.Write(buffer.ToArray());
		}

		// Token: 0x06006926 RID: 26918 RVA: 0x00167489 File Offset: 0x00165689
		public virtual void Write(ReadOnlySpan<char> buffer)
		{
			this.Write(buffer.ToArray());
		}

		// Token: 0x06006927 RID: 26919 RVA: 0x00167498 File Offset: 0x00165698
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006928 RID: 26920 RVA: 0x00167514 File Offset: 0x00165714
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006929 RID: 26921 RVA: 0x00167539 File Offset: 0x00165739
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692A RID: 26922 RVA: 0x00167547 File Offset: 0x00165747
		[CLSCompliant(false)]
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692B RID: 26923 RVA: 0x00167556 File Offset: 0x00165756
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692C RID: 26924 RVA: 0x00167576 File Offset: 0x00165776
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692D RID: 26925 RVA: 0x00167588 File Offset: 0x00165788
		...
		/// <exception cref="T:System.IO.IOException">An I/O error occurs. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692E RID: 26926 RVA: 0x001675FC File Offset: 0x001657FC
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x0600692F RID: 26927 RVA: 0x00167638 File Offset: 0x00165838
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006930 RID: 26928 RVA: 0x00167664 File Offset: 0x00165864
		[SecuritySafeCritical]
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006931 RID: 26929 RVA: 0x00167679 File Offset: 0x00165879
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006932 RID: 26930 RVA: 0x0016769C File Offset: 0x0016589C
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006933 RID: 26931 RVA: 0x0016769C File Offset: 0x0016589C
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006934 RID: 26932 RVA: 0x001676C8 File Offset: 0x001658C8
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006935 RID: 26933 RVA: 0x00167718 File Offset: 0x00165918
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006936 RID: 26934 RVA: 0x00167768 File Offset: 0x00165968
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006937 RID: 26935 RVA: 0x001677EC File Offset: 0x001659EC
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006938 RID: 26936 RVA: 0x00167870 File Offset: 0x00165A70
		[SecuritySafeCritical]
		...
		/// <exception cref="T:System.ObjectDisposedException">The stream is closed. </exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06006939 RID: 26937 RVA: 0x00167888 File Offset: 0x00165A88
		[SecuritySafeCritical]
		...
		// Token: 0x0600693A RID: 26938 RVA: 0x001679E8 File Offset: 0x00165BE8
