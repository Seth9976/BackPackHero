...
namespace System.Threading.Tasks
{
	...
	{
		// Token: 0x060021C5 RID: 8645 RVA: 0x00079169 File Offset: 0x00077369
		internal ForceAsyncAwaiter(Task task)
		{
			this._task = task;
		}

		// Token: 0x060021C6 RID: 8646 RVA: 0x00079172 File Offset: 0x00077372
		...
		// Token: 0x060021C8 RID: 8648 RVA: 0x0007917C File Offset: 0x0007737C
		public void GetResult()
		{
			this._task.GetAwaiter().GetResult();
		}

		// Token: 0x060021C9 RID: 8649 RVA: 0x0007919C File Offset: 0x0007739C
		public void OnCompleted(Action action)
		{
			this._task.ConfigureAwait(false).GetAwaiter().OnCompleted(action);
		}

		// Token: 0x060021CA RID: 8650 RVA: 0x000791C8 File Offset: 0x000773C8
