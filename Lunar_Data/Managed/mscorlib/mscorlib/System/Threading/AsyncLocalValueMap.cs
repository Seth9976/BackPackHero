...
namespace System.Threading
{
	...
	internal static class AsyncLocalValueMap
	{
		...
		// (get) Token: 0x06001D66 RID: 7526 RVA: 0x0006DB54 File Offset: 0x0006BD54
		...
		{
			// Token: 0x06001D68 RID: 7528 RVA: 0x0006DB68 File Offset: 0x0006BD68
			...
			// Token: 0x06001D69 RID: 7529 RVA: 0x0006DB85 File Offset: 0x0006BD85
		...
		{
			// Token: 0x06001D6B RID: 7531 RVA: 0x0006DB8B File Offset: 0x0006BD8B
			...
			// Token: 0x06001D6C RID: 7532 RVA: 0x0006DBA4 File Offset: 0x0006BDA4
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D6D RID: 7533 RVA: 0x0006DBEF File Offset: 0x0006BDEF
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D6E RID: 7534 RVA: 0x0006DC08 File Offset: 0x0006BE08
			...
			// Token: 0x06001D6F RID: 7535 RVA: 0x0006DC30 File Offset: 0x0006BE30
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D70 RID: 7536 RVA: 0x0006DCDD File Offset: 0x0006BEDD
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D71 RID: 7537 RVA: 0x0006DD09 File Offset: 0x0006BF09
			...
			// Token: 0x06001D72 RID: 7538 RVA: 0x0006DD40 File Offset: 0x0006BF40
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D73 RID: 7539 RVA: 0x0006DE95 File Offset: 0x0006C095
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D74 RID: 7540 RVA: 0x0006DED4 File Offset: 0x0006C0D4
			internal MultiElementAsyncLocalValueMap(int count)
			{
				this._keyValues = new KeyValuePair<IAsyncLocal, object>[count];
			}

			// Token: 0x06001D75 RID: 7541 RVA: 0x0006DEE8 File Offset: 0x0006C0E8
			...
			// Token: 0x06001D76 RID: 7542 RVA: 0x0006DF00 File Offset: 0x0006C100
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				int i = 0;
			...
			// Token: 0x06001D77 RID: 7543 RVA: 0x0006E258 File Offset: 0x0006C458
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				foreach (KeyValuePair<IAsyncLocal, object> keyValuePair in this._keyValues)
				{
		...
		{
			// Token: 0x06001D78 RID: 7544 RVA: 0x0006E29B File Offset: 0x0006C49B
			public ManyElementAsyncLocalValueMap(int capacity)
				: base(capacity)
			{
			}

			// Token: 0x06001D79 RID: 7545 RVA: 0x0006E2A4 File Offset: 0x0006C4A4
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
