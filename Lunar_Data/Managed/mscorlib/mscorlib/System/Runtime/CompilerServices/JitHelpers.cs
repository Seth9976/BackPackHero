...
namespace System.Runtime.CompilerServices
{
	...
	{
		// Token: 0x060046CA RID: 18122 RVA: 0x000E71BD File Offset: 0x000E53BD
		internal static T UnsafeCast<T>(object o) where T : class
		{
			return Array.UnsafeMov<object, T>(o);
		}

		// Token: 0x060046CB RID: 18123 RVA: 0x000E71C5 File Offset: 0x000E53C5
		internal static int UnsafeEnumCast<T>(T val) where T : struct
		{
			return Array.UnsafeMov<T, int>(val);
		}

		// Token: 0x060046CC RID: 18124 RVA: 0x000E71CD File Offset: 0x000E53CD
