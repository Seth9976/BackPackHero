...
namespace System
{
	...
	internal class TypeIdentifiers
	{
		...
		// Token: 0x06001BBC RID: 7100 RVA: 0x00067AEE File Offset: 0x00065CEE
		...
		{
			// Token: 0x06001BBE RID: 7102 RVA: 0x00067AF6 File Offset: 0x00065CF6
			...
			// (get) Token: 0x06001BBF RID: 7103 RVA: 0x00067B0C File Offset: 0x00065D0C
			...
			// (get) Token: 0x06001BC0 RID: 7104 RVA: 0x00067B14 File Offset: 0x00065D14
			...
			// Token: 0x06001BC1 RID: 7105 RVA: 0x00067B30 File Offset: 0x00065D30
			private string GetInternalName()
			{
				return TypeSpec.UnescapeInternalName(this.displayName);
			}

			// Token: 0x06001BC2 RID: 7106 RVA: 0x00067B3D File Offset: 0x00065D3D
		...
		{
			// Token: 0x06001BC3 RID: 7107 RVA: 0x00067B5A File Offset: 0x00065D5A
			...
			// Token: 0x06001BC4 RID: 7108 RVA: 0x00067B70 File Offset: 0x00065D70
			...
			// (get) Token: 0x06001BC5 RID: 7109 RVA: 0x00067B96 File Offset: 0x00065D96
			public override string DisplayName
			{
				get
				{
			...
			// (get) Token: 0x06001BC6 RID: 7110 RVA: 0x00067BB2 File Offset: 0x00065DB2
			public string InternalName
			{
				get
				{
			...
			// Token: 0x06001BC7 RID: 7111 RVA: 0x00067BBA File Offset: 0x00065DBA
			private string GetDisplayName()
			{
				return TypeSpec.EscapeDisplayName(this.internalName);
			}

			// Token: 0x06001BC8 RID: 7112 RVA: 0x00067B3D File Offset: 0x00065D3D
			public override TypeName NestedName(TypeIdentifier innerName)
			{
				return TypeNames.FromDisplay(this.DisplayName + "+" + innerName.DisplayName);
			}
		...
		{
			// Token: 0x06001BC9 RID: 7113 RVA: 0x00067BC7 File Offset: 0x00065DC7
			...
			// (get) Token: 0x06001BCA RID: 7114 RVA: 0x00067BD6 File Offset: 0x00065DD6
			public override string DisplayName
			{
				get
				{
			...
			// (get) Token: 0x06001BCB RID: 7115 RVA: 0x00067BD6 File Offset: 0x00065DD6
			public string InternalName
			{
				get
				{
			...
			// Token: 0x06001BCC RID: 7116 RVA: 0x00067B3D File Offset: 0x00065D3D
			public override TypeName NestedName(TypeIdentifier innerName)
			{
				return TypeNames.FromDisplay(this.DisplayName + "+" + innerName.DisplayName);
			}
