...
namespace UnityEngine.TextCore.Text
{
	...
	{
		// Token: 0x06000091 RID: 145 RVA: 0x00005988 File Offset: 0x00003B88
		...
		// Token: 0x06000092 RID: 146 RVA: 0x000059D4 File Offset: 0x00003BD4
		...
		// Token: 0x06000093 RID: 147 RVA: 0x00005C64 File Offset: 0x00003E64
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00005D1C File Offset: 0x00003F1C
		public static SpriteCharacter GetSpriteCharacterFromSpriteAsset(uint unicode, SpriteAsset spriteAsset, bool includeFallbacks)
		{
			...
			else
			{
				...
				bool flag2 = spriteAsset.spriteCharacterLookupTable.TryGetValue(unicode, ref spriteCharacterFromSpriteAsset_Internal);
				if (flag2)
				{
					spriteCharacter = spriteCharacterFromSpriteAsset_Internal;
				}
		...
		// Token: 0x06000095 RID: 149 RVA: 0x00005E34 File Offset: 0x00004034
		...
		{
			SpriteCharacter spriteCharacterFromSpriteAsset_Internal;
			bool flag = spriteAsset.spriteCharacterLookupTable.TryGetValue(unicode, ref spriteCharacterFromSpriteAsset_Internal);
			SpriteCharacter spriteCharacter;
			if (flag)
			{
				spriteCharacter = spriteCharacterFromSpriteAsset_Internal;
