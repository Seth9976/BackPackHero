...
namespace ES3Types
{
	...
	{
		// Token: 0x060002BF RID: 703 RVA: 0x0000BBBD File Offset: 0x00009DBD
		...
		// Token: 0x060002C0 RID: 704 RVA: 0x0000BBD8 File Offset: 0x00009DD8
		...
		// Token: 0x060002C1 RID: 705 RVA: 0x0000BE40 File Offset: 0x0000A040
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach (object obj2 in reader.Properties)
			{
				...
				else if (num <= 2839690237U)
				{
					...
					else if (text == "rotationOverLifetime")
					{
