...
namespace ES3Types
{
	...
	{
		// Token: 0x060001E6 RID: 486 RVA: 0x00007078 File Offset: 0x00005278
		...
		// Token: 0x060001E7 RID: 487 RVA: 0x000070CF File Offset: 0x000052CF
		...
		// Token: 0x060001E8 RID: 488 RVA: 0x000070FA File Offset: 0x000052FA
		public override void Write(object obj, ES3Writer writer)
		{
			this.Write(obj, writer, writer.settings.memberReferenceMode);
		}

		// Token: 0x060001E9 RID: 489 RVA: 0x00007110 File Offset: 0x00005310
		...
		// Token: 0x060001EA RID: 490 RVA: 0x000071AC File Offset: 0x000053AC
		public override object Read<T>(ES3Reader reader)
		{
			return this.Read(reader);
		}

		// Token: 0x060001EB RID: 491 RVA: 0x000071B5 File Offset: 0x000053B5
		public override void ReadInto<T>(ES3Reader reader, object obj)
		{
			this.ReadInto(reader, obj);
		}

		// Token: 0x060001EC RID: 492 RVA: 0x000071C0 File Offset: 0x000053C0
		public object Read(ES3Reader reader)
		{
			...
			{
				object obj = reader.Read<object>(this.keyType);
				reader.EndReadDictionaryKey();
				reader.StartReadDictionaryValue();
				object obj2 = reader.Read<object>(this.valueType);
		...
		// Token: 0x060001ED RID: 493 RVA: 0x00007230 File Offset: 0x00005430
