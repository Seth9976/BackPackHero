...
namespace ES3Types
{
	...
	{
		// Token: 0x06000348 RID: 840 RVA: 0x00012268 File Offset: 0x00010468
		...
		// Token: 0x06000349 RID: 841 RVA: 0x00012280 File Offset: 0x00010480
		...
		// Token: 0x0600034A RID: 842 RVA: 0x00014520 File Offset: 0x00012720
		...
		// Token: 0x0600034B RID: 843 RVA: 0x00014548 File Offset: 0x00012748
			...
			foreach (object obj2 in reader.Properties)
			{
				...
				if (num <= 1682465976U)
				{
					if (num <= 919196594U)
					{
						if (num <= 406124255U)
						{
									...
									if (num <= 68591784U)
									{
										if (num != 7127063U)
										{
											if (num != 55328192U)
											{
												if (num == 68591784U)
												{
													if (text == "_LightTextureB0_TextureOffset")
													{
								...
								else if (num <= 153343372U)
								{
									if (num != 141217425U)
									{
										if (num != 148874462U)
										{
											if (num == 153343372U)
											{
												if (text == "_ShadowTex_TextureOffset")
												{
									...
									else if (text == "_ShadowOffset_TextureScale")
									{
										material.SetTextureScale("_ShadowOffset_TextureScale", reader.Read<Vector2>());
										continue;
									}
								}
								else if (num <= 172912383U)
								{
									if (num != 162315826U)
									{
										if (num == 172912383U)
										{
											if (text == "_DownTex_TextureScale")
											{
							...
							else if (num <= 295998671U)
							{
								if (num <= 255833163U)
								{
									if (num != 200583458U)
									{
										if (num != 203733107U)
										{
											if (num == 255833163U)
											{
												if (text == "_TranslucencyViewDependency")
												{
								...
								else if (num <= 279960306U)
								{
									if (num != 260030667U)
									{
										if (num == 279960306U)
										{
											if (text == "_MetallicTex_TextureScale")
											{
									...
									else if (text == "_DetailMask")
									{
										material.SetTexture("_DetailMask", reader.Read<Texture>());
										continue;
									}
								}
								else if (num != 282835344U)
								{
									if (num == 295998671U)
									{
										if (text == "_LightTexture0")
										{
							...
							else if (num <= 343169911U)
							{
								if (num != 328136867U)
								{
									if (num != 341066806U)
									{
										if (num == 343169911U)
										{
											if (text == "_LeftTex_TextureOffset")
											{
								...
								else if (text == "_ShadowMapTexture")
								{
									material.SetTexture("_ShadowMapTexture", reader.Read<Texture>());
									continue;
								}
							}
							else if (num <= 375951392U)
							{
								if (num != 356840113U)
								{
									if (num == 375951392U)
									{
										if (text == "_Normal0_TextureOffset")
										{
							...
							else if (num != 380346447U)
							{
								if (num == 406124255U)
								{
									if (text == "_DetailBump_TextureScale")
									{
						...
						else if (num <= 603015785U)
						{
							if (num <= 553948789U)
							{
								if (num <= 429075365U)
								{
									if (num != 422665670U)
									{
										if (num != 428374000U)
										{
											if (num == 429075365U)
											{
												if (text == "_BumpSpecMap_TextureScale")
												{
								...
								else if (num <= 502476099U)
								{
									...
									else if (text == "_AlphaTex_TextureScale")
									{
										material.SetTextureScale("_AlphaTex_TextureScale", reader.Read<Vector2>());
										continue;
									}
								}
								else if (num != 503558223U)
								{
									if (num == 553948789U)
									{
										if (text == "_HueVariation")
										{
							...
							else if (num <= 581707668U)
							{
								...
								else if (text == "_ShadowStrength")
								{
									material.SetFloat("_ShadowStrength", reader.Read<float>());
									continue;
								}
							}
							else if (num != 598816323U)
							{
								if (num == 603015785U)
								{
									if (text == "_EmissionMap_TextureScale")
									{
						...
						else if (num <= 817165336U)
						{
							...
							else if (num <= 770001181U)
							{
								...
								else if (text == "_BumpMap")
								{
									material.SetTexture("_BumpMap", reader.Read<Texture>());
									continue;
								}
							}
							else if (num != 812059063U)
							{
								if (num == 817165336U)
								{
									if (text == "_MetallicGlossMap_TextureOffset")
									{
						...
						else if (num <= 885641356U)
						{
							...
							else if (text == "_BackTex")
							{
								material.SetTexture("_BackTex", reader.Read<Texture>());
								continue;
							}
						}
						else if (num <= 901275863U)
						{
							if (num != 895309160U)
							{
								if (num == 901275863U)
								{
									if (text == "_UseUIAlphaClip")
									{
						...
						else if (text == "_Metallic2")
						{
							material.SetFloat("_Metallic2", reader.Read<float>());
							continue;
						}
					}
					else if (num <= 1253351323U)
					{
						if (num <= 1045070348U)
						{
							if (num <= 967141699U)
							{
								...
								else if (num <= 962589770U)
								{
									...
									else if (text == "_Normal0")
									{
										material.SetTexture("_Normal0", reader.Read<Texture>());
										continue;
									}
								}
								else if (num != 963292716U)
								{
									if (num == 967141699U)
									{
										if (text == "_MainTex_TextureOffset")
										{
							...
							else if (num <= 986252426U)
							{
								...
								else if (text == "_Normal2")
								{
									material.SetTexture("_Normal2", reader.Read<Texture>());
									continue;
								}
							}
							else if (num != 1036030121U)
							{
								if (num == 1045070348U)
								{
									if (text == "_TranslucencyMap_TextureOffset")
									{
						...
						else if (num <= 1203380659U)
						{
							if (num <= 1164491925U)
							{
								if (num != 1142396659U)
								{
									if (num == 1164491925U)
									{
										if (text == "_RightTex_TextureScale")
										{
							...
							else if (text == "_WavingTint")
							{
								material.SetColor("_WavingTint", reader.Read<Color>());
								continue;
							}
						}
						else if (num <= 1232579662U)
						{
							if (num != 1226578069U)
							{
								if (num == 1232579662U)
								{
									if (text == "_DetailNormalMap")
									{
							...
							else if (text == "_StencilOp")
							{
								material.SetFloat("_StencilOp", reader.Read<float>());
								continue;
							}
						}
						else if (num != 1243036609U)
						{
							if (num == 1253351323U)
							{
								if (text == "_SquashAmount")
								{
					...
					else if (num <= 1462102642U)
					{
						if (num <= 1361083537U)
						{
							if (num <= 1305186703U)
							{
								...
								else if (text == "_Splat0_TextureScale")
								{
									material.SetTextureScale("_Splat0_TextureScale", reader.Read<Vector2>());
									continue;
								}
							}
							else if (num <= 1336190404U)
							{
								if (num != 1319107834U)
								{
									if (num == 1336190404U)
									{
										if (text == "_DownTex_TextureOffset")
										{
								...
								else if (text == "_SkyTint")
								{
									material.SetColor("_SkyTint", reader.Read<Color>());
									continue;
								}
							}
							else if (num != 1348930790U)
							{
								if (num == 1361083537U)
								{
									if (text == "_GlossMap_TextureOffset")
									{
							...
							else if (text == "_SpecularHighlights")
							{
								material.SetFloat("_SpecularHighlights", reader.Read<float>());
								continue;
							}
						}
						else if (num <= 1414313228U)
						{
							if (num != 1398291504U)
							{
								if (num != 1405658179U)
						...
						else if (num <= 1443031040U)
						{
							...
							else if (text == "PixelSnap")
							{
								material.SetFloat("PixelSnap", reader.Read<float>());
								continue;
							}
						}
						else if (num != 1445378660U)
						{
							if (num == 1462102642U)
							{
								if (text == "_GlossMap")
					...
					else if (num <= 1636759524U)
					{
						...
						else if (num <= 1576959784U)
						{
							...
							else if (text == "_DecalTex_TextureScale")
							{
								material.SetTextureScale("_DecalTex_TextureScale", reader.Read<Vector2>());
								continue;
							}
						}
						else if (num != 1605483851U)
						{
							if (num == 1636759524U)
							{
								if (text == "_GroundColor")
								{
						...
						else if (text == "_GlossyReflections")
						{
							material.SetFloat("_GlossyReflections", reader.Read<float>());
							continue;
						}
					}
					else if (num <= 1675615873U)
					{
						if (num <= 1662192275U)
						{
							if (num != 1645414656U)
							...
							else if (text == "_Smoothness3")
							{
								material.SetFloat("_Smoothness3", reader.Read<float>());
								continue;
							}
						}
						else if (num != 1662498466U)
						{
							if (num == 1675615873U)
							{
								if (text == "_Parallax")
						...
						else if (text == "_Splat2_TextureScale")
						{
							material.SetTextureScale("_Splat2_TextureScale", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num <= 1678969894U)
					{
						if (num != 1675639101U)
						{
							if (num == 1678969894U)
							{
								if (text == "_Smoothness1")
								{
						...
						else if (text == "_Normal2_TextureScale")
						{
							material.SetTextureScale("_Normal2_TextureScale", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num != 1682028044U)
					{
						if (num == 1682465976U)
						{
							if (text == "_TexA_TextureScale")
							{
				...
				else if (num <= 2887531476U)
				{
					if (num <= 2154989402U)
					{
						if (num <= 1968933722U)
						{
							...
							else if (num <= 1955116722U)
							{
								...
								else if (text == "_Splat1")
								{
									material.SetTexture("_Splat1", reader.Read<Texture>());
									continue;
								}
							}
							else if (num != 1961687748U)
							{
								if (num == 1968933722U)
								{
									if (text == "_SpecGlossMap_TextureOffset")
									{
							...
							else if (text == "_DstBlend")
							{
								material.SetFloat("_DstBlend", reader.Read<float>());
								continue;
							}
						}
						else if (num <= 2087601404U)
						{
							if (num <= 2015124603U)
							{
								if (num != 1973821157U)
								{
									if (num != 1989027847U)
									{
										if (num == 2015124603U)
										{
											if (text == "_DetailTex_TextureOffset")
											{
						...
						else if (num <= 2146446390U)
						{
							...
							else if (text == "_Cube_TextureScale")
							{
								material.SetTextureScale("_Cube_TextureScale", reader.Read<Vector2>());
								continue;
							}
						}
						else if (num != 2152098340U)
						{
							if (num == 2154989402U)
							{
								if (text == "_EnableExternalAlpha")
								{
					...
					else if (num <= 2598137465U)
					{
						if (num <= 2369371622U)
						{
							...
							else if (num <= 2219190405U)
							{
								...
								else if (text == "_ShadowOffsetScale")
								{
									material.SetFloat("_ShadowOffsetScale", reader.Read<float>());
									continue;
								}
							}
							else if (num != 2273541346U)
							{
								if (num == 2369371622U)
								{
									if (text == "name")
							...
							else if (text == "_ReflectColor")
							{
								material.SetColor("_ReflectColor", reader.Read<Color>());
								continue;
							}
						}
						else if (num <= 2497933263U)
						{
							if (num != 2405197547U)
							{
								if (num != 2453828219U)
								{
									if (num == 2497933263U)
									{
										if (text == "_ShadowMapTexture_TextureScale")
										{
						...
						else if (num <= 2540782072U)
						{
							...
							else if (text == "_ParallaxMap")
							{
								material.SetTexture("_ParallaxMap", reader.Read<Texture>());
								continue;
							}
						}
						else if (num != 2552582851U)
						{
							if (num == 2598137465U)
							{
								if (text == "_ShadowOffset")
								{
					...
					else if (num <= 2817505971U)
					{
						...
						else if (text == "_MainBump_TextureScale")
						{
							material.SetTextureScale("_MainBump_TextureScale", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num <= 2857297588U)
					{
						if (num != 2850321074U)
						{
							if (num == 2857297588U)
							{
								if (text == "_Control_TextureOffset")
								{
						...
						else if (text == "_EmissionMap_TextureOffset")
						{
							material.SetTextureOffset("_EmissionMap_TextureOffset", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num != 2871490548U)
					{
						if (num == 2887531476U)
						{
							if (text == "_OcclusionMap_TextureOffset")
							{
				...
				else if (num <= 3592552492U)
				{
					if (num <= 3210237587U)
					{
						if (num <= 3043693480U)
						{
							...
							else if (num <= 3022067111U)
							{
								...
								else if (text == "_SpecColor")
								{
									material.SetColor("_SpecColor", reader.Read<Color>());
									continue;
								}
							}
							else if (num != 3024523485U)
							{
								if (num == 3043693480U)
								{
									if (text == "_LightTexture0_TextureOffset")
									{
						...
						else if (num <= 3184520309U)
						{
							...
							else if (text == "_RightTex_TextureOffset")
							{
								material.SetTextureOffset("_RightTex_TextureOffset", reader.Read<Vector2>());
								continue;
							}
						}
						else if (num != 3201642425U)
						{
							if (num == 3210237587U)
							{
								if (text == "_Normal1_TextureOffset")
								{
						...
						else if (text == "_SunSize")
						{
							material.SetFloat("_SunSize", reader.Read<float>());
							continue;
						}
					}
					else if (num <= 3438695487U)
					{
						if (num <= 3329971224U)
						{
							if (num != 3294514723U)
					...
					else if (num <= 3466366380U)
					{
						...
						else if (text == "_Splat2_TextureOffset")
						{
							material.SetTextureOffset("_Splat2_TextureOffset", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num <= 3550408357U)
					{
						if (num != 3485684074U)
						{
							if (num == 3550408357U)
							{
								if (text == "_SmoothnessTextureChannel")
								{
						...
						else if (text == "_ShadowOffset_TextureOffset")
						{
							material.SetTextureOffset("_ShadowOffset_TextureOffset", reader.Read<Vector2>());
							continue;
						}
					}
					else if (num != 3589955780U)
					{
						if (num == 3592552492U)
						{
							if (text == "_DetailMask_TextureOffset")
							{
				...
				else if (num <= 3955420539U)
				{
					if (num <= 3756110474U)
					{
						if (num <= 3656027575U)
						{
							if (num != 3644696525U)
							{
								if (num != 3655253552U)
								{
									if (num == 3656027575U)
									{
										if (text == "_TranslucencyMap_TextureScale")
										{
								...
								else if (text == "renderQueue")
								{
									material.renderQueue = reader.Read<int>(ES3Type_int.Instance);
									continue;
								}
							}
							else if (text == "_ColorMask")
							{
								material.SetFloat("_ColorMask", reader.Read<float>());
								continue;
							}
						}
						else if (num <= 3724010068U)
						{
							if (num != 3670141549U)
							{
								if (num == 3724010068U)
								{
									if (text == "_ShadowMapTexture_TextureOffset")
									{
						...
						else if (num != 3744703109U)
						{
							if (num == 3756110474U)
							{
								if (text == "_DetailTex_TextureScale")
								{
						...
						else if (text == "_WindQuality")
						{
							material.SetFloat("_WindQuality", reader.Read<float>());
							continue;
						}
					}
					else if (num <= 3838020807U)
					{
						if (num != 3796889148U)
						{
							if (num != 3813440219U)
					...
					else if (num <= 3924849459U)
					{
						...
						else if (text == "_GlossMapScale")
						{
							material.SetFloat("_GlossMapScale", reader.Read<float>());
							continue;
						}
					}
					else if (num != 3953642293U)
					{
						if (num == 3955420539U)
						{
							if (text == "_Splat3_TextureScale")
							{
				...
				else if (num <= 4168428097U)
				{
					if (num <= 4114388399U)
					{
						...
						else if (text == "_SecondTex")
						{
							material.SetTexture("_SecondTex", reader.Read<Texture>());
							continue;
						}
					}
					else if (num != 4157429958U)
					{
						if (num == 4168428097U)
						{
							if (text == "_StencilWriteMask")
							{
					...
					else if (text == "_Splat1_TextureOffset")
					{
						material.SetTextureOffset("_Splat1_TextureOffset", reader.Read<Vector2>());
						continue;
					}
				}
				else if (num <= 4191347155U)
				{
					if (num != 4171477713U)
					{
						if (num == 4191347155U)
						{
							if (text == "_DetailAlbedoMap_TextureOffset")
							{
					...
					else if (text == "_EmissionMap")
					{
						material.SetTexture("_EmissionMap", reader.Read<Texture>());
						continue;
					}
				}
				else if (num != 4248419892U)
				{
					if (num == 4276686489U)
					{
						if (text == "_FrontTex_TextureOffset")
						{
