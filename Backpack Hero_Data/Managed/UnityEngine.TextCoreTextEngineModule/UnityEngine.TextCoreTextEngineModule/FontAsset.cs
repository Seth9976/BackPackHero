...
namespace UnityEngine.TextCore.Text
{
	...
	public class FontAsset : TextAsset
	{
		...
		private static FontAsset CreateFontAssetInstance(Font font, int atlasPadding, GlyphRenderMode renderMode, int atlasWidth, int atlasHeight, AtlasPopulationMode atlasPopulationMode, bool enableMultiAtlasSupport)
		{
			...
			List<GlyphRect> list = new List<GlyphRect>(8);
		...
		private FontEngineError LoadFontFace()
		{
			...
			if (flag)
			{
				fontEngineError = FontEngine.LoadFontFace(this.m_SourceFontFile, this.m_FaceInfo.pointSize, this.m_FaceInfo.faceIndex);
			}
			else
			{
		...
		public bool HasCharacter(char character, bool searchFallbacks = false, bool tryAddCharacter = false)
		{
			...
			else
			{
				...
				if (flag5)
				{
					...
					bool flag6 = this.TryAddCharacterInternal((uint)character, out character2, false);
					if (flag6)
					{
						return true;
					}
				...
				if (searchFallbacks)
				{
					...
					if (flag8)
					{
						...
						while (num < this.fallbackFontAssetTable.Count && this.fallbackFontAssetTable[num] != null)
						{
							...
							if (flag9)
							{
								bool flag10 = fontAsset.HasCharacter_Internal((uint)character, true, tryAddCharacter);
								if (flag10)
								{
									return true;
								}
		...
		public bool HasCharacters(string text, out uint[] missingCharacters, bool searchFallbacks = false, bool tryAddCharacter = false)
		{
			...
			{
				bool flag3 = true;
				uint num = (uint)text.get_Chars(i);
		...
		public bool TryAddCharacters(uint[] unicodes, out uint[] missingUnicodes, bool includeFontFeatures = false)
		{
			...
			else
			{
				...
				if (flag4)
				{
					missingUnicodes = Enumerable.ToArray<uint>(unicodes);
					FontAsset.k_TryAddCharactersMarker.End();
					flag3 = false;
				}
				else
				{
					...
					{
						bool flag14 = this.m_AtlasTextures[this.m_AtlasTextureIndex].width == 0 || this.m_AtlasTextures[this.m_AtlasTextureIndex].height == 0;
						if (flag14)
						{
						...
						for (int j = 0; j < this.m_CharactersToAdd.Count; j++)
						{
							...
							Glyph glyph2;
							bool flag16 = !this.m_GlyphLookupDictionary.TryGetValue(character2.glyphIndex, ref glyph2);
							if (flag16)
							{
		...
		// Token: 0x06000078 RID: 120 RVA: 0x000043DC File Offset: 0x000025DC
		...
		// Token: 0x06000079 RID: 121 RVA: 0x000043F8 File Offset: 0x000025F8
		...
		// Token: 0x0600007A RID: 122 RVA: 0x00004930 File Offset: 0x00002B30
		...
		// Token: 0x0600007B RID: 123 RVA: 0x00004D30 File Offset: 0x00002F30
		...
		// Token: 0x0600007D RID: 125 RVA: 0x00004F24 File Offset: 0x00003124
		private bool TryAddGlyphsToNewAtlasTexture()
		{
			...
			for (int i = 0; i < this.m_CharactersToAdd.Count; i++)
			{
				...
				Glyph glyph2;
				bool flag2 = !this.m_GlyphLookupDictionary.TryGetValue(character.glyphIndex, ref glyph2);
				if (flag2)
				{
		...
		// Token: 0x0600007E RID: 126 RVA: 0x000050A4 File Offset: 0x000032A4
		...
		internal void UpdateAtlasTexture()
		{
			...
			if (!flag)
			{
				bool flag2 = this.m_AtlasTextures[this.m_AtlasTextureIndex].width == 0 || this.m_AtlasTextures[this.m_AtlasTextureIndex].height == 0;
				if (flag2)
				{
					this.m_AtlasTextures[this.m_AtlasTextureIndex].Reinitialize(this.m_AtlasWidth, this.m_AtlasHeight);
					FontEngine.ResetAtlasTexture(this.m_AtlasTextures[this.m_AtlasTextureIndex]);
		...
		// Token: 0x06000080 RID: 128 RVA: 0x00005208 File Offset: 0x00003408
		...
		// Token: 0x06000081 RID: 129 RVA: 0x00005338 File Offset: 0x00003538
		...
		// Token: 0x06000084 RID: 132 RVA: 0x00005450 File Offset: 0x00003650
		...
		// Token: 0x06000085 RID: 133 RVA: 0x0000549F File Offset: 0x0000369F
		...
		// Token: 0x06000086 RID: 134 RVA: 0x000054CE File Offset: 0x000036CE
		...
		// Token: 0x06000087 RID: 135 RVA: 0x000054E0 File Offset: 0x000036E0
		...
		// Token: 0x06000088 RID: 136 RVA: 0x0000556C File Offset: 0x0000376C
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00005680 File Offset: 0x00003880
		internal void ClearAtlasTextures(bool setAtlasSizeToZero = false)
		{
			...
			if (!flag)
			{
				...
				{
					texture2D.Reinitialize(0, 0, TextureFormat.Alpha8, false);
				}
				else
				{
		...
		// Token: 0x0600008A RID: 138 RVA: 0x00005778 File Offset: 0x00003978
