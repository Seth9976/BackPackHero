...
namespace UnityEngine.TextCore.Text
{
	...
	{
		// Token: 0x0600011D RID: 285 RVA: 0x00008B18 File Offset: 0x00006D18
		...
		// Token: 0x0600011E RID: 286 RVA: 0x00008B48 File Offset: 0x00006D48
		...
		// Token: 0x0600011F RID: 287 RVA: 0x00008BCC File Offset: 0x00006DCC
		...
		// Token: 0x06000120 RID: 288 RVA: 0x00008C34 File Offset: 0x00006E34
		...
		// Token: 0x06000121 RID: 289 RVA: 0x00008D60 File Offset: 0x00006F60
		...
		// Token: 0x06000122 RID: 290 RVA: 0x00008DC0 File Offset: 0x00006FC0
		...
		// Token: 0x06000123 RID: 291 RVA: 0x00008E20 File Offset: 0x00007020
		...
		// Token: 0x06000124 RID: 292 RVA: 0x00008E80 File Offset: 0x00007080
		...
		// Token: 0x06000125 RID: 293 RVA: 0x00008F60 File Offset: 0x00007160
		private void GenerateTextMesh(TextGenerationSettings generationSettings, TextInfo textInfo)
		{
			...
			if (!flag)
			{
				...
				else
				{
					...
					while (num13 < this.m_CharBuffer.Length && this.m_CharBuffer[num13] != 0)
					{
						...
						if (enableKerning)
						{
							...
							if (flag28)
							{
								...
								uint num20 = (glyphIndex2 << 16) | glyphIndex;
								bool flag29 = this.m_CurrentFontAsset.m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup.TryGetValue(num20, ref glyphPairAdjustmentRecord);
								if (flag29)
								{
							...
							if (flag30)
							{
								...
								uint num21 = (glyphIndex << 16) | glyphIndex3;
								bool flag31 = this.m_CurrentFontAsset.m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup.TryGetValue(num21, ref glyphPairAdjustmentRecord);
								if (flag31)
								{
						...
						if (flag33)
						{
							num22 = (this.m_MonoSpacing / 2f - (this.m_CachedTextElement.glyph.metrics.width / 2f + this.m_CachedTextElement.glyph.metrics.horizontalBearingX) * num2) * (1f - this.m_CharWidthAdjDelta);
						...
						if (flag34)
						{
							...
							if (flag35)
							{
								...
								num23 = this.m_CurrentFontAsset.boldStyleWeight / 4f * @float * this.m_CurrentMaterial.GetFloat(TextShaderUtilities.ID_ScaleRatio_A);
								bool flag36 = num23 + num3 > @float;
								if (flag36)
								{
									num3 = @float - num23;
								}
						...
						else
						{
							...
							if (flag37)
							{
								...
								num23 = this.m_CurrentFontAsset.regularStyleWeight / 4f * float2 * this.m_CurrentMaterial.GetFloat(TextShaderUtilities.ID_ScaleRatio_A);
								bool flag38 = num23 + num3 > float2;
								if (flag38)
								{
									num3 = float2 - num23;
								}
						...
						float num24 = this.m_CurrentFontAsset.faceInfo.baseline * this.m_FontScale * this.m_FontScaleMultiplier * this.m_CurrentFontAsset.faceInfo.scale;
						Vector3 vector3;
						vector3.x = this.m_XAdvance + (this.m_CachedTextElement.glyph.metrics.horizontalBearingX - num3 - num23 + glyphValueRecord.xPlacement) * num2 * (1f - this.m_CharWidthAdjDelta);
						vector3.y = num24 + (this.m_CachedTextElement.glyph.metrics.horizontalBearingY + num3 + glyphValueRecord.yPlacement) * num2 - this.m_LineOffset + this.m_BaselineOffset;
						vector3.z = 0f;
						Vector3 vector4;
						vector4.x = vector3.x;
						...
						vector4.z = 0f;
						Vector3 vector5;
						vector5.x = vector4.x + (this.m_CachedTextElement.glyph.metrics.width + num3 * 2f + num23 * 2f) * num2 * (1f - this.m_CharWidthAdjDelta);
						vector5.y = vector3.y;
						vector5.z = 0f;
						Vector3 vector6;
						vector6.x = vector5.x;
						...
						if (flag39)
						{
							float num25 = (float)this.m_CurrentFontAsset.italicStyleSlant * 0.01f;
							Vector3 vector7 = new Vector3(num25 * ((this.m_CachedTextElement.glyph.metrics.horizontalBearingY + num3 + num23) * num2), 0f, 0f);
							Vector3 vector8 = new Vector3(num25 * ((this.m_CachedTextElement.glyph.metrics.horizontalBearingY - this.m_CachedTextElement.glyph.metrics.height - num3 - num23) * num2), 0f, 0f);
							vector3 += vector7;
							vector4 += vector8;
							vector5 += vector7;
							vector6 += vector8;
						...
						textInfo.textElementInfo[this.m_CharacterCount].baseLine = num24 - this.m_LineOffset + this.m_BaselineOffset;
						textInfo.textElementInfo[this.m_CharacterCount].aspectRatio = (vector5.x - vector4.x) / (vector3.y - vector4.y);
						float num26 = this.m_CurrentFontAsset.faceInfo.ascentLine * ((this.m_TextElementType == TextElementType.Character) ? (num2 / num17) : textInfo.textElementInfo[this.m_CharacterCount].scale) + this.m_BaselineOffset;
						textInfo.textElementInfo[this.m_CharacterCount].ascender = num26 - this.m_LineOffset;
						this.m_MaxLineAscender = ((num26 > this.m_MaxLineAscender) ? num26 : this.m_MaxLineAscender);
						float num27 = this.m_CurrentFontAsset.faceInfo.descentLine * ((this.m_TextElementType == TextElementType.Character) ? (num2 / num17) : textInfo.textElementInfo[this.m_CharacterCount].scale) + this.m_BaselineOffset;
						float num28 = (textInfo.textElementInfo[this.m_CharacterCount].descender = num27 - this.m_LineOffset);
						...
						if (flag40)
						{
							float num29 = (num26 - this.m_BaselineOffset) / this.m_CurrentFontAsset.faceInfo.subscriptSize;
							num26 = this.m_MaxLineAscender;
							this.m_MaxLineAscender = ((num29 > this.m_MaxLineAscender) ? num29 : this.m_MaxLineAscender);
							float num30 = (num27 - this.m_BaselineOffset) / this.m_CurrentFontAsset.faceInfo.subscriptSize;
							num27 = this.m_MaxLineDescender;
							this.m_MaxLineDescender = ((num30 < this.m_MaxLineDescender) ? num30 : this.m_MaxLineDescender);
						}
						bool flag41 = this.m_LineNumber == 0 || this.m_IsNewPage;
						if (flag41)
						{
							this.m_MaxAscender = ((this.m_MaxAscender > num26) ? this.m_MaxAscender : num26);
						...
						if (flag43)
						{
							...
							float num31 = Mathf.Abs(this.m_XAdvance) + ((!generationSettings.isRightToLeft) ? this.m_CachedTextElement.glyph.metrics.horizontalAdvance : 0f) * (1f - this.m_CharWidthAdjDelta) * ((num14 != 173) ? num2 : num19);
							bool flag45 = num31 > num9 * (flag44 ? 1.05f : 1f);
							if (flag45)
							{
								...
								if (flag46)
								{
									...
									if (flag54)
									{
										...
										TextGeneratorUtilities.AdjustLineOffset(this.m_FirstCharacterOfLine, this.m_CharacterCount, num32, textInfo);
									...
									this.m_MaxDescender = ((this.m_MaxDescender < num34) ? this.m_MaxDescender : num34);
									bool flag55 = !flag7;
									if (flag55)
									{
									...
									textInfo.lineInfo[this.m_LineNumber].lineExtents.min = new Vector2(textInfo.textElementInfo[this.m_FirstVisibleCharacterOfLine].bottomLeft.x, num34);
									textInfo.lineInfo[this.m_LineNumber].lineExtents.max = new Vector2(textInfo.textElementInfo[this.m_LastVisibleCharacterOfLine].topRight.x, num33);
									...
									textInfo.lineInfo[this.m_LineNumber].ascender = num33;
									textInfo.lineInfo[this.m_LineNumber].descender = num34;
									textInfo.lineInfo[this.m_LineNumber].lineHeight = num33 - num34 + num5 * num;
									...
									if (flag58)
									{
										float num35 = textInfo.textElementInfo[this.m_CharacterCount].ascender - textInfo.textElementInfo[this.m_CharacterCount].baseLine;
										float num36 = 0f - this.m_MaxLineDescender + num35 + (num5 + generationSettings.lineSpacing + this.m_LineSpacingDelta) * num;
							...
							else
							{
								...
								if (flag67)
								{
									this.SaveGlyphVertexInfo(num3, num23, color, generationSettings, textInfo);
								}
								else
								{
						...
						if (flag73)
						{
							...
							TextGeneratorUtilities.AdjustLineOffset(this.m_FirstCharacterOfLine, this.m_CharacterCount, num37, textInfo);
							num28 -= num37;
						...
						bool flag75 = this.m_MaxAscender - num28 > marginHeight + 0.0001f;
						if (flag75)
						{
						...
						if (flag89)
						{
							float num38 = this.m_CurrentFontAsset.faceInfo.tabWidth * (float)this.m_CurrentFontAsset.tabMultiple * num2;
						...
						else
						{
							...
							if (flag90)
							{
								this.m_XAdvance += (this.m_MonoSpacing - num22 + (generationSettings.characterSpacing + this.m_CurrentFontAsset.regularStyleSpacing) * num2 + this.m_CSpacing) * (1f - this.m_CharWidthAdjDelta);
							...
							else
							{
								...
								if (flag92)
								{
									...
									if (isFxMatrixSet2)
									{
										num40 = this.m_FxMatrix.m00;
									}
									this.m_XAdvance += ((this.m_CachedTextElement.glyph.metrics.horizontalAdvance * num40 * num4 + generationSettings.characterSpacing + this.m_CurrentFontAsset.regularStyleSpacing + glyphValueRecord.xAdvance) * num2 + this.m_CSpacing) * (1f - this.m_CharWidthAdjDelta);
						...
						if (flag95)
						{
							...
							if (flag96)
							{
								...
								TextGeneratorUtilities.AdjustLineOffset(this.m_FirstCharacterOfLine, this.m_CharacterCount, num41, textInfo);
								this.m_LineOffset += num41;
							}
							this.m_IsNewPage = false;
							float num42 = this.m_MaxLineAscender - this.m_LineOffset;
							float num43 = this.m_MaxLineDescender - this.m_LineOffset;
							this.m_MaxDescender = ((this.m_MaxDescender < num43) ? this.m_MaxDescender : num43);
							bool flag97 = !flag7;
							if (flag97)
							{
								num11 = this.m_MaxDescender;
							...
							textInfo.lineInfo[this.m_LineNumber].characterCount = textInfo.lineInfo[this.m_LineNumber].lastCharacterIndex - textInfo.lineInfo[this.m_LineNumber].firstCharacterIndex + 1;
							textInfo.lineInfo[this.m_LineNumber].visibleCharacterCount = this.m_LineVisibleCharacterCount;
							textInfo.lineInfo[this.m_LineNumber].lineExtents.min = new Vector2(textInfo.textElementInfo[this.m_FirstVisibleCharacterOfLine].bottomLeft.x, num43);
							textInfo.lineInfo[this.m_LineNumber].lineExtents.max = new Vector2(textInfo.textElementInfo[this.m_LastVisibleCharacterOfLine].topRight.x, num42);
							...
							textInfo.lineInfo[this.m_LineNumber].baseline = 0f - this.m_LineOffset;
							textInfo.lineInfo[this.m_LineNumber].ascender = num42;
							textInfo.lineInfo[this.m_LineNumber].descender = num43;
							textInfo.lineInfo[this.m_LineNumber].lineHeight = num42 - num43 + num5 * num;
							...
							if (flag100)
							{
								...
								if (flag102)
								{
									float num36 = 0f - this.m_MaxLineDescender + num26 + (num5 + generationSettings.lineSpacing + generationSettings.paragraphSpacing + this.m_LineSpacingDelta) * num;
									this.m_LineOffset += num36;
								}
								else
								{
						...
						if (flag103)
						{
							...
							textInfo.pageInfo[this.m_PageNumber].descender = ((num27 < textInfo.pageInfo[this.m_PageNumber].descender) ? num27 : textInfo.pageInfo[this.m_PageNumber].descender);
					...
					float num44 = this.m_MaxFontSize - this.m_MinFontSize;
					bool flag113 = !this.m_IsCharacterWrappingEnabled && generationSettings.autoSize && num44 > 0.051f && this.m_FontSize < generationSettings.fontSizeMax;
					if (flag113)
					{
					...
					else
					{
						...
						{
							int num45 = this.m_MaterialReferences[0].referenceCount * 4;
							...
							while (i < this.m_CharacterCount)
							{
								...
								if (flag121)
								{
									...
									else
									{
										...
										float num58 = generationSettings.uvLineOffset * (float)lineNumber3 % 1f;
										...
										case TextureMapping.Line:
										{
											...
											if (flag122)
											{
												textElementInfo[i].vertexBottomLeft.uv2.x = (textElementInfo[i].vertexBottomLeft.position.x - lineExtents.min.x) / (lineExtents.max.x - lineExtents.min.x) + num58;
												textElementInfo[i].vertexTopLeft.uv2.x = (textElementInfo[i].vertexTopLeft.position.x - lineExtents.min.x) / (lineExtents.max.x - lineExtents.min.x) + num58;
												textElementInfo[i].vertexTopRight.uv2.x = (textElementInfo[i].vertexTopRight.position.x - lineExtents.min.x) / (lineExtents.max.x - lineExtents.min.x) + num58;
												textElementInfo[i].vertexBottomRight.uv2.x = (textElementInfo[i].vertexBottomRight.position.x - lineExtents.min.x) / (lineExtents.max.x - lineExtents.min.x) + num58;
											}
											else
											{
												textElementInfo[i].vertexBottomLeft.uv2.x = (textElementInfo[i].vertexBottomLeft.position.x + vector11.x - this.m_MeshExtents.min.x) / (this.m_MeshExtents.max.x - this.m_MeshExtents.min.x) + num58;
												textElementInfo[i].vertexTopLeft.uv2.x = (textElementInfo[i].vertexTopLeft.position.x + vector11.x - this.m_MeshExtents.min.x) / (this.m_MeshExtents.max.x - this.m_MeshExtents.min.x) + num58;
												textElementInfo[i].vertexTopRight.uv2.x = (textElementInfo[i].vertexTopRight.position.x + vector11.x - this.m_MeshExtents.min.x) / (this.m_MeshExtents.max.x - this.m_MeshExtents.min.x) + num58;
												textElementInfo[i].vertexBottomRight.uv2.x = (textElementInfo[i].vertexBottomRight.position.x + vector11.x - this.m_MeshExtents.min.x) / (this.m_MeshExtents.max.x - this.m_MeshExtents.min.x) + num58;
											}
											break;
										}
										...
										case TextureMapping.MatchAspect:
										{
											...
											case TextureMapping.Character:
												...
												break;
											case TextureMapping.Line:
												textElementInfo[i].vertexBottomLeft.uv2.y = (textElementInfo[i].vertexBottomLeft.position.y - lineExtents.min.y) / (lineExtents.max.y - lineExtents.min.y) + num58;
												textElementInfo[i].vertexTopLeft.uv2.y = (textElementInfo[i].vertexTopLeft.position.y - lineExtents.min.y) / (lineExtents.max.y - lineExtents.min.y) + num58;
												...
												break;
											case TextureMapping.Paragraph:
												textElementInfo[i].vertexBottomLeft.uv2.y = (textElementInfo[i].vertexBottomLeft.position.y - this.m_MeshExtents.min.y) / (this.m_MeshExtents.max.y - this.m_MeshExtents.min.y) + num58;
												textElementInfo[i].vertexTopLeft.uv2.y = (textElementInfo[i].vertexTopLeft.position.y - this.m_MeshExtents.min.y) / (this.m_MeshExtents.max.y - this.m_MeshExtents.min.y) + num58;
												textElementInfo[i].vertexTopRight.uv2.y = textElementInfo[i].vertexBottomLeft.uv2.y;
												textElementInfo[i].vertexBottomRight.uv2.y = textElementInfo[i].vertexTopLeft.uv2.y;
												break;
											case TextureMapping.MatchAspect:
											...
											float num59 = (1f - (textElementInfo[i].vertexBottomLeft.uv2.y + textElementInfo[i].vertexTopLeft.uv2.y) * textElementInfo[i].aspectRatio) / 2f;
											textElementInfo[i].vertexBottomLeft.uv2.x = textElementInfo[i].vertexBottomLeft.uv2.y * textElementInfo[i].aspectRatio + num59 + num58;
											textElementInfo[i].vertexTopLeft.uv2.x = textElementInfo[i].vertexBottomLeft.uv2.x;
											textElementInfo[i].vertexTopRight.uv2.x = textElementInfo[i].vertexTopLeft.uv2.y * textElementInfo[i].aspectRatio + num59 + num58;
										...
										case TextureMapping.MatchAspect:
										{
											float num60 = (1f - (textElementInfo[i].vertexBottomLeft.uv2.x + textElementInfo[i].vertexTopRight.uv2.x) / textElementInfo[i].aspectRatio) / 2f;
											textElementInfo[i].vertexBottomLeft.uv2.y = num60 + textElementInfo[i].vertexBottomLeft.uv2.x / textElementInfo[i].aspectRatio;
											textElementInfo[i].vertexTopLeft.uv2.y = num60 + textElementInfo[i].vertexTopRight.uv2.x / textElementInfo[i].aspectRatio;
											textElementInfo[i].vertexBottomRight.uv2.y = textElementInfo[i].vertexBottomLeft.uv2.y;
											textElementInfo[i].vertexTopRight.uv2.y = textElementInfo[i].vertexTopLeft.uv2.y;
											break;
										}
										}
										num50 = textElementInfo[i].scale * (1f - this.m_CharWidthAdjDelta) * 1f;
										...
										textElementInfo[i].vertexBottomLeft.uv2.y = num50;
										textElementInfo[i].vertexTopLeft.uv2.x = 1f;
										textElementInfo[i].vertexTopLeft.uv2.y = num50;
										textElementInfo[i].vertexTopRight.uv2.x = 1f;
										textElementInfo[i].vertexTopRight.uv2.y = num50;
										textElementInfo[i].vertexBottomRight.uv2.x = 1f;
										textElementInfo[i].vertexBottomRight.uv2.y = num50;
									}
									bool flag124 = i < generationSettings.maxVisibleCharacters && num46 < generationSettings.maxVisibleWords && lineNumber3 < generationSettings.maxVisibleLines && generationSettings.overflowMode != TextOverflowMode.Page;
									if (flag124)
									{
									...
									{
										bool flag125 = i < generationSettings.maxVisibleCharacters && num46 < generationSettings.maxVisibleWords && lineNumber3 < generationSettings.maxVisibleLines && generationSettings.overflowMode == TextOverflowMode.Page && textElementInfo[i].pageNumber == num6;
										if (flag125)
										{
											ptr = ref textElementInfo[i].vertexBottomLeft.position;
											ptr += vector12;
								...
								int num61 = i;
								textElementInfo2[num61].origin = textElementInfo2[num61].origin + vector12.x;
								TextElementInfo[] textElementInfo3 = textInfo.textElementInfo;
								int num62 = i;
								textElementInfo3[num62].xAdvance = textElementInfo3[num62].xAdvance + vector12.x;
								TextElementInfo[] textElementInfo4 = textInfo.textElementInfo;
								int num63 = i;
								textElementInfo4[num63].ascender = textElementInfo4[num63].ascender + vector12.y;
								TextElementInfo[] textElementInfo5 = textInfo.textElementInfo;
								int num64 = i;
								textElementInfo5[num64].descender = textElementInfo5[num64].descender + vector12.y;
								TextElementInfo[] textElementInfo6 = textInfo.textElementInfo;
								int num65 = i;
								textElementInfo6[num65].baseLine = textElementInfo6[num65].baseLine + vector12.y;
								bool flag128 = lineNumber3 != num48 || i == this.m_CharacterCount - 1;
								if (flag128)
								{
									bool flag129 = lineNumber3 != num48;
									if (flag129)
									{
										LineInfo[] lineInfo4 = textInfo.lineInfo;
										int num66 = num48;
										lineInfo4[num66].baseline = lineInfo4[num66].baseline + vector12.y;
										LineInfo[] lineInfo5 = textInfo.lineInfo;
										int num67 = num48;
										lineInfo5[num67].ascender = lineInfo5[num67].ascender + vector12.y;
										LineInfo[] lineInfo6 = textInfo.lineInfo;
										int num68 = num48;
										lineInfo6[num68].descender = lineInfo6[num68].descender + vector12.y;
										textInfo.lineInfo[num48].lineExtents.min = new Vector2(textInfo.textElementInfo[textInfo.lineInfo[num48].firstCharacterIndex].bottomLeft.x, textInfo.lineInfo[num48].descender);
										textInfo.lineInfo[num48].lineExtents.max = new Vector2(textInfo.textElementInfo[textInfo.lineInfo[num48].lastVisibleCharacterIndex].topRight.x, textInfo.lineInfo[num48].ascender);
									}
									...
									if (flag130)
									{
										...
										lineInfo7[num69].baseline = lineInfo7[num69].baseline + vector12.y;
										LineInfo[] lineInfo8 = textInfo.lineInfo;
										int num70 = lineNumber3;
										lineInfo8[num70].ascender = lineInfo8[num70].ascender + vector12.y;
										LineInfo[] lineInfo9 = textInfo.lineInfo;
										int num71 = lineNumber3;
										lineInfo9[num71].descender = lineInfo9[num71].descender + vector12.y;
								...
								if (flag131)
								{
									...
									if (flag133)
									{
										int num72 = textInfo.wordInfo.Length;
										int wordCount = textInfo.wordCount;
										bool flag134 = textInfo.wordCount + 1 > num72;
										if (flag134)
										{
											TextInfo.Resize<WordInfo>(ref textInfo.wordInfo, num72 + 1);
										}
										int num73 = i;
										textInfo.wordInfo[wordCount].firstCharacterIndex = num49;
										textInfo.wordInfo[wordCount].lastCharacterIndex = num73;
										textInfo.wordInfo[wordCount].characterCount = num73 - num49 + 1;
										num46++;
										textInfo.wordCount++;
										LineInfo[] lineInfo10 = textInfo.lineInfo;
										int num74 = lineNumber3;
										lineInfo10[num74].wordCount = lineInfo10[num74].wordCount + 1;
									}
								}
								else
								{
									...
									if (flag135)
									{
										...
										if (flag136)
										{
											int num73 = ((i == this.m_CharacterCount - 1 && char.IsLetterOrDigit(character)) ? i : (i - 1));
											flag120 = false;
											int num75 = textInfo.wordInfo.Length;
											int wordCount2 = textInfo.wordCount;
											bool flag137 = textInfo.wordCount + 1 > num75;
											if (flag137)
											{
												TextInfo.Resize<WordInfo>(ref textInfo.wordInfo, num75 + 1);
											}
											textInfo.wordInfo[wordCount2].firstCharacterIndex = num49;
											textInfo.wordInfo[wordCount2].lastCharacterIndex = num73;
											textInfo.wordInfo[wordCount2].characterCount = num73 - num49 + 1;
											num46++;
											textInfo.wordCount++;
											LineInfo[] lineInfo11 = textInfo.lineInfo;
											int num76 = lineNumber3;
											lineInfo11[num76].wordCount = lineInfo11[num76].wordCount + 1;
										}
									}
								}
								...
								if (flag139)
								{
									...
									if (flag142)
									{
										num52 = Mathf.Max(num52, textInfo.textElementInfo[i].scale);
										num53 = Mathf.Min((pageNumber == num54) ? num53 : 32767f, textInfo.textElementInfo[i].baseLine + generationSettings.fontAsset.faceInfo.underlineOffset * num52);
										num54 = pageNumber;
									}
									...
									if (flag143)
									{
										...
										{
											flag3 = true;
											num51 = textInfo.textElementInfo[i].scale;
											bool flag145 = num52 == 0f;
											if (flag145)
											{
												num52 = num51;
											}
											zero = new Vector3(textInfo.textElementInfo[i].bottomLeft.x, num53, 0f);
									...
									{
										flag3 = false;
										Vector3 vector13 = new Vector3(textInfo.textElementInfo[i].topRight.x, num53, 0f);
										float num77 = textInfo.textElementInfo[i].scale;
										this.DrawUnderlineMesh(zero, vector13, ref num45, num51, num77, num52, num50, color2, generationSettings, textInfo);
										num52 = 0f;
										num53 = 32767f;
									}
									else
									{
										...
										if (flag147)
										{
											...
											if (flag148)
											{
												...
												vector13 = new Vector3(textInfo.textElementInfo[lastVisibleCharacterIndex].topRight.x, num53, 0f);
												num77 = textInfo.textElementInfo[lastVisibleCharacterIndex].scale;
											}
											else
											{
												vector13 = new Vector3(textInfo.textElementInfo[i].topRight.x, num53, 0f);
												num77 = textInfo.textElementInfo[i].scale;
											}
											flag3 = false;
											this.DrawUnderlineMesh(zero, vector13, ref num45, num51, num77, num52, num50, color2, generationSettings, textInfo);
											num52 = 0f;
										...
										else
										{
											...
											{
												flag3 = false;
												Vector3 vector13 = new Vector3(textInfo.textElementInfo[i - 1].topRight.x, num53, 0f);
												float num77 = textInfo.textElementInfo[i - 1].scale;
												this.DrawUnderlineMesh(zero, vector13, ref num45, num51, num77, num52, num50, color2, generationSettings, textInfo);
												num52 = 0f;
												num53 = 32767f;
											}
								...
								if (flag153)
								{
									...
									if (flag155)
									{
										...
										{
											flag4 = true;
											num55 = textInfo.textElementInfo[i].pointSize;
											num56 = textInfo.textElementInfo[i].scale;
											zero2 = new Vector3(textInfo.textElementInfo[i].bottomLeft.x, textInfo.textElementInfo[i].baseLine + strikethroughOffset * num56, 0f);
											color3 = textInfo.textElementInfo[i].strikethroughColor;
											num57 = textInfo.textElementInfo[i].baseLine;
										}
									}
									...
									{
										flag4 = false;
										Vector3 vector14 = new Vector3(textInfo.textElementInfo[i].topRight.x, textInfo.textElementInfo[i].baseLine + strikethroughOffset * num56, 0f);
										this.DrawUnderlineMesh(zero2, vector14, ref num45, num56, num56, num56, num50, color3, generationSettings, textInfo);
									}
									else
									{
										...
										if (flag158)
										{
											...
											if (flag159)
											{
												...
												vector14 = new Vector3(textInfo.textElementInfo[lastVisibleCharacterIndex2].topRight.x, textInfo.textElementInfo[lastVisibleCharacterIndex2].baseLine + strikethroughOffset * num56, 0f);
											}
											else
											{
												vector14 = new Vector3(textInfo.textElementInfo[i].topRight.x, textInfo.textElementInfo[i].baseLine + strikethroughOffset * num56, 0f);
											}
											flag4 = false;
											this.DrawUnderlineMesh(zero2, vector14, ref num45, num56, num56, num56, num50, color3, generationSettings, textInfo);
										}
										...
										{
											bool flag160 = flag4 && i < this.m_CharacterCount && (textInfo.textElementInfo[i + 1].pointSize != num55 || !TextGeneratorUtilities.Approximately(textInfo.textElementInfo[i + 1].baseLine + vector12.y, num57));
											if (flag160)
											{
												flag4 = false;
												...
												if (flag161)
												{
													vector14 = new Vector3(textInfo.textElementInfo[lastVisibleCharacterIndex3].topRight.x, textInfo.textElementInfo[lastVisibleCharacterIndex3].baseLine + strikethroughOffset * num56, 0f);
												}
												else
												{
													vector14 = new Vector3(textInfo.textElementInfo[i].topRight.x, textInfo.textElementInfo[i].baseLine + strikethroughOffset * num56, 0f);
											...
											else
											{
												...
												else
												{
													...
													{
														flag4 = false;
														Vector3 vector14 = new Vector3(textInfo.textElementInfo[i - 1].topRight.x, textInfo.textElementInfo[i - 1].baseLine + strikethroughOffset * num56, 0f);
														this.DrawUnderlineMesh(zero2, vector14, ref num45, num56, num56, num56, num50, color3, generationSettings, textInfo);
													}
												}
											}
								...
								if (flag166)
								{
									...
									if (flag171)
									{
										...
										if (flag173)
										{
											...
											this.DrawTextHighlight(vector, vector2, ref num45, color4, generationSettings, textInfo);
											flag5 = true;
											vector = vector2;
								...
								if (flag183)
								{
									bool flag184 = lineNumber3 != num48 || i == 0 || i == generationSettings.firstVisibleCharacter;
									if (flag184)
									{
									...
									{
										float num78 = ((!generationSettings.isRightToLeft) ? (lineInfo3.width - lineInfo3.maxAdvance) : (lineInfo3.width + lineInfo3.maxAdvance));
										int num79 = lineInfo3.visibleCharacterCount - 1 + lineInfo3.controlCharacterCount;
										int num80 = (textElementInfo[lineInfo3.lastCharacterIndex].isVisible ? lineInfo3.spaceCount : (lineInfo3.spaceCount - 1)) - lineInfo3.controlCharacterCount;
										...
										float num81 = ((num80 > 0) ? generationSettings.wordWrappingRatio : 1f);
										bool flag188 = num80 < 1;
										if (flag188)
										{
											num80 = 1;
										}
										...
										if (flag189)
										{
											...
											if (flag190)
											{
												vector11 += new Vector3(num78 * (1f - num81) / (float)num80, 0f, 0f);
											}
											else
											{
												vector11 -= new Vector3(num78 * (1f - num81) / (float)num80, 0f, 0f);
										...
										else
										{
											...
											if (flag191)
											{
												vector11 += new Vector3(num78 * num81 / (float)num79, 0f, 0f);
											}
											else
											{
												vector11 -= new Vector3(num78 * num81 / (float)num79, 0f, 0f);
							...
							textInfo.lineCount = num47;
							textInfo.wordCount = ((num46 != 0 && this.m_CharacterCount > 0) ? num46 : 1);
							textInfo.pageCount = this.m_PageNumber + 1;
							textInfo.meshInfo[this.m_Underline.materialIndex].vertexCount = num45;
		...
		// Token: 0x06000126 RID: 294 RVA: 0x0000FBCC File Offset: 0x0000DDCC
		...
		// Token: 0x06000127 RID: 295 RVA: 0x0000FE4C File Offset: 0x0000E04C
		...
		// Token: 0x06000128 RID: 296 RVA: 0x000100D4 File Offset: 0x0000E2D4
		...
		// Token: 0x06000129 RID: 297 RVA: 0x0001044C File Offset: 0x0000E64C
			...
			else if (markupTag <= MarkupTag.SCALE)
			{
				if (markupTag <= MarkupTag.ALPHA)
				{
					...
					else
					{
						if (markupTag == MarkupTag.ALIGN)
						{
							...
							MarkupTag markupTag4 = valueHashCode5;
				...
				else if (markupTag <= MarkupTag.CLASS)
				{
					...
					else
					{
						...
						MarkupTag markupTag5 = valueHashCode6;
		...
		// Token: 0x0600012A RID: 298 RVA: 0x00013CA8 File Offset: 0x00011EA8
		...
		// Token: 0x0600012B RID: 299 RVA: 0x00014294 File Offset: 0x00012494
		...
		// Token: 0x0600012C RID: 300 RVA: 0x00014734 File Offset: 0x00012934
		...
		// Token: 0x0600012D RID: 301 RVA: 0x0001521C File Offset: 0x0001341C
		...
		// Token: 0x0600012E RID: 302 RVA: 0x00015601 File Offset: 0x00013801
		private static void ClearMesh(bool updateMesh, TextInfo textInfo)
		{
			textInfo.ClearMeshInfo(updateMesh);
		}

		// Token: 0x0600012F RID: 303 RVA: 0x0001560C File Offset: 0x0001380C
		private void EnableMasking()
		{
			this.m_IsMaskingEnabled = true;
		}

		// Token: 0x06000130 RID: 304 RVA: 0x00015616 File Offset: 0x00013816
		private void DisableMasking()
		{
			this.m_IsMaskingEnabled = false;
		}

		// Token: 0x06000131 RID: 305 RVA: 0x00015620 File Offset: 0x00013820
		private void SetArraySizes(int[] chars, TextGenerationSettings generationSettings, TextInfo textInfo)
		{
			...
			while (num2 < chars.Length && chars[num2] != 0)
			{
				...
				bool flag15;
				TextElement textElement = this.GetTextElement(generationSettings, (uint)num3, this.m_CurrentFontAsset, this.m_FontStyleInternal, this.m_FontWeightInternal, out flag15);
				bool flag16 = textElement == null;
				if (flag16)
				{
					int num5 = num3;
					num3 = ((textSettings.missingCharacterUnicode == 0) ? 9633 : textSettings.missingCharacterUnicode);
					textElement = FontAssetUtilities.GetCharacterFromFontAsset((uint)num3, this.m_CurrentFontAsset, true, this.m_FontStyleInternal, this.m_FontWeightInternal, out flag15);
					bool flag17 = textElement == null;
					if (flag17)
					{
						bool flag18 = textSettings.fallbackFontAssets != null && textSettings.fallbackFontAssets.Count > 0;
						if (flag18)
						{
							textElement = FontAssetUtilities.GetCharacterFromFontAssets((uint)num3, this.m_CurrentFontAsset, textSettings.fallbackFontAssets, true, this.m_FontStyleInternal, this.m_FontWeightInternal, out flag15);
						}
					}
					bool flag19 = textElement == null;
					if (flag19)
					{
						bool flag20 = textSettings.defaultFontAsset != null;
						if (flag20)
						{
							textElement = FontAssetUtilities.GetCharacterFromFontAsset((uint)num3, textSettings.defaultFontAsset, true, this.m_FontStyleInternal, this.m_FontWeightInternal, out flag15);
						}
					}
					...
					if (flag21)
					{
						...
						if (displayWarnings)
						{
							string text = ((num5 > 65535) ? string.Format("The character with Unicode value \\U{0:X8} was not found in the [{1}] font asset or any potential fallbacks. It was replaced by a space.", num5, generationSettings.fontAsset.name) : string.Format("The character with Unicode value \\u{0:X4} was not found in the [{1}] font asset or any potential fallbacks. It was replaced by a space.", num5, generationSettings.fontAsset.name));
							Debug.LogWarning(text);
						}
					}
				}
				bool flag22 = textElement.elementType == TextElementType.Character;
				if (flag22)
				{
					bool flag23 = textElement.textAsset.instanceID != this.m_CurrentFontAsset.instanceID;
					if (flag23)
					{
						flag7 = true;
				...
				textInfo.textElementInfo[this.m_TotalCharacterCount].isUsingAlternateTypeface = flag15;
				textInfo.textElementInfo[this.m_TotalCharacterCount].character = (char)num3;
				textInfo.textElementInfo[this.m_TotalCharacterCount].fontAsset = this.m_CurrentFontAsset;
				bool flag24 = textElement.elementType == TextElementType.Sprite;
				if (flag24)
				{
				...
				bool flag25 = flag7 && this.m_CurrentFontAsset.instanceID != generationSettings.fontAsset.instanceID;
				if (flag25)
				{
				...
				bool flag26 = textElement != null && textElement.glyph.atlasIndex > 0;
				if (flag26)
				{
				...
				bool flag27 = !char.IsWhiteSpace((char)num3) && num3 != 8203;
				if (flag27)
				{
					bool flag28 = this.m_MaterialReferences[this.m_CurrentMaterialIndex].referenceCount < 16383;
					if (flag28)
					{
			...
			else
			{
				...
				bool flag30 = num6 > textInfo.meshInfo.Length;
				if (flag30)
				{
					TextInfo.Resize<MeshInfo>(ref textInfo.meshInfo, num6, false);
				}
				bool flag31 = textInfo.textElementInfo.Length - this.m_TotalCharacterCount > 256;
				if (flag31)
				{
				...
				for (int i = 0; i < num6; i++)
				{
					...
					bool flag32 = textInfo.meshInfo[i].vertices == null || textInfo.meshInfo[i].vertices.Length < referenceCount * 4;
					if (flag32)
					{
						bool flag33 = textInfo.meshInfo[i].vertices == null;
						if (flag33)
						{
					...
					{
						bool flag34 = textInfo.meshInfo[i].vertices.Length - referenceCount * 4 > 1024;
						if (flag34)
						{
		...
		// Token: 0x06000132 RID: 306 RVA: 0x00016108 File Offset: 0x00014308
		...
		// Token: 0x06000133 RID: 307 RVA: 0x00016350 File Offset: 0x00014550
		...
		// Token: 0x06000134 RID: 308 RVA: 0x0001644C File Offset: 0x0001464C
		...
		// Token: 0x06000135 RID: 309 RVA: 0x00016460 File Offset: 0x00014660
		...
		// Token: 0x06000136 RID: 310 RVA: 0x00016584 File Offset: 0x00014784
		...
		// Token: 0x06000137 RID: 311 RVA: 0x000165FC File Offset: 0x000147FC
		...
		// Token: 0x06000138 RID: 312 RVA: 0x00016660 File Offset: 0x00014860
		...
		// Token: 0x06000139 RID: 313 RVA: 0x000166E8 File Offset: 0x000148E8
		...
		// Token: 0x0600013A RID: 314 RVA: 0x0001679C File Offset: 0x0001499C
		...
		// Token: 0x0600013B RID: 315 RVA: 0x00016840 File Offset: 0x00014A40
				...
				else
				{
					...
					while (this.m_CharBuffer[num9] != 0)
					{
						...
						if (enableKerning)
						{
							...
							{
								uint glyphIndex2 = textInfo.textElementInfo[this.m_CharacterCount + 1].textElement.glyphIndex;
								uint num15 = (glyphIndex2 << 16) | glyphIndex;
								bool flag23 = this.m_CurrentFontAsset.m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup.TryGetValue(num15, ref glyphPairAdjustmentRecord);
								if (flag23)
								{
									glyphValueRecord = glyphPairAdjustmentRecord.firstAdjustmentRecord.glyphValueRecord;
								}
							...
							{
								uint glyphIndex3 = textInfo.textElementInfo[this.m_CharacterCount - 1].textElement.glyphIndex;
								uint num16 = (glyphIndex << 16) | glyphIndex3;
								bool flag25 = this.m_CurrentFontAsset.m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup.TryGetValue(num16, ref glyphPairAdjustmentRecord);
								if (flag25)
								{
									glyphValueRecord += glyphPairAdjustmentRecord.secondAdjustmentRecord.glyphValueRecord;
								}
						...
						if (flag26)
						{
							num17 = this.m_MonoSpacing / 2f - (this.m_CachedTextElement.glyph.metrics.width / 2f + this.m_CachedTextElement.glyph.metrics.horizontalBearingX) * num2;
							this.m_XAdvance += num17;
						}
						...
						if (flag27)
						{
							num18 = 1f + this.m_CurrentFontAsset.boldStyleSpacing * 0.01f;
						}
						else
						{
							num18 = 1f;
						...
						float num19 = this.m_CurrentFontAsset.faceInfo.ascentLine * ((this.m_TextElementType == TextElementType.Character) ? (num2 / num12) : this.m_InternalTextElementInfo[this.m_CharacterCount].scale) + this.m_BaselineOffset;
						this.m_InternalTextElementInfo[this.m_CharacterCount].ascender = num19 - this.m_LineOffset;
						this.m_MaxLineAscender = ((num19 > this.m_MaxLineAscender) ? num19 : this.m_MaxLineAscender);
						float num20 = this.m_CurrentFontAsset.faceInfo.descentLine * ((this.m_TextElementType == TextElementType.Character) ? (num2 / num12) : this.m_InternalTextElementInfo[this.m_CharacterCount].scale) + this.m_BaselineOffset;
						...
						if (flag28)
						{
							float num21 = (num19 - this.m_BaselineOffset) / this.m_CurrentFontAsset.faceInfo.subscriptSize;
							num19 = this.m_MaxLineAscender;
							this.m_MaxLineAscender = ((num21 > this.m_MaxLineAscender) ? num21 : this.m_MaxLineAscender);
							float num22 = (num20 - this.m_BaselineOffset) / this.m_CurrentFontAsset.faceInfo.subscriptSize;
							this.m_MaxLineDescender = ((num22 < this.m_MaxLineDescender) ? num22 : this.m_MaxLineDescender);
						}
						bool flag29 = this.m_LineNumber == 0;
						if (flag29)
						{
							this.m_MaxAscender = ((this.m_MaxAscender > num19) ? this.m_MaxAscender : num19);
						}
						bool flag30 = num10 == 9 || (!char.IsWhiteSpace((char)num10) && num10 != 8203) || this.m_TextElementType == TextElementType.Sprite;
						if (flag30)
						{
							float num23 = ((this.m_Width != -1f) ? Mathf.Min(x + 0.0001f - this.m_MarginLeft - this.m_MarginRight, this.m_Width) : (x + 0.0001f - this.m_MarginLeft - this.m_MarginRight));
							...
							bool flag32 = num7 > num23 * (flag31 ? 1.05f : 1f);
							if (flag32)
							{
								...
								if (flag33)
								{
									...
									float num25 = this.m_MaxLineAscender - this.m_LineOffset;
									float num26 = this.m_MaxLineDescender - this.m_LineOffset;
									this.m_MaxDescender = ((this.m_MaxDescender < num26) ? this.m_MaxDescender : num26);
									this.m_FirstCharacterOfLine = this.m_CharacterCount;
									...
									{
										num6 = Mathf.Max(num6, num25 - num26);
									}
									...
									if (flag41)
									{
										float num27 = this.m_InternalTextElementInfo[this.m_CharacterCount].ascender - this.m_InternalTextElementInfo[this.m_CharacterCount].baseLine;
										float num28 = 0f - this.m_MaxLineDescender + num27 + (num3 + generationSettings.lineSpacing + this.m_LineSpacingDelta) * num;
						...
						if (flag46)
						{
							float num30 = this.m_CurrentFontAsset.faceInfo.tabWidth * (float)this.m_CurrentFontAsset.tabMultiple * num2;
							float num31 = Mathf.Ceil(this.m_XAdvance / num30) * num30;
							this.m_XAdvance = ((num31 > this.m_XAdvance) ? num31 : (this.m_XAdvance + num30));
						}
						else
						{
							...
							if (flag47)
							{
								this.m_XAdvance += (this.m_MonoSpacing - num17 + (generationSettings.characterSpacing + this.m_CurrentFontAsset.regularStyleSpacing) * num2 + this.m_CSpacing) * (1f - this.m_CharWidthAdjDelta);
							...
							{
								this.m_XAdvance += ((this.m_CachedTextElement.glyph.metrics.horizontalAdvance * num18 + generationSettings.characterSpacing + this.m_CurrentFontAsset.regularStyleSpacing + glyphValueRecord.xAdvance) * num2 + this.m_CSpacing) * (1f - this.m_CharWidthAdjDelta);
						...
						if (flag51)
						{
							...
							this.m_MaxDescender = ((this.m_MaxDescender < num33) ? this.m_MaxDescender : num33);
							this.m_FirstCharacterOfLine = this.m_CharacterCount + 1;
							...
							if (flag54)
							{
								...
								if (flag55)
								{
									float num28 = 0f - this.m_MaxLineDescender + num19 + (num3 + generationSettings.lineSpacing + generationSettings.paragraphSpacing + this.m_LineSpacingDelta) * num;
									this.m_LineOffset += num28;
								}
								else
								{
						...
						if (flag56)
						{
							...
							else
							{
								...
								if (flag58)
								{
									bool flag59 = flag4 || flag5 || (!textSettings.lineBreakingRules.leadingCharactersLookup.Contains((uint)num10) && this.m_CharacterCount < totalCharacterCount - 1 && !textSettings.lineBreakingRules.followingCharactersLookup.Contains((uint)this.m_InternalTextElementInfo[this.m_CharacterCount + 1].character));
									if (flag59)
									{
										this.SaveWordWrappingState(ref wordWrapState2, num9, this.m_CharacterCount, textInfo);
										this.m_IsCharacterWrappingEnabled = false;
					...
					bool flag61 = !this.m_IsCharacterWrappingEnabled && !ignoreTextAutoSizing && num34 > 0.051f && defaultFontSize < generationSettings.fontSizeMax;
					if (flag61)
					{
		...
		{
			// Token: 0x0600013D RID: 317 RVA: 0x0001816C File Offset: 0x0001636C
