...
namespace TMPro
{
	...
	public class TMP_Dropdown : Selectable, IPointerClickHandler, IEventSystemHandler, ISubmitHandler, ICancelHandler
	{
		...
		protected internal class DropdownItem : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, ICancelHandler
		{
			...
			// (get) Token: 0x060005E5 RID: 1509 RVA: 0x00038542 File Offset: 0x00036742
			// (set) Token: 0x060005E6 RID: 1510 RVA: 0x0003854A File Offset: 0x0003674A
			...
			// (get) Token: 0x060005E7 RID: 1511 RVA: 0x00038553 File Offset: 0x00036753
			// (set) Token: 0x060005E8 RID: 1512 RVA: 0x0003855B File Offset: 0x0003675B
			public Image image
			{
				get
				{
			...
			// (get) Token: 0x060005E9 RID: 1513 RVA: 0x00038564 File Offset: 0x00036764
			// (set) Token: 0x060005EA RID: 1514 RVA: 0x0003856C File Offset: 0x0003676C
			...
			// (get) Token: 0x060005EB RID: 1515 RVA: 0x00038575 File Offset: 0x00036775
			// (set) Token: 0x060005EC RID: 1516 RVA: 0x0003857D File Offset: 0x0003677D
			...
			// Token: 0x060005ED RID: 1517 RVA: 0x00038586 File Offset: 0x00036786
			public virtual void OnPointerEnter(PointerEventData eventData)
			{
				EventSystem.current.SetSelectedGameObject(base.gameObject);
			}

			// Token: 0x060005EE RID: 1518 RVA: 0x00038598 File Offset: 0x00036798
			public virtual void OnCancel(BaseEventData eventData)
			{
		...
		public class OptionData
		{
			...
			// (get) Token: 0x060005F0 RID: 1520 RVA: 0x000385C2 File Offset: 0x000367C2
			// (set) Token: 0x060005F1 RID: 1521 RVA: 0x000385CA File Offset: 0x000367CA
			public string text
			{
				get
				{
			...
			// (get) Token: 0x060005F2 RID: 1522 RVA: 0x000385D3 File Offset: 0x000367D3
			// (set) Token: 0x060005F3 RID: 1523 RVA: 0x000385DB File Offset: 0x000367DB
			public Sprite image
			{
				get
				{
			...
			// Token: 0x060005F4 RID: 1524 RVA: 0x000385E4 File Offset: 0x000367E4
			public OptionData()
			{
			}

			// Token: 0x060005F5 RID: 1525 RVA: 0x000385EC File Offset: 0x000367EC
			public OptionData(string text)
			{
				this.text = text;
			}

			// Token: 0x060005F6 RID: 1526 RVA: 0x000385FB File Offset: 0x000367FB
			public OptionData(Sprite image)
			{
				this.image = image;
			}

			// Token: 0x060005F7 RID: 1527 RVA: 0x0003860A File Offset: 0x0003680A
		...
		public class OptionDataList
		{
			...
			// (get) Token: 0x060005F8 RID: 1528 RVA: 0x00038620 File Offset: 0x00036820
			// (set) Token: 0x060005F9 RID: 1529 RVA: 0x00038628 File Offset: 0x00036828
			public List<TMP_Dropdown.OptionData> options
			{
				get
				{
			...
			// Token: 0x060005FA RID: 1530 RVA: 0x00038631 File Offset: 0x00036831
