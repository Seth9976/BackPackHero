...
namespace TwitchLib.Api.Core.Common
{
	...
	{
		// Token: 0x06000078 RID: 120 RVA: 0x000036B1 File Offset: 0x000018B1
		public static string FormatOAuth(string token)
		{
			...
			return token.Split(new char[] { ' ' })[1];
		}

		// Token: 0x06000079 RID: 121 RVA: 0x000036D8 File Offset: 0x000018D8
		...
		// Token: 0x0600007A RID: 122 RVA: 0x000039A5 File Offset: 0x00001BA5
