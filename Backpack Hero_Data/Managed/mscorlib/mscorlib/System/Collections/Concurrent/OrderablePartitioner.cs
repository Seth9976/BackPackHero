...
namespace System.Collections.Concurrent
{
	...
	public abstract class OrderablePartitioner<TSource> : Partitioner<TSource>
	{
		...
		// Token: 0x06005F7B RID: 24443 RVA: 0x00140FA8 File Offset: 0x0013F1A8
		...
		// Token: 0x06005F7D RID: 24445 RVA: 0x00140FC5 File Offset: 0x0013F1C5
		...
		// (get) Token: 0x06005F7E RID: 24446 RVA: 0x00140FD1 File Offset: 0x0013F1D1
		// (set) Token: 0x06005F7F RID: 24447 RVA: 0x00140FD9 File Offset: 0x0013F1D9
		...
		// (get) Token: 0x06005F80 RID: 24448 RVA: 0x00140FE2 File Offset: 0x0013F1E2
		// (set) Token: 0x06005F81 RID: 24449 RVA: 0x00140FEA File Offset: 0x0013F1EA
		...
		// (get) Token: 0x06005F82 RID: 24450 RVA: 0x00140FF3 File Offset: 0x0013F1F3
		// (set) Token: 0x06005F83 RID: 24451 RVA: 0x00140FFB File Offset: 0x0013F1FB
		...
		/// <returns>A list containing <paramref name="partitionCount" /> enumerators.</returns>
		/// <param name="partitionCount">The number of partitions to create.</param>
		// Token: 0x06005F84 RID: 24452 RVA: 0x00141004 File Offset: 0x0013F204
		...
		// Token: 0x06005F85 RID: 24453 RVA: 0x00141050 File Offset: 0x0013F250
		...
		{
			// Token: 0x06005F86 RID: 24454 RVA: 0x0014105D File Offset: 0x0013F25D
			public EnumerableDropIndices(IEnumerable<KeyValuePair<long, TSource>> source)
			{
				this._source = source;
			}

			// Token: 0x06005F87 RID: 24455 RVA: 0x0014106C File Offset: 0x0013F26C
			public IEnumerator<TSource> GetEnumerator()
			{
				return new OrderablePartitioner<TSource>.EnumeratorDropIndices(this._source.GetEnumerator());
			}

			// Token: 0x06005F88 RID: 24456 RVA: 0x0014107E File Offset: 0x0013F27E
			IEnumerator IEnumerable.GetEnumerator()
			{
				return this.GetEnumerator();
			}

			// Token: 0x06005F89 RID: 24457 RVA: 0x00141088 File Offset: 0x0013F288
			public void Dispose()
			{
		...
		{
			// Token: 0x06005F8A RID: 24458 RVA: 0x001410AA File Offset: 0x0013F2AA
			public EnumeratorDropIndices(IEnumerator<KeyValuePair<long, TSource>> source)
			{
				this._source = source;
			}

			// Token: 0x06005F8B RID: 24459 RVA: 0x001410B9 File Offset: 0x0013F2B9
			...
			// (get) Token: 0x06005F8C RID: 24460 RVA: 0x001410C8 File Offset: 0x0013F2C8
			...
			// (get) Token: 0x06005F8D RID: 24461 RVA: 0x001410E8 File Offset: 0x0013F2E8
			...
			// Token: 0x06005F8E RID: 24462 RVA: 0x001410F5 File Offset: 0x0013F2F5
			public void Dispose()
			{
				this._source.Dispose();
			}

			// Token: 0x06005F8F RID: 24463 RVA: 0x00141102 File Offset: 0x0013F302
			public void Reset()
			{
				this._source.Reset();
			}
