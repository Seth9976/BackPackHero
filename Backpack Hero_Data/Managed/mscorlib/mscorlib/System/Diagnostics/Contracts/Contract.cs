...
namespace System.Diagnostics.Contracts
{
	...
	public static class Contract
	{
		...
		// Token: 0x06005A0F RID: 23055 RVA: 0x00133DA9 File Offset: 0x00131FA9
		[Conditional("DEBUG")]
		...
		// Token: 0x06005A10 RID: 23056 RVA: 0x00133DB7 File Offset: 0x00131FB7
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[Conditional("CONTRACTS_FULL")]
		[Conditional("DEBUG")]
		...
		// Token: 0x06005A11 RID: 23057 RVA: 0x00133DC5 File Offset: 0x00131FC5
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[Conditional("CONTRACTS_FULL")]
		[Conditional("DEBUG")]
		...
		// Token: 0x06005A12 RID: 23058 RVA: 0x00133DD3 File Offset: 0x00131FD3
		[Conditional("CONTRACTS_FULL")]
		[Conditional("DEBUG")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		/// <param name="condition">The conditional expression to test.</param>
		// Token: 0x06005A13 RID: 23059 RVA: 0x00133DE1 File Offset: 0x00131FE1
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[Conditional("CONTRACTS_FULL")]
		...
		// Token: 0x06005A14 RID: 23060 RVA: 0x00133DE1 File Offset: 0x00131FE1
		[Conditional("CONTRACTS_FULL")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A15 RID: 23061 RVA: 0x00133DEE File Offset: 0x00131FEE
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		/// <param name="userMessage">The message to display if the condition is false.</param>
		/// <typeparam name="TException">The exception to throw if the condition is false.</typeparam>
		// Token: 0x06005A16 RID: 23062 RVA: 0x00133DEE File Offset: 0x00131FEE
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A17 RID: 23063 RVA: 0x00133DFB File Offset: 0x00131FFB
		[Conditional("CONTRACTS_FULL")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A18 RID: 23064 RVA: 0x00133DFB File Offset: 0x00131FFB
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[Conditional("CONTRACTS_FULL")]
		...
		// Token: 0x06005A19 RID: 23065 RVA: 0x00133E08 File Offset: 0x00132008
		[Conditional("CONTRACTS_FULL")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		/// <typeparam name="TException">The type of exception that invokes the postcondition check.</typeparam>
		// Token: 0x06005A1A RID: 23066 RVA: 0x00133E08 File Offset: 0x00132008
		[Conditional("CONTRACTS_FULL")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A1B RID: 23067 RVA: 0x00133E18 File Offset: 0x00132018
		...
		// Token: 0x06005A1C RID: 23068 RVA: 0x00133E2E File Offset: 0x0013202E
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
		...
		// Token: 0x06005A1D RID: 23069 RVA: 0x00133E40 File Offset: 0x00132040
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
		...
		/// <param name="condition">The conditional expression to test.</param>
		// Token: 0x06005A1E RID: 23070 RVA: 0x00133E56 File Offset: 0x00132056
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[Conditional("CONTRACTS_FULL")]
		...
		/// <param name="condition">The conditional expression to test.</param>
		/// <param name="userMessage">The message to display if the condition is false.</param>
		// Token: 0x06005A1F RID: 23071 RVA: 0x00133E56 File Offset: 0x00132056
		[Conditional("CONTRACTS_FULL")]
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A20 RID: 23072 RVA: 0x00133E64 File Offset: 0x00132064
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A21 RID: 23073 RVA: 0x00133EA8 File Offset: 0x001320A8
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		/// <exception cref="T:System.ArgumentException">
		///   <paramref name="toExclusive " />is less than <paramref name="fromInclusive" />.</exception>
		// Token: 0x06005A22 RID: 23074 RVA: 0x00133F18 File Offset: 0x00132118
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="collection" /> or <paramref name="predicate" /> is null.</exception>
		// Token: 0x06005A23 RID: 23075 RVA: 0x00133F5C File Offset: 0x0013215C
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		...
		// Token: 0x06005A25 RID: 23077 RVA: 0x00133FCC File Offset: 0x001321CC
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		[DebuggerNonUserCode]
		...
		// Token: 0x06005A26 RID: 23078 RVA: 0x00134020 File Offset: 0x00132220
		...
		// (add) Token: 0x06005A27 RID: 23079 RVA: 0x001340DC File Offset: 0x001322DC
		// (remove) Token: 0x06005A28 RID: 23080 RVA: 0x001340E4 File Offset: 0x001322E4
