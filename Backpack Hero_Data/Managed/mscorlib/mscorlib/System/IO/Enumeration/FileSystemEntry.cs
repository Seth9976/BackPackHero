...
namespace System.IO.Enumeration
{
	...
	{
		// Token: 0x06006AFA RID: 27386 RVA: 0x0016E09B File Offset: 0x0016C29B
		...
		// (get) Token: 0x06006AFB RID: 27387 RVA: 0x0016E0BA File Offset: 0x0016C2BA
		// (set) Token: 0x06006AFC RID: 27388 RVA: 0x0016E0C2 File Offset: 0x0016C2C2
		public ReadOnlySpan<char> Directory { readonly get; private set; }

		// Token: 0x1700126D RID: 4717
		// (get) Token: 0x06006AFD RID: 27389 RVA: 0x0016E0CB File Offset: 0x0016C2CB
		// (set) Token: 0x06006AFE RID: 27390 RVA: 0x0016E0D3 File Offset: 0x0016C2D3
		public ReadOnlySpan<char> RootDirectory { readonly get; private set; }

		// Token: 0x1700126E RID: 4718
		// (get) Token: 0x06006AFF RID: 27391 RVA: 0x0016E0DC File Offset: 0x0016C2DC
		// (set) Token: 0x06006B00 RID: 27392 RVA: 0x0016E0E4 File Offset: 0x0016C2E4
		public ReadOnlySpan<char> OriginalRootDirectory { readonly get; private set; }

		// Token: 0x1700126F RID: 4719
		// (get) Token: 0x06006B01 RID: 27393 RVA: 0x0016E0ED File Offset: 0x0016C2ED
		...
		// (get) Token: 0x06006B02 RID: 27394 RVA: 0x0016E0FA File Offset: 0x0016C2FA
		...
		// (get) Token: 0x06006B03 RID: 27395 RVA: 0x0016E107 File Offset: 0x0016C307
		...
		// (get) Token: 0x06006B04 RID: 27396 RVA: 0x0016E114 File Offset: 0x0016C314
		...
		// (get) Token: 0x06006B05 RID: 27397 RVA: 0x0016E126 File Offset: 0x0016C326
		...
		// (get) Token: 0x06006B06 RID: 27398 RVA: 0x0016E138 File Offset: 0x0016C338
		...
		// (get) Token: 0x06006B07 RID: 27399 RVA: 0x0016E14A File Offset: 0x0016C34A
		...
		// (get) Token: 0x06006B08 RID: 27400 RVA: 0x0016E158 File Offset: 0x0016C358
		...
		// Token: 0x06006B09 RID: 27401 RVA: 0x0016E165 File Offset: 0x0016C365
		public FileSystemInfo ToFileSystemInfo()
		{
			return FileSystemInfo.Create(Path.Join(this.Directory, this.FileName), ref this);
		}

		// Token: 0x06006B0A RID: 27402 RVA: 0x0016E17E File Offset: 0x0016C37E
		public string ToFullPath()
		{
			return Path.Join(this.Directory, this.FileName);
		}

		// Token: 0x06006B0B RID: 27403 RVA: 0x0016E194 File Offset: 0x0016C394
