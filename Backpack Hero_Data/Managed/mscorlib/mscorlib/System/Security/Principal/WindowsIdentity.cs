...
namespace System.Security.Principal
{
	...
	public class WindowsIdentity : ClaimsIdentity, IIdentity, IDeserializationCallback, ISerializable, IDisposable
	{
		...
		// Token: 0x06003244 RID: 12868 RVA: 0x000B950D File Offset: 0x000B770D
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003245 RID: 12869 RVA: 0x000B9519 File Offset: 0x000B7719
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003246 RID: 12870 RVA: 0x000B9525 File Offset: 0x000B7725
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003247 RID: 12871 RVA: 0x000B9531 File Offset: 0x000B7731
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		// Token: 0x06003248 RID: 12872 RVA: 0x000B955D File Offset: 0x000B775D
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		/// <exception cref="T:System.OutOfMemoryException">There is insufficient memory available.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-The computer is not attached to a Windows 2003 or later domain.-or-The computer is not running Windows 2003 or later.-or-The user is not a member of the domain the computer is attached to.</exception>
		// Token: 0x06003249 RID: 12873 RVA: 0x000B9568 File Offset: 0x000B7768
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x0600324A RID: 12874 RVA: 0x000B95CB File Offset: 0x000B77CB
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		// Token: 0x0600324B RID: 12875 RVA: 0x000B95DA File Offset: 0x000B77DA
		...
		// Token: 0x0600324C RID: 12876 RVA: 0x000B9602 File Offset: 0x000B7802
		[ComVisible(false)]
		public void Dispose()
		{
		...
		// Token: 0x0600324D RID: 12877 RVA: 0x000B9602 File Offset: 0x000B7802
		[ComVisible(false)]
		...
		// Token: 0x0600324E RID: 12878 RVA: 0x000B9610 File Offset: 0x000B7810
		...
		/// </PermissionSet>
		// Token: 0x0600324F RID: 12879 RVA: 0x000B966A File Offset: 0x000B786A
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003252 RID: 12882 RVA: 0x000B9679 File Offset: 0x000B7879
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003253 RID: 12883 RVA: 0x000B9686 File Offset: 0x000B7886
		[SecurityPermission(SecurityAction.Demand, ControlPrincipal = true)]
		...
		// (get) Token: 0x06003256 RID: 12886 RVA: 0x000B968E File Offset: 0x000B788E
		...
		// (get) Token: 0x06003257 RID: 12887 RVA: 0x000B9696 File Offset: 0x000B7896
		...
		// (get) Token: 0x06003258 RID: 12888 RVA: 0x000B96A1 File Offset: 0x000B78A1
		...
		// (get) Token: 0x06003259 RID: 12889 RVA: 0x000B96A9 File Offset: 0x000B78A9
		...
		// (get) Token: 0x0600325A RID: 12890 RVA: 0x000B96B4 File Offset: 0x000B78B4
		...
		// (get) Token: 0x0600325B RID: 12891 RVA: 0x000B96BF File Offset: 0x000B78BF
		...
		// (get) Token: 0x0600325C RID: 12892 RVA: 0x000B96E0 File Offset: 0x000B78E0
		...
		// Token: 0x06003261 RID: 12897 RVA: 0x000B96E8 File Offset: 0x000B78E8
		...
		// Token: 0x06003262 RID: 12898 RVA: 0x000B97D0 File Offset: 0x000B79D0
		...
		// Token: 0x06003263 RID: 12899 RVA: 0x000B983C File Offset: 0x000B7A3C
		internal ClaimsIdentity CloneAsBase()
		{
			return base.Clone();
		}

		// Token: 0x06003264 RID: 12900 RVA: 0x000B96E0 File Offset: 0x000B78E0
		internal IntPtr GetTokenInternal()
		{
			return this._token;
		}

		// Token: 0x06003265 RID: 12901 RVA: 0x000B9844 File Offset: 0x000B7A44
		...
		// (get) Token: 0x0600326D RID: 12909 RVA: 0x000B98D3 File Offset: 0x000B7AD3
		...
		// (get) Token: 0x0600326E RID: 12910 RVA: 0x000B98D3 File Offset: 0x000B7AD3
