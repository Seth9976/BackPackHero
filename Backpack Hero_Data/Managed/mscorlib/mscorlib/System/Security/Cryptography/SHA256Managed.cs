...
namespace System.Security.Cryptography
{
	...
	public class SHA256Managed : SHA256
	{
		...
		// Token: 0x0600303B RID: 12347 RVA: 0x000AF48C File Offset: 0x000AD68C
		...
		// Token: 0x0600303C RID: 12348 RVA: 0x000AF4E2 File Offset: 0x000AD6E2
		...
		// Token: 0x0600303D RID: 12349 RVA: 0x000AF512 File Offset: 0x000AD712
		...
		// Token: 0x0600303E RID: 12350 RVA: 0x000AF51D File Offset: 0x000AD71D
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x0600303F RID: 12351 RVA: 0x000AF528 File Offset: 0x000AD728
		...
		// Token: 0x06003040 RID: 12352 RVA: 0x000AF5A8 File Offset: 0x000AD7A8
		...
		// Token: 0x06003041 RID: 12353 RVA: 0x000AF6BC File Offset: 0x000AD8BC
		...
		// Token: 0x06003042 RID: 12354 RVA: 0x000AF7A8 File Offset: 0x000AD9A8
		[SecurityCritical]
		...
		// Token: 0x06003043 RID: 12355 RVA: 0x000AFAC5 File Offset: 0x000ADCC5
		private static uint RotateRight(uint x, int n)
		{
			return (x >> n) | (x << 32 - n);
		}

		// Token: 0x06003044 RID: 12356 RVA: 0x000AFAD7 File Offset: 0x000ADCD7
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x06003045 RID: 12357 RVA: 0x000AFAE2 File Offset: 0x000ADCE2
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06003046 RID: 12358 RVA: 0x000AFAEF File Offset: 0x000ADCEF
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ (x >> 3);
		}

		// Token: 0x06003047 RID: 12359 RVA: 0x000AFB05 File Offset: 0x000ADD05
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ (x >> 10);
		}

		// Token: 0x06003048 RID: 12360 RVA: 0x000AFB1D File Offset: 0x000ADD1D
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x06003049 RID: 12361 RVA: 0x000AFB38 File Offset: 0x000ADD38
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x0600304A RID: 12362 RVA: 0x000AFB54 File Offset: 0x000ADD54
		[SecurityCritical]
