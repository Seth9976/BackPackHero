...
namespace System.Security.Cryptography
{
	...
	public class SHA512Managed : SHA512
	{
		...
		// Token: 0x06003063 RID: 12387 RVA: 0x000B0388 File Offset: 0x000AE588
		...
		// Token: 0x06003064 RID: 12388 RVA: 0x000B03E1 File Offset: 0x000AE5E1
		...
		// Token: 0x06003065 RID: 12389 RVA: 0x000B0411 File Offset: 0x000AE611
		...
		// Token: 0x06003066 RID: 12390 RVA: 0x000B041C File Offset: 0x000AE61C
		[SecuritySafeCritical]
		...
		// Token: 0x06003067 RID: 12391 RVA: 0x000B0424 File Offset: 0x000AE624
		...
		// Token: 0x06003068 RID: 12392 RVA: 0x000B04C4 File Offset: 0x000AE6C4
		[SecurityCritical]
		...
		// Token: 0x06003069 RID: 12393 RVA: 0x000B05F0 File Offset: 0x000AE7F0
		[SecurityCritical]
		...
		// Token: 0x0600306A RID: 12394 RVA: 0x000B06E4 File Offset: 0x000AE8E4
		[SecurityCritical]
		...
		// Token: 0x0600306B RID: 12395 RVA: 0x000B0269 File Offset: 0x000AE469
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x0600306C RID: 12396 RVA: 0x000B027B File Offset: 0x000AE47B
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600306D RID: 12397 RVA: 0x000AFAE2 File Offset: 0x000ADCE2
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600306E RID: 12398 RVA: 0x000B0A01 File Offset: 0x000AEC01
		private static ulong Sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 28) ^ SHA512Managed.RotateRight(x, 34) ^ SHA512Managed.RotateRight(x, 39);
		}

		// Token: 0x0600306F RID: 12399 RVA: 0x000B0A1D File Offset: 0x000AEC1D
		private static ulong Sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 14) ^ SHA512Managed.RotateRight(x, 18) ^ SHA512Managed.RotateRight(x, 41);
		}

		// Token: 0x06003070 RID: 12400 RVA: 0x000B0A39 File Offset: 0x000AEC39
		private static ulong sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 1) ^ SHA512Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x06003071 RID: 12401 RVA: 0x000B0A4E File Offset: 0x000AEC4E
		private static ulong sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 19) ^ SHA512Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x06003072 RID: 12402 RVA: 0x000B0A68 File Offset: 0x000AEC68
		[SecurityCritical]
