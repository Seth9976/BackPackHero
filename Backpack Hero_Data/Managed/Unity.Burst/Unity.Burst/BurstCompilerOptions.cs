...
namespace Unity.Burst
{
	...
	{
		// Token: 0x0600003D RID: 61 RVA: 0x0000267C File Offset: 0x0000087C
		internal static string SerialiseStringArraySafe(string[] array)
		{
			StringBuilder stringBuilder = new StringBuilder();
			foreach (string text in array)
			{
				stringBuilder.Append(string.Format("{0}]", text.Length));
				stringBuilder.Append(text);
			}
			return stringBuilder.ToString();
		}

		// Token: 0x0600003E RID: 62 RVA: 0x000026D0 File Offset: 0x000008D0
		internal static string[] DeserialiseStringArraySafe(string input)
		{
			...
			while (i < length)
			{
				...
				int num2 = int.Parse(input.Substring(i, num - i));
				list.Add(input.Substring(num + 1, num2));
				i = num + 1 + num2;
			}
			return list.ToArray();
		}

		// Token: 0x0600003F RID: 63 RVA: 0x0000272B File Offset: 0x0000092B
		internal static string SerialiseCompilationOptionsSafe(string[] roots, string[] folders, string options)
		{
			return BurstCompilerOptions.SerialiseStringArraySafe(new string[]
			{
				BurstCompilerOptions.SerialiseStringArraySafe(roots),
				BurstCompilerOptions.SerialiseStringArraySafe(folders),
				options
			});
		}

		// Token: 0x06000040 RID: 64 RVA: 0x00002750 File Offset: 0x00000950
		...
		{
			string[] array = BurstCompilerOptions.DeserialiseStringArraySafe(from);
			return new ValueTuple<string[], string[], string>(BurstCompilerOptions.DeserialiseStringArraySafe(array[0]), BurstCompilerOptions.DeserialiseStringArraySafe(array[1]), array[2]);
		}
		...
		// Token: 0x06000042 RID: 66 RVA: 0x00002785 File Offset: 0x00000985
		...
		// (get) Token: 0x06000043 RID: 67 RVA: 0x000027A2 File Offset: 0x000009A2
		private bool IsGlobal { get; }

		// Token: 0x1700000B RID: 11
		// (get) Token: 0x06000044 RID: 68 RVA: 0x000027AA File Offset: 0x000009AA
		...
		// (get) Token: 0x06000045 RID: 69 RVA: 0x000027BE File Offset: 0x000009BE
		// (set) Token: 0x06000046 RID: 70 RVA: 0x000027C8 File Offset: 0x000009C8
		public bool EnableBurstCompilation
		{
			...
			set
			{
				...
				if (flag && value)
				{
					this.MaybePreventChangingOption();
				}
		...
		// (get) Token: 0x06000047 RID: 71 RVA: 0x00002821 File Offset: 0x00000A21
		// (set) Token: 0x06000048 RID: 72 RVA: 0x00002829 File Offset: 0x00000A29
		...
		// (get) Token: 0x06000049 RID: 73 RVA: 0x00002846 File Offset: 0x00000A46
		// (set) Token: 0x0600004A RID: 74 RVA: 0x0000284E File Offset: 0x00000A4E
		...
		// (get) Token: 0x0600004B RID: 75 RVA: 0x0000287A File Offset: 0x00000A7A
		// (set) Token: 0x0600004C RID: 76 RVA: 0x00002882 File Offset: 0x00000A82
		...
		// (get) Token: 0x0600004D RID: 77 RVA: 0x000028AE File Offset: 0x00000AAE
		// (set) Token: 0x0600004E RID: 78 RVA: 0x000028B6 File Offset: 0x00000AB6
		...
		// (get) Token: 0x0600004F RID: 79 RVA: 0x000028E2 File Offset: 0x00000AE2
		// (set) Token: 0x06000050 RID: 80 RVA: 0x000028E5 File Offset: 0x00000AE5
		...
		// (get) Token: 0x06000051 RID: 81 RVA: 0x000028E7 File Offset: 0x00000AE7
		// (set) Token: 0x06000052 RID: 82 RVA: 0x000028EA File Offset: 0x00000AEA
		...
		// (get) Token: 0x06000053 RID: 83 RVA: 0x000028EC File Offset: 0x00000AEC
		// (set) Token: 0x06000054 RID: 84 RVA: 0x000028F4 File Offset: 0x00000AF4
		...
		// (get) Token: 0x06000055 RID: 85 RVA: 0x00002911 File Offset: 0x00000B11
		...
		// Token: 0x06000059 RID: 89 RVA: 0x0000298E File Offset: 0x00000B8E
		...
		// Token: 0x0600005A RID: 90 RVA: 0x000029AD File Offset: 0x00000BAD
		...
		// Token: 0x0600005B RID: 91 RVA: 0x000029CC File Offset: 0x00000BCC
		...
		// Token: 0x0600005C RID: 92 RVA: 0x00002A5C File Offset: 0x00000C5C
		...
		// Token: 0x0600005D RID: 93 RVA: 0x00002A88 File Offset: 0x00000C88
		...
		// Token: 0x0600005E RID: 94 RVA: 0x00002B84 File Offset: 0x00000D84
		internal bool TryGetOptions(MemberInfo member, bool isJit, out string flagsOut, bool isForILPostProcessing = false)
		{
			...
			flagsOut = this.GetOptions(isJit, burstCompileAttribute, isForILPostProcessing);
			return true;
		}

		// Token: 0x0600005F RID: 95 RVA: 0x00002BCC File Offset: 0x00000DCC
		internal string GetOptions(bool isJit, BurstCompileAttribute attr = null, bool isForILPostProcessing = false)
		{
			StringBuilder stringBuilder = new StringBuilder();
			if (isJit && ((attr != null && attr.CompileSynchronously) || this.RequiresSynchronousCompilation))
			{
			...
			if (isJit && this.EnableBurstTimings)
			{
		...
		// Token: 0x06000060 RID: 96 RVA: 0x00002E20 File Offset: 0x00001020
		...
		// Token: 0x06000061 RID: 97 RVA: 0x00002E3B File Offset: 0x0000103B
		...
		// Token: 0x06000063 RID: 99 RVA: 0x00002E7E File Offset: 0x0000107E
		private void MaybeTriggerRecompilation()
		{
		}

		// Token: 0x06000064 RID: 100 RVA: 0x00002E80 File Offset: 0x00001080
		private void MaybePreventChangingOption()
		{
		}

		// Token: 0x06000065 RID: 101 RVA: 0x00002E84 File Offset: 0x00001084
		...
		// Token: 0x06000066 RID: 102 RVA: 0x00002EE6 File Offset: 0x000010E6
