...
namespace UnityEngine.Experimental.Rendering
{
	...
	{
		// Token: 0x06000050 RID: 80 RVA: 0x000040EF File Offset: 0x000022EF
		...
		// (get) Token: 0x06000051 RID: 81 RVA: 0x000040FC File Offset: 0x000022FC
		...
		// (get) Token: 0x06000052 RID: 82 RVA: 0x00004104 File Offset: 0x00002304
		...
		// (get) Token: 0x06000053 RID: 83 RVA: 0x0000410C File Offset: 0x0000230C
		...
		// (get) Token: 0x06000054 RID: 84 RVA: 0x00004114 File Offset: 0x00002314
		...
		// (get) Token: 0x06000055 RID: 85 RVA: 0x0000411C File Offset: 0x0000231C
		...
		// Token: 0x06000056 RID: 86 RVA: 0x00004123 File Offset: 0x00002323
		public void SetNumberOfCellsLoadedPerFrame(int numberOfCells)
		{
			this.m_NumberOfCellsLoadedPerFrame = Mathf.Max(1, numberOfCells);
		}

		// Token: 0x06000057 RID: 87 RVA: 0x00004134 File Offset: 0x00002334
		...
		// Token: 0x06000058 RID: 88 RVA: 0x000041B6 File Offset: 0x000023B6
		public void SetEnableStateFromSRP(bool srpEnablesPV)
		{
			this.m_EnabledBySRP = srpEnablesPV;
		}

		// Token: 0x06000059 RID: 89 RVA: 0x000041BF File Offset: 0x000023BF
		...
		// Token: 0x0600005A RID: 90 RVA: 0x000041EF File Offset: 0x000023EF
		public void Cleanup()
		{
			if (!this.m_ProbeReferenceVolumeInit)
			{
		...
		// Token: 0x0600005B RID: 91 RVA: 0x00004220 File Offset: 0x00002420
		...
		// Token: 0x0600005C RID: 92 RVA: 0x00004250 File Offset: 0x00002450
		private void RemoveCell(ProbeReferenceVolume.Cell cell)
		{
			if (cell.loaded)
			{
				...
				if (flag)
				{
					...
					ProbeReferenceVolume.RegId regId = default(ProbeReferenceVolume.RegId);
					if (this.m_CellToBricks.TryGetValue(cell, out regId))
					{
						this.ReleaseBricks(regId);
		...
		// Token: 0x0600005D RID: 93 RVA: 0x00004368 File Offset: 0x00002568
		...
		// Token: 0x0600005E RID: 94 RVA: 0x000043F4 File Offset: 0x000025F4
		...
		// Token: 0x06000060 RID: 96 RVA: 0x00004658 File Offset: 0x00002858
		...
		// Token: 0x06000061 RID: 97 RVA: 0x0000469C File Offset: 0x0000289C
		...
		// Token: 0x06000063 RID: 99 RVA: 0x00004791 File Offset: 0x00002991
		...
		// Token: 0x06000064 RID: 100 RVA: 0x000047AC File Offset: 0x000029AC
		...
		// Token: 0x06000065 RID: 101 RVA: 0x00004874 File Offset: 0x00002A74
		private void PerformPendingLoading()
		{
			...
			if (this.m_HasChangedIndex)
			{
				...
				foreach (ProbeVolumeAsset probeVolumeAsset in this.m_ActiveAssets.Values)
				{
					this.LoadAsset(probeVolumeAsset);
				}
			}
			foreach (ProbeVolumeAsset probeVolumeAsset2 in this.m_PendingAssetsToBeLoaded.Values)
			{
				this.LoadAsset(probeVolumeAsset2);
				if (!this.m_ActiveAssets.ContainsKey(probeVolumeAsset2.GetSerializedFullPath()))
				{
					this.m_ActiveAssets.Add(probeVolumeAsset2.GetSerializedFullPath(), probeVolumeAsset2);
				}
			}
		...
		// Token: 0x06000066 RID: 102 RVA: 0x00004990 File Offset: 0x00002B90
		private void PerformPendingDeletion()
		{
			...
			foreach (ProbeVolumeAsset probeVolumeAsset in this.m_PendingAssetsToBeUnloaded.Values)
			{
				this.RemovePendingAsset(probeVolumeAsset);
			}
			this.m_PendingAssetsToBeUnloaded.Clear();
		}

		// Token: 0x06000067 RID: 103 RVA: 0x00004A08 File Offset: 0x00002C08
		...
		// Token: 0x06000068 RID: 104 RVA: 0x00004C00 File Offset: 0x00002E00
		private bool GetCellIndexUpdate(ProbeReferenceVolume.Cell cell, out ProbeBrickIndex.CellIndexUpdateInfo cellUpdateInfo)
		{
			...
			int numberOfBricksAtSubdiv = this.GetNumberOfBricksAtSubdiv(cell, out vector3Int, out vector3Int2);
			...
			cellUpdateInfo.maxValidBrickIndexForCellAtMaxResPlusOne = vector3Int2 + vector3Int;
			return this.m_Index.AssignIndexChunksToCell(cell, numberOfBricksAtSubdiv, ref cellUpdateInfo);
		}

		// Token: 0x06000069 RID: 105 RVA: 0x00004C6C File Offset: 0x00002E6C
		private void LoadPendingCells(bool loadAll = false)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				bool flag = false;
				int num2 = 0;
				ProbeBrickPool.DataLocation dataLocation = ProbeBrickPool.CreateDataLocation(cell.sh.Length, flag, this.m_SHBands, out num2);
				ProbeBrickPool.FillDataLocation(ref dataLocation, cell.sh, this.m_SHBands);
				...
				List<ProbeBrickPool.BrickChunkAlloc> list2 = new List<ProbeBrickPool.BrickChunkAlloc>();
				ProbeReferenceVolume.RegId regId = this.AddBricks(list, dataLocation, cellIndexUpdateInfo, out list2);
		...
		// Token: 0x0600006A RID: 106 RVA: 0x00004DC4 File Offset: 0x00002FC4
		...
		// Token: 0x0600006B RID: 107 RVA: 0x00004DE0 File Offset: 0x00002FE0
		...
		// Token: 0x0600006C RID: 108 RVA: 0x00004EA0 File Offset: 0x000030A0
		...
		// Token: 0x0600006D RID: 109 RVA: 0x00004F04 File Offset: 0x00003104
		...
		public ProbeReferenceVolume.RuntimeResources GetRuntimeResources()
		{
			...
			ProbeReferenceVolume.RuntimeResources runtimeResources = default(ProbeReferenceVolume.RuntimeResources);
			this.m_Index.GetRuntimeResources(ref runtimeResources);
			this.m_CellIndices.GetRuntimeResources(ref runtimeResources);
			this.m_Pool.GetRuntimeResources(ref runtimeResources);
			return runtimeResources;
		}

		// Token: 0x0600006F RID: 111 RVA: 0x00005088 File Offset: 0x00003288
		...
		// Token: 0x06000073 RID: 115 RVA: 0x00005127 File Offset: 0x00003327
		internal float MinBrickSize()
		{
			return this.m_Transform.scale;
		}

		// Token: 0x06000074 RID: 116 RVA: 0x00005134 File Offset: 0x00003334
		internal float MaxBrickSize()
		{
			return this.BrickSize(this.m_MaxSubdivision - 1);
		}

		// Token: 0x06000075 RID: 117 RVA: 0x00005144 File Offset: 0x00003344
		internal Matrix4x4 GetRefSpaceToWS()
		{
			return this.m_Transform.refSpaceToWS;
		}

		// Token: 0x06000076 RID: 118 RVA: 0x00005151 File Offset: 0x00003351
		internal ProbeReferenceVolume.RefVolTransform GetTransform()
		{
			return this.m_Transform;
		}

		// Token: 0x06000077 RID: 119 RVA: 0x00005159 File Offset: 0x00003359
		internal int GetMaxSubdivision()
		{
			return this.m_MaxSubdivision;
		}

		// Token: 0x06000078 RID: 120 RVA: 0x00005161 File Offset: 0x00003361
		internal int GetMaxSubdivision(float multiplier)
		{
			return Mathf.CeilToInt((float)this.m_MaxSubdivision * multiplier);
		}

		// Token: 0x06000079 RID: 121 RVA: 0x00005171 File Offset: 0x00003371
		...
		// Token: 0x0600007B RID: 123 RVA: 0x00005189 File Offset: 0x00003389
		public bool DataHasBeenLoaded()
		{
			return this.m_BricksLoaded;
		}

		// Token: 0x0600007C RID: 124 RVA: 0x00005194 File Offset: 0x00003394
		internal void Clear()
		{
			if (this.m_ProbeReferenceVolumeInit)
			{
		...
		// Token: 0x0600007D RID: 125 RVA: 0x000051F4 File Offset: 0x000033F4
		...
		// Token: 0x0600007E RID: 126 RVA: 0x00005360 File Offset: 0x00003560
		private void ReleaseBricks(ProbeReferenceVolume.RegId id)
		{
			List<ProbeBrickPool.BrickChunkAlloc> list;
			if (!this.m_Registry.TryGetValue(id, out list))
			{
			...
			this.m_Pool.Deallocate(list);
			this.m_Registry.Remove(id);
			this.m_BricksToCellUpdateInfo.Remove(id);
		}

		// Token: 0x0600007F RID: 127 RVA: 0x000053DC File Offset: 0x000035DC
		public void UpdateConstantBuffer(CommandBuffer cmd, ProbeVolumeShadingParameters parameters)
		{
			...
			ConstantBuffer.PushGlobal<ShaderVariablesProbeVolumes>(cmd, in shaderVariablesProbeVolumes, this.m_CBShaderID);
		}

		// Token: 0x06000080 RID: 128 RVA: 0x000054C3 File Offset: 0x000036C3
		...
		// (get) Token: 0x06000082 RID: 130 RVA: 0x0000550A File Offset: 0x0000370A
		public Color[] subdivisionDebugColors { get; } = new Color[7];

		// Token: 0x06000083 RID: 131 RVA: 0x00005512 File Offset: 0x00003712
		...
		// Token: 0x06000084 RID: 132 RVA: 0x0000553C File Offset: 0x0000373C
		...
		// Token: 0x06000085 RID: 133 RVA: 0x0000564E File Offset: 0x0000384E
		...
		// Token: 0x06000086 RID: 134 RVA: 0x00005662 File Offset: 0x00003862
		...
		// Token: 0x06000087 RID: 135 RVA: 0x00005671 File Offset: 0x00003871
		private void DebugCellIndexChanged<T>(DebugUI.Field<T> field, T value)
		{
			this.ClearDebugData();
		}

		// Token: 0x06000088 RID: 136 RVA: 0x0000567C File Offset: 0x0000387C
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00005AB5 File Offset: 0x00003CB5
		...
		// Token: 0x0600008A RID: 138 RVA: 0x00005AF0 File Offset: 0x00003CF0
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00005B7C File Offset: 0x00003D7C
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00005D40 File Offset: 0x00003F40
		...
		// Token: 0x0600008D RID: 141 RVA: 0x00005D58 File Offset: 0x00003F58
				...
				if (cell.sh != null && cell.sh.Length != 0)
				{
					...
					if (this.m_ChunkInfo.TryGetValue(cell.index, out cellChunkInfo))
					{
						...
						for (int i = 0; i < cell.probePositions.Length; i++)
						{
							...
							ProbeBrickPool.BrickChunkAlloc brickChunkAlloc = cellChunkInfo.chunks[num3];
							int num4 = i % this.m_Pool.GetChunkSizeInProbeCount();
							int num5 = num4 / 64;
							int num6 = num4 % 64;
							Vector2Int vector2Int = new Vector2Int(brickChunkAlloc.x + num5 * 4, brickChunkAlloc.y);
							int num7 = num6 % 16;
							Vector3Int vector3Int = new Vector3Int(vector2Int.x + num7 % 4, vector2Int.y + num7 / 4, num6 / 16);
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00006024 File Offset: 0x00004224
		...
		{
			// Token: 0x060007EA RID: 2026 RVA: 0x000225BC File Offset: 0x000207BC
		...
		{
			// Token: 0x060007EC RID: 2028 RVA: 0x000225FC File Offset: 0x000207FC
			...
			// Token: 0x060007ED RID: 2029 RVA: 0x000226A2 File Offset: 0x000208A2
			...
			// Token: 0x060007EE RID: 2030 RVA: 0x000226D4 File Offset: 0x000208D4
			...
			// Token: 0x060007EF RID: 2031 RVA: 0x0002272C File Offset: 0x0002092C
				...
				for (int i = 0; i < 2; i++)
				{
					for (int j = 0; j < 2; j++)
					{
						for (int k = 0; k < 2; k++)
						{
							...
							Vector3 vector4 = this.corner + this.X * vector3.x + this.Y * vector3.y + this.Z * vector3.z;
			...
			// Token: 0x060007F0 RID: 2032 RVA: 0x00022824 File Offset: 0x00020A24
			...
			// Token: 0x060007F1 RID: 2033 RVA: 0x000228A8 File Offset: 0x00020AA8
			...
			// Token: 0x060007F2 RID: 2034 RVA: 0x00022904 File Offset: 0x00020B04
			...
			// Token: 0x060007F3 RID: 2035 RVA: 0x00022968 File Offset: 0x00020B68
		...
		{
			// Token: 0x060007F4 RID: 2036 RVA: 0x000229DF File Offset: 0x00020BDF
			public bool IsValid()
			{
				return this.id != 0;
			}

			// Token: 0x060007F5 RID: 2037 RVA: 0x000229EA File Offset: 0x00020BEA
			public void Invalidate()
			{
				this.id = 0;
			}

			// Token: 0x060007F6 RID: 2038 RVA: 0x000229F3 File Offset: 0x00020BF3
			public static bool operator ==(ProbeReferenceVolume.RegId lhs, ProbeReferenceVolume.RegId rhs)
			{
				return lhs.id == rhs.id;
			}

			// Token: 0x060007F7 RID: 2039 RVA: 0x00022A03 File Offset: 0x00020C03
			public static bool operator !=(ProbeReferenceVolume.RegId lhs, ProbeReferenceVolume.RegId rhs)
			{
				return lhs.id != rhs.id;
			}

			// Token: 0x060007F8 RID: 2040 RVA: 0x00022A16 File Offset: 0x00020C16
			public override bool Equals(object obj)
			{
				return obj != null && base.GetType().Equals(obj.GetType()) && (ProbeReferenceVolume.RegId)obj == this;
			}

			// Token: 0x060007F9 RID: 2041 RVA: 0x00022A4B File Offset: 0x00020C4B
