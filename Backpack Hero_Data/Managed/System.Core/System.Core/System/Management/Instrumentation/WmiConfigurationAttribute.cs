...
namespace System.Management.Instrumentation
{
	...
	public sealed class WmiConfigurationAttribute : Attribute
	{
		...
		// (set) Token: 0x06001B24 RID: 6948 RVA: 0x0000235B File Offset: 0x0000055B
		...
		// (set) Token: 0x06001B26 RID: 6950 RVA: 0x0000235B File Offset: 0x0000055B
		...
		// (set) Token: 0x06001B28 RID: 6952 RVA: 0x0000235B File Offset: 0x0000055B
		...
		// (set) Token: 0x06001B2A RID: 6954 RVA: 0x0000235B File Offset: 0x0000055B
		...
		// (set) Token: 0x06001B2D RID: 6957 RVA: 0x0000235B File Offset: 0x0000055B
