...
namespace UnityEngine.InputSystem.XR
{
	...
	public class PoseControl : InputControl<PoseState>
	{
		...
		// (get) Token: 0x06000971 RID: 2417 RVA: 0x00034A0E File Offset: 0x00032C0E
		// (set) Token: 0x06000972 RID: 2418 RVA: 0x00034A16 File Offset: 0x00032C16
		public ButtonControl isTracked { get; private set; }

		// Token: 0x17000261 RID: 609
		// (get) Token: 0x06000973 RID: 2419 RVA: 0x00034A1F File Offset: 0x00032C1F
		// (set) Token: 0x06000974 RID: 2420 RVA: 0x00034A27 File Offset: 0x00032C27
		public IntegerControl trackingState { get; private set; }

		// Token: 0x17000262 RID: 610
		// (get) Token: 0x06000975 RID: 2421 RVA: 0x00034A30 File Offset: 0x00032C30
		// (set) Token: 0x06000976 RID: 2422 RVA: 0x00034A38 File Offset: 0x00032C38
		public Vector3Control position { get; private set; }

		// Token: 0x17000263 RID: 611
		// (get) Token: 0x06000977 RID: 2423 RVA: 0x00034A41 File Offset: 0x00032C41
		// (set) Token: 0x06000978 RID: 2424 RVA: 0x00034A49 File Offset: 0x00032C49
		public QuaternionControl rotation { get; private set; }

		// Token: 0x17000264 RID: 612
		// (get) Token: 0x06000979 RID: 2425 RVA: 0x00034A52 File Offset: 0x00032C52
		// (set) Token: 0x0600097A RID: 2426 RVA: 0x00034A5A File Offset: 0x00032C5A
		public Vector3Control velocity { get; private set; }

		// Token: 0x17000265 RID: 613
		// (get) Token: 0x0600097B RID: 2427 RVA: 0x00034A63 File Offset: 0x00032C63
		// (set) Token: 0x0600097C RID: 2428 RVA: 0x00034A6B File Offset: 0x00032C6B
		public Vector3Control angularVelocity { get; private set; }

		// Token: 0x0600097D RID: 2429 RVA: 0x00034A74 File Offset: 0x00032C74
		public PoseControl()
		{
			this.m_StateBlock.format = PoseState.s_Format;
		}

		// Token: 0x0600097E RID: 2430 RVA: 0x00034A8C File Offset: 0x00032C8C
		...
		// Token: 0x0600097F RID: 2431 RVA: 0x00034B08 File Offset: 0x00032D08
		...
		// Token: 0x06000980 RID: 2432 RVA: 0x00034BBC File Offset: 0x00032DBC
		...
		// Token: 0x06000981 RID: 2433 RVA: 0x00034C5C File Offset: 0x00032E5C
