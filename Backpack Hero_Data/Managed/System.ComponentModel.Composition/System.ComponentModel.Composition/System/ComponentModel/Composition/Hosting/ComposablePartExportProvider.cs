...
namespace System.ComponentModel.Composition.Hosting
{
	...
	public class ComposablePartExportProvider : ExportProvider, IDisposable
	{
		...
		private void Recompose(CompositionBatch batch, AtomicComposition atomicComposition)
		{
			...
			{
				enumerable = batch.PartsToAdd.SelectMany((ComposablePart part) => part.ExportDefinitions).ToArray<ExportDefinition>();
			}
			...
			{
				enumerable2 = batch.PartsToRemove.SelectMany((ComposablePart part) => part.ExportDefinitions).ToArray<ExportDefinition>();
			}
