...
namespace UnityEngine
{
	...
	{
		// Token: 0x06000414 RID: 1044 RVA: 0x0000F570 File Offset: 0x0000D770
		...
		// Token: 0x06000415 RID: 1045 RVA: 0x0000F5CC File Offset: 0x0000D7CC
		public float Handle()
		{
		...
		// Token: 0x06000416 RID: 1046 RVA: 0x0000F650 File Offset: 0x0000D850
		...
		// Token: 0x06000417 RID: 1047 RVA: 0x0000F7E4 File Offset: 0x0000D9E4
		...
		// Token: 0x06000418 RID: 1048 RVA: 0x0000F870 File Offset: 0x0000DA70
		...
		// Token: 0x06000419 RID: 1049 RVA: 0x0000F8B0 File Offset: 0x0000DAB0
		...
		// Token: 0x0600041A RID: 1050 RVA: 0x0000FA78 File Offset: 0x0000DC78
		private EventType CurrentEventType()
		{
			return this.CurrentEvent().GetTypeForControl(this.id);
		}

		// Token: 0x0600041B RID: 1051 RVA: 0x0000FA9C File Offset: 0x0000DC9C
		...
		// Token: 0x0600041C RID: 1052 RVA: 0x0000FB08 File Offset: 0x0000DD08
		private bool IsEmptySlider()
		{
			return this.start == this.end;
		}

		// Token: 0x0600041D RID: 1053 RVA: 0x0000FB28 File Offset: 0x0000DD28
		private bool SupportsPageMovements()
		{
			return this.size != 0f && GUI.usePageScrollbars;
		}

		// Token: 0x0600041E RID: 1054 RVA: 0x0000FB50 File Offset: 0x0000DD50
		...
		// Token: 0x0600041F RID: 1055 RVA: 0x0000FBBC File Offset: 0x0000DDBC
		...
		// Token: 0x06000420 RID: 1056 RVA: 0x0000FC18 File Offset: 0x0000DE18
		private Event CurrentEvent()
		{
			return Event.current;
		}

		// Token: 0x06000421 RID: 1057 RVA: 0x0000FC30 File Offset: 0x0000DE30
		...
		// Token: 0x06000422 RID: 1058 RVA: 0x0000FCBC File Offset: 0x0000DEBC
		private float Clamp(float value)
		{
			return Mathf.Clamp(value, this.MinValue(), this.MaxValue());
		}

		// Token: 0x06000423 RID: 1059 RVA: 0x0000FCE0 File Offset: 0x0000DEE0
		private Rect ThumbSelectionRect()
		{
			return this.ThumbRect();
		}

		// Token: 0x06000424 RID: 1060 RVA: 0x0000FCFC File Offset: 0x0000DEFC
		...
		// Token: 0x06000425 RID: 1061 RVA: 0x0000FD2C File Offset: 0x0000DF2C
		private SliderState SliderState()
		{
			return (SliderState)GUIUtility.GetStateObject(typeof(SliderState), this.id);
		}

		// Token: 0x06000426 RID: 1062 RVA: 0x0000FD58 File Offset: 0x0000DF58
		...
		// Token: 0x06000427 RID: 1063 RVA: 0x0000FDAC File Offset: 0x0000DFAC
		private Rect ThumbRect()
		{
			return this.horiz ? this.HorizontalThumbRect() : this.VerticalThumbRect();
		}

		// Token: 0x06000428 RID: 1064 RVA: 0x0000FDD4 File Offset: 0x0000DFD4
		...
		// Token: 0x06000429 RID: 1065 RVA: 0x0000FEC4 File Offset: 0x0000E0C4
		...
		// Token: 0x0600042A RID: 1066 RVA: 0x0000FFB0 File Offset: 0x0000E1B0
		private float ClampedCurrentValue()
		{
			return this.Clamp(this.currentValue);
		}

		// Token: 0x0600042B RID: 1067 RVA: 0x0000FFD0 File Offset: 0x0000E1D0
		...
		// Token: 0x0600042C RID: 1068 RVA: 0x00010030 File Offset: 0x0000E230
		...
		// Token: 0x0600042D RID: 1069 RVA: 0x000100C4 File Offset: 0x0000E2C4
		...
		// Token: 0x0600042E RID: 1070 RVA: 0x00010144 File Offset: 0x0000E344
		private float MaxValue()
		{
			return Mathf.Max(this.start, this.end) - this.size;
		}

		// Token: 0x0600042F RID: 1071 RVA: 0x00010170 File Offset: 0x0000E370
