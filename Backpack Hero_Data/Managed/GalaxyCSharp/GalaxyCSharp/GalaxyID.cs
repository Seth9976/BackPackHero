...
namespace Galaxy.Api
{
	...
	public class GalaxyID : IDisposable
	{
		...
		{
			GalaxyID galaxyID = new GalaxyID(GalaxyInstancePINVOKE.GalaxyID_FromRealID((int)type, value), true);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			GalaxyID galaxyID = new GalaxyID(GalaxyInstancePINVOKE.GalaxyID_operator_assign(this.swigCPtr, GalaxyID.getCPtr(other)), false);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			bool flag = GalaxyInstancePINVOKE.GalaxyID_operator_less(this.swigCPtr, GalaxyID.getCPtr(other));
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			bool flag = GalaxyInstancePINVOKE.GalaxyID_operator_equals(this.swigCPtr, GalaxyID.getCPtr(other));
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			bool flag = GalaxyInstancePINVOKE.GalaxyID_operator_not_equals(this.swigCPtr, GalaxyID.getCPtr(other));
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		public bool IsValid()
		{
			bool flag = GalaxyInstancePINVOKE.GalaxyID_IsValid(this.swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			ulong num = GalaxyInstancePINVOKE.GalaxyID_ToUint64(this.swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			ulong num = GalaxyInstancePINVOKE.GalaxyID_GetRealID(this.swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			GalaxyID.IDType idtype = (GalaxyID.IDType)GalaxyInstancePINVOKE.GalaxyID_GetIDType(this.swigCPtr);
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
			}
