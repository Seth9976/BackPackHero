...
namespace UnityEngine.UIElements
{
	...
	public class PanelRaycaster : BaseRaycaster, IRuntimePanelComponent
	{
		...
		// (get) Token: 0x06000519 RID: 1305 RVA: 0x00017A1D File Offset: 0x00015C1D
		// (set) Token: 0x0600051A RID: 1306 RVA: 0x00017A28 File Offset: 0x00015C28
		public IPanel panel
		{
			get
			{
		...
		// Token: 0x0600051B RID: 1307 RVA: 0x00017A58 File Offset: 0x00015C58
		...
		// Token: 0x0600051C RID: 1308 RVA: 0x00017A79 File Offset: 0x00015C79
		...
		// Token: 0x0600051D RID: 1309 RVA: 0x00017A9A File Offset: 0x00015C9A
		...
		// (get) Token: 0x0600051E RID: 1310 RVA: 0x00017AA3 File Offset: 0x00015CA3
		...
		// (get) Token: 0x0600051F RID: 1311 RVA: 0x00017AB6 File Offset: 0x00015CB6
		...
		// (get) Token: 0x06000520 RID: 1312 RVA: 0x00017ACF File Offset: 0x00015CCF
		...
		// Token: 0x06000521 RID: 1313 RVA: 0x00017AEC File Offset: 0x00015CEC
		public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
		{
			...
			IPanel panel = ((PointerDeviceState.GetPressedButtons(num2) != 0) ? PointerDeviceState.GetPlayerPanelWithSoftPointerCapture(num2) : null);
			...
			if (capturingElement == null && panel == null)
			{
				Vector2 vector3;
				Vector2 vector4;
				if (!this.m_Panel.ScreenToPanel(vector2, delta, out vector3, out vector4, false))
				{
					return;
				}
				if (this.m_Panel.Pick(vector3) == null)
				{
					return;
				}
			}
		...
		// (get) Token: 0x06000522 RID: 1314 RVA: 0x00017C8A File Offset: 0x00015E8A
		...
		// Token: 0x06000523 RID: 1315 RVA: 0x00017C90 File Offset: 0x00015E90
