...
namespace Mono.Net.Security
{
	...
	internal sealed class MonoSslClientAuthenticationOptions : MonoSslAuthenticationOptions, IMonoSslClientAuthenticationOptions, IMonoAuthenticationOptions
	{
		...
		// (get) Token: 0x060002F9 RID: 761 RVA: 0x00009158 File Offset: 0x00007358
		public SslClientAuthenticationOptions Options { get; }

		// Token: 0x1700009A RID: 154
		// (get) Token: 0x060002FA RID: 762 RVA: 0x00003062 File Offset: 0x00001262
		...
		// Token: 0x060002FB RID: 763 RVA: 0x00009160 File Offset: 0x00007360
		public MonoSslClientAuthenticationOptions(SslClientAuthenticationOptions options)
		{
			this.Options = options;
		}

		// Token: 0x060002FC RID: 764 RVA: 0x0000916F File Offset: 0x0000736F
		...
		// (get) Token: 0x060002FD RID: 765 RVA: 0x00009182 File Offset: 0x00007382
		// (set) Token: 0x060002FE RID: 766 RVA: 0x0000918F File Offset: 0x0000738F
		...
		// (get) Token: 0x060002FF RID: 767 RVA: 0x0000919D File Offset: 0x0000739D
		// (set) Token: 0x06000300 RID: 768 RVA: 0x000091AA File Offset: 0x000073AA
		...
		// (get) Token: 0x06000301 RID: 769 RVA: 0x000091B8 File Offset: 0x000073B8
		// (set) Token: 0x06000302 RID: 770 RVA: 0x000091C5 File Offset: 0x000073C5
		...
		// (get) Token: 0x06000303 RID: 771 RVA: 0x000091D3 File Offset: 0x000073D3
		// (set) Token: 0x06000304 RID: 772 RVA: 0x000091E0 File Offset: 0x000073E0
		...
		// (get) Token: 0x06000305 RID: 773 RVA: 0x000091EE File Offset: 0x000073EE
		// (set) Token: 0x06000306 RID: 774 RVA: 0x000091FB File Offset: 0x000073FB
		...
		// (get) Token: 0x06000307 RID: 775 RVA: 0x00009209 File Offset: 0x00007409
		// (set) Token: 0x06000308 RID: 776 RVA: 0x00009216 File Offset: 0x00007416
		...
		// (get) Token: 0x06000309 RID: 777 RVA: 0x00009224 File Offset: 0x00007424
		// (set) Token: 0x0600030A RID: 778 RVA: 0x00009231 File Offset: 0x00007431
		...
		// (get) Token: 0x0600030B RID: 779 RVA: 0x000044FA File Offset: 0x000026FA
		// (set) Token: 0x0600030C RID: 780 RVA: 0x000044FA File Offset: 0x000026FA
		...
		// (get) Token: 0x0600030D RID: 781 RVA: 0x0000923F File Offset: 0x0000743F
		// (set) Token: 0x0600030E RID: 782 RVA: 0x0000924C File Offset: 0x0000744C
		...
		// (get) Token: 0x0600030F RID: 783 RVA: 0x000044FA File Offset: 0x000026FA
		// (set) Token: 0x06000310 RID: 784 RVA: 0x000044FA File Offset: 0x000026FA
