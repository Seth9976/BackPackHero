...
namespace System
{
	...
	{
		// Token: 0x060009C0 RID: 2496 RVA: 0x0000219B File Offset: 0x0000039B
		private UncNameHelper()
		{
		}

		// Token: 0x060009C1 RID: 2497 RVA: 0x0002B31A File Offset: 0x0002951A
		internal static string ParseCanonicalName(string str, int start, int end, ref bool loopback)
		{
			return DomainNameHelper.ParseCanonicalName(str, start, end, ref loopback);
		}

		// Token: 0x060009C2 RID: 2498 RVA: 0x0002B328 File Offset: 0x00029528
