...
namespace System
{
	...
	{
		// Token: 0x060008DD RID: 2269 RVA: 0x00020B48 File Offset: 0x0001ED48
		internal static bool CheckIriUnicodeRange(char unicode, bool isQuery)
		{
			return (unicode >= '\u00a0' && unicode <= '\ud7ff') || (unicode >= '豈' && unicode <= '﷏') || (unicode >= 'ﷰ' && unicode <= '\uffef') || (isQuery && unicode >= '\ue000' && unicode <= '\uf8ff');
		}

		// Token: 0x060008DE RID: 2270 RVA: 0x00020BA0 File Offset: 0x0001EDA0
		...
		// Token: 0x060008DF RID: 2271 RVA: 0x00020DBC File Offset: 0x0001EFBC
		...
		// Token: 0x060008E0 RID: 2272 RVA: 0x00020E9C File Offset: 0x0001F09C
			...
			while (i < end)
			{
				...
				if (flag2)
				{
					if (num < 12)
					{
						...
						Buffer.Memcpy((byte*)ptr2, (byte*)ptr, num2 * 2, true);
						array5 = null;
