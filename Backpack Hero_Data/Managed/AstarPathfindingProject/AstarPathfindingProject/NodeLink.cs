...
namespace Pathfinding
{
	...
	public class NodeLink : GraphModifier
	{
		...
		// (get) Token: 0x06000300 RID: 768 RVA: 0x00010994 File Offset: 0x0000EB94
		...
		// (get) Token: 0x06000301 RID: 769 RVA: 0x0001099C File Offset: 0x0000EB9C
		...
		// Token: 0x06000302 RID: 770 RVA: 0x000109A4 File Offset: 0x0000EBA4
		...
		// Token: 0x06000303 RID: 771 RVA: 0x000109D4 File Offset: 0x0000EBD4
		public void InternalOnPostScan()
		{
			this.Apply();
		}

		// Token: 0x06000304 RID: 772 RVA: 0x000109DC File Offset: 0x0000EBDC
		...
		// Token: 0x06000305 RID: 773 RVA: 0x00010A08 File Offset: 0x0000EC08
		public virtual void Apply()
		{
			...
			else
			{
				...
				node.AddConnection(node2, num);
				if (!this.oneWay)
				{
					node2.AddConnection(node, num);
				}
			}
		}

		// Token: 0x06000306 RID: 774 RVA: 0x00010ADC File Offset: 0x0000ECDC
