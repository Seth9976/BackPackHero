...
namespace Pathfinding
{
	...
	{
		// Token: 0x06000160 RID: 352 RVA: 0x00006AA4 File Offset: 0x00004CA4
		public RichFunnel()
		{
		...
		// Token: 0x06000161 RID: 353 RVA: 0x00006AF4 File Offset: 0x00004CF4
		...
		// Token: 0x06000162 RID: 354 RVA: 0x00006B43 File Offset: 0x00004D43
		...
		// (get) Token: 0x06000163 RID: 355 RVA: 0x00006B7C File Offset: 0x00004D7C
		...
		// Token: 0x06000164 RID: 356 RVA: 0x00006BA8 File Offset: 0x00004DA8
		...
		// Token: 0x06000165 RID: 357 RVA: 0x00006D70 File Offset: 0x00004F70
		private void SimplifyPath(IRaycastableGraph graph, List<GraphNode> nodes, int start, int end, List<GraphNode> result, Vector3 startPoint, Vector3 endPoint)
		{
			...
			while (num4++ <= 1000)
			{
				...
				{
					int num6 = (k + num5) / 2;
					Vector3 vector = ((start == num3) ? startPoint : ((Vector3)nodes[start].position));
					Vector3 vector2 = ((num6 == end) ? endPoint : ((Vector3)nodes[num6].position));
					GraphHitInfo graphHitInfo2;
					if (graph.Linecast(vector, vector2, out graphHitInfo2, null, null) || graphHitInfo2.node != nodes[num6])
					{
						k = num6;
					}
					else
				...
				{
					Vector3 vector3 = ((start == num3) ? startPoint : ((Vector3)nodes[start].position));
					Vector3 vector4 = ((num5 == end) ? endPoint : ((Vector3)nodes[num5].position));
		...
		// Token: 0x06000166 RID: 358 RVA: 0x0000712C File Offset: 0x0000532C
		...
		// Token: 0x06000167 RID: 359 RVA: 0x000071F4 File Offset: 0x000053F4
		...
		// (get) Token: 0x06000168 RID: 360 RVA: 0x00007230 File Offset: 0x00005430
		public float DistanceToEndOfPath
		{
			get
			{
				TriangleMeshNode triangleMeshNode = this.CurrentNode;
				Vector3 vector = ((triangleMeshNode != null) ? triangleMeshNode.ClosestPointOnNode(this.currentPosition) : this.currentPosition);
				return (this.exactEnd - vector).magnitude;
			}
		}

		// Token: 0x06000169 RID: 361 RVA: 0x00007270 File Offset: 0x00005470
		...
		// Token: 0x0600016A RID: 362 RVA: 0x000072C8 File Offset: 0x000054C8
		...
		// Token: 0x0600016B RID: 363 RVA: 0x000073C4 File Offset: 0x000055C4
		...
		// Token: 0x0600016C RID: 364 RVA: 0x000075E9 File Offset: 0x000057E9
		...
		// Token: 0x0600016D RID: 365 RVA: 0x00007600 File Offset: 0x00005800
		...
		// Token: 0x0600016E RID: 366 RVA: 0x00007884 File Offset: 0x00005A84
