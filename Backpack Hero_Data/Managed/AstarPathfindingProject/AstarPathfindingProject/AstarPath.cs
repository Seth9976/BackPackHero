...
public class AstarPath : VersionedMonoBehaviour
{
	...
	// Token: 0x0600001F RID: 31 RVA: 0x000026BD File Offset: 0x000008BD
	...
	// Token: 0x06000020 RID: 32 RVA: 0x000026C9 File Offset: 0x000008C9
	[Obsolete("This method has been moved. Use the method on the context object that can be sent with work item delegates instead")]
	...
	// Token: 0x06000021 RID: 33 RVA: 0x000026D5 File Offset: 0x000008D5
	public void AddWorkItem(Action callback)
	{
		this.AddWorkItem(new AstarWorkItem(callback, null));
	}

	// Token: 0x06000022 RID: 34 RVA: 0x000026E4 File Offset: 0x000008E4
	public void AddWorkItem(Action<IWorkItemContext> callback)
	{
		this.AddWorkItem(new AstarWorkItem(callback, null));
	}

	// Token: 0x06000023 RID: 35 RVA: 0x000026F3 File Offset: 0x000008F3
	...
	// Token: 0x0600002E RID: 46 RVA: 0x000028AA File Offset: 0x00000AAA
	[Obsolete("Use FlushWorkItems instead")]
	...
	private void InitializePathProcessor()
	{
		...
		bool flag = num > 0;
		this.pathProcessor = new PathProcessor(this, this.pathReturnQueue, num2, flag);
	...
	// Token: 0x06000033 RID: 51 RVA: 0x00002B51 File Offset: 0x00000D51
	...
	// Token: 0x06000034 RID: 52 RVA: 0x00002B8F File Offset: 0x00000D8F
	private void InitializeProfiler()
	{
	}

	// Token: 0x06000035 RID: 53 RVA: 0x00002B91 File Offset: 0x00000D91
	...
	// Token: 0x06000038 RID: 56 RVA: 0x00002CF1 File Offset: 0x00000EF1
	...
	// Token: 0x06000039 RID: 57 RVA: 0x00002CF3 File Offset: 0x00000EF3
	[Obsolete("Not meaningful anymore. The HierarchicalGraph takes care of things automatically behind the scenes")]
	public void FloodFill(GraphNode seed, uint area)
	{
	}

	// Token: 0x0600003A RID: 58 RVA: 0x00002CF5 File Offset: 0x00000EF5
	...
	// Token: 0x0600003B RID: 59 RVA: 0x00002D0D File Offset: 0x00000F0D
	internal int GetNewNodeIndex()
	{
		return this.pathProcessor.GetNewNodeIndex();
	}

	// Token: 0x0600003C RID: 60 RVA: 0x00002D1A File Offset: 0x00000F1A
	internal void InitializeNode(GraphNode node)
	{
		this.pathProcessor.InitializeNode(node);
	}

	// Token: 0x0600003D RID: 61 RVA: 0x00002D28 File Offset: 0x00000F28
	internal void DestroyNode(GraphNode node)
	{
		this.pathProcessor.DestroyNode(node);
	}

	// Token: 0x0600003E RID: 62 RVA: 0x00002D36 File Offset: 0x00000F36
	...
	// Token: 0x0600003F RID: 63 RVA: 0x00002D38 File Offset: 0x00000F38
	public PathProcessor.GraphUpdateLock PausePathfinding()
	{
		return this.pathProcessor.PausePathfinding(true);
	}

	// Token: 0x06000040 RID: 64 RVA: 0x00002D46 File Offset: 0x00000F46
	...
	// Token: 0x06000042 RID: 66 RVA: 0x00002D70 File Offset: 0x00000F70
	...
	// Token: 0x06000044 RID: 68 RVA: 0x00002DEF File Offset: 0x00000FEF
	...
	// Token: 0x06000045 RID: 69 RVA: 0x00002E06 File Offset: 0x00001006
	...
	// Token: 0x06000046 RID: 70 RVA: 0x00002E16 File Offset: 0x00001016
	...
	// Token: 0x06000049 RID: 73 RVA: 0x00002FA8 File Offset: 0x000011A8
	...
	// Token: 0x0600004A RID: 74 RVA: 0x000030B5 File Offset: 0x000012B5
	public NNInfo GetNearest(Vector3 position)
	{
		return this.GetNearest(position, AstarPath.NNConstraintNone);
	}

	// Token: 0x0600004B RID: 75 RVA: 0x000030C3 File Offset: 0x000012C3
