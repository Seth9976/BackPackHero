...
namespace Pathfinding
{
	...
	{
		// Token: 0x060005E6 RID: 1510 RVA: 0x00022262 File Offset: 0x00020462
		...
		// Token: 0x060005E7 RID: 1511 RVA: 0x00022284 File Offset: 0x00020484
		...
		// Token: 0x060005E8 RID: 1512 RVA: 0x00022320 File Offset: 0x00020520
		...
		// Token: 0x060005E9 RID: 1513 RVA: 0x0002239C File Offset: 0x0002059C
		...
		// Token: 0x060005EA RID: 1514 RVA: 0x00022428 File Offset: 0x00020628
		...
		// Token: 0x060005EB RID: 1515 RVA: 0x00022498 File Offset: 0x00020698
		...
		// Token: 0x060005EC RID: 1516 RVA: 0x000224F8 File Offset: 0x000206F8
		...
		// Token: 0x060005ED RID: 1517 RVA: 0x00022630 File Offset: 0x00020830
		...
		// Token: 0x060005EE RID: 1518 RVA: 0x00022768 File Offset: 0x00020968
								...
								for (int m = 0; m < num; m++)
								{
									...
									if (num3 >= 0 && num4 >= 0 && num3 < gridGraph.width && num4 < gridGraph.depth)
									{
										...
										if (gridNodeBase2.Walkable)
										{
											...
											{
												uint num5 = this.costs[gridNodeBase2.NodeIndex * this.pivotCount + n] + gridGraph.neighbourCosts[m];
												this.costs[num2 + n] = Math.Min(this.costs[num2 + n], num5);
											}
										}
									}
								}
								for (int num6 = 0; num6 < this.pivotCount; num6++)
								{
									if (this.costs[num2 + num6] == 4294967295U)
									{
										this.costs[num2 + num6] = 0U;
									}
								}
							}
						}
		...
		// Token: 0x060005EF RID: 1519 RVA: 0x0002297C File Offset: 0x00020B7C
