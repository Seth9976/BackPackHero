...
namespace Pathfinding
{
	...
	{
		// Token: 0x06000450 RID: 1104 RVA: 0x00015627 File Offset: 0x00013827
		...
		// Token: 0x06000451 RID: 1105 RVA: 0x00015635 File Offset: 0x00013835
		...
		// Token: 0x06000452 RID: 1106 RVA: 0x0001565C File Offset: 0x0001385C
		...
		// (get) Token: 0x06000453 RID: 1107 RVA: 0x00015675 File Offset: 0x00013875
		...
		// (get) Token: 0x06000454 RID: 1108 RVA: 0x00015678 File Offset: 0x00013878
		...
		// Token: 0x06000455 RID: 1109 RVA: 0x0001567B File Offset: 0x0001387B
		...
		// Token: 0x06000456 RID: 1110 RVA: 0x00015690 File Offset: 0x00013890
		...
		// (get) Token: 0x06000457 RID: 1111 RVA: 0x000156C7 File Offset: 0x000138C7
		...
		// (get) Token: 0x06000458 RID: 1112 RVA: 0x000156E1 File Offset: 0x000138E1
		// (set) Token: 0x06000459 RID: 1113 RVA: 0x000156E9 File Offset: 0x000138E9
		public Vector2 size { get; protected set; }

		// Token: 0x170000D5 RID: 213
		// (get) Token: 0x0600045A RID: 1114 RVA: 0x000156F2 File Offset: 0x000138F2
		// (set) Token: 0x0600045B RID: 1115 RVA: 0x000156FA File Offset: 0x000138FA
		public GraphTransform transform { get; private set; }

		// Token: 0x170000D6 RID: 214
		// (get) Token: 0x0600045C RID: 1116 RVA: 0x00015703 File Offset: 0x00013903
		// (set) Token: 0x0600045D RID: 1117 RVA: 0x0001572C File Offset: 0x0001392C
		public bool is2D
		{
			get
			{
		...
		// Token: 0x0600045E RID: 1118 RVA: 0x00015790 File Offset: 0x00013990
		public GridGraph()
		{
		...
		// Token: 0x0600045F RID: 1119 RVA: 0x00015889 File Offset: 0x00013A89
		...
		// Token: 0x06000460 RID: 1120 RVA: 0x00015898 File Offset: 0x00013A98
		...
		// Token: 0x06000461 RID: 1121 RVA: 0x00015907 File Offset: 0x00013B07
		...
		// Token: 0x06000462 RID: 1122 RVA: 0x0001592F File Offset: 0x00013B2F
		...
		// Token: 0x06000463 RID: 1123 RVA: 0x00015967 File Offset: 0x00013B67
		...
		// (get) Token: 0x06000464 RID: 1124 RVA: 0x0001599F File Offset: 0x00013B9F
		// (set) Token: 0x06000465 RID: 1125 RVA: 0x000159A7 File Offset: 0x00013BA7
		public int Width
		{
			get
			{
		...
		// (get) Token: 0x06000466 RID: 1126 RVA: 0x000159B0 File Offset: 0x00013BB0
		// (set) Token: 0x06000467 RID: 1127 RVA: 0x000159B8 File Offset: 0x00013BB8
		public int Depth
		{
			get
			{
		...
		// Token: 0x06000468 RID: 1128 RVA: 0x000159C1 File Offset: 0x00013BC1
		public uint GetConnectionCost(int dir)
		{
			return this.neighbourCosts[dir];
		}

		// Token: 0x06000469 RID: 1129 RVA: 0x000159CC File Offset: 0x00013BCC
		...
		public GridNode GetNodeConnection(GridNode node, int dir)
		{
			...
			int num2 = nodeInGridIndex - num * this.Width;
			return this.GetNodeConnection(nodeInGridIndex, num2, num, dir);
		}

		// Token: 0x0600046A RID: 1130 RVA: 0x00015A30 File Offset: 0x00013C30
		[Obsolete("Use GridNode.HasConnectionInDirection instead")]
		public bool HasNodeConnection(GridNode node, int dir)
		{
			...
			int num = nodeInGridIndex / this.Width;
			int num2 = nodeInGridIndex - num * this.Width;
			return this.HasNodeConnection(nodeInGridIndex, num2, num, dir);
		}

		// Token: 0x0600046B RID: 1131 RVA: 0x00015A78 File Offset: 0x00013C78
		...
		public void SetNodeConnection(GridNode node, int dir, bool value)
		{
			...
			int num = nodeInGridIndex / this.Width;
			int num2 = nodeInGridIndex - num * this.Width;
			this.SetNodeConnection(nodeInGridIndex, num2, num, dir, value);
		}

		// Token: 0x0600046C RID: 1132 RVA: 0x00015AAC File Offset: 0x00013CAC
		[Obsolete("Use GridNode.HasConnectionInDirection instead")]
		...
		// Token: 0x0600046D RID: 1133 RVA: 0x00015B1B File Offset: 0x00013D1B
		[Obsolete("Use GridNode.SetConnectionInternal instead")]
		...
		// Token: 0x0600046E RID: 1134 RVA: 0x00015B34 File Offset: 0x00013D34
		[Obsolete("Use GridNode.HasConnectionInDirection instead")]
		...
		// Token: 0x0600046F RID: 1135 RVA: 0x00015B8C File Offset: 0x00013D8C
		...
		// Token: 0x06000470 RID: 1136 RVA: 0x00015C2F File Offset: 0x00013E2F
		...
		// Token: 0x06000471 RID: 1137 RVA: 0x00015C53 File Offset: 0x00013E53
		...
		// Token: 0x06000472 RID: 1138 RVA: 0x00015C6D File Offset: 0x00013E6D
		...
		// Token: 0x06000473 RID: 1139 RVA: 0x00015C75 File Offset: 0x00013E75
		...
		// Token: 0x06000474 RID: 1140 RVA: 0x00015C9C File Offset: 0x00013E9C
		public GraphTransform CalculateTransform()
		{
			...
			matrix4x = Matrix4x4.Scale(new Vector3(Mathf.Cos(0.017453292f * this.isometricAngle), 1f, 1f)) * matrix4x;
			matrix4x = Matrix4x4.TRS(Vector3.zero, Quaternion.Euler(0f, -45f, 0f), Vector3.one) * matrix4x;
			return new GraphTransform(Matrix4x4.TRS((Matrix4x4.TRS(this.center, Quaternion.Euler(this.rotation), new Vector3(this.aspectRatio, 1f, 1f)) * matrix4x).MultiplyPoint3x4(-new Vector3((float)num * num3, 0f, (float)num2 * num3) * 0.5f), Quaternion.Euler(this.rotation), new Vector3(num3 * this.aspectRatio, 1f, num3)) * matrix4x);
		}

		// Token: 0x06000475 RID: 1141 RVA: 0x00015DB8 File Offset: 0x00013FB8
		...
		// Token: 0x06000476 RID: 1142 RVA: 0x00015F10 File Offset: 0x00014110
		public override NNInfoInternal GetNearest(Vector3 position, NNConstraint constraint, GraphNode hint)
		{
			...
			NNInfoInternal nninfoInternal = new NNInfoInternal(this.nodes[num2 * this.width + num]);
			float y = this.transform.InverseTransform((Vector3)this.nodes[num2 * this.width + num].position).y;
			nninfoInternal.clampedPosition = this.transform.Transform(new Vector3(Mathf.Clamp(x, (float)num, (float)num + 1f), y, Mathf.Clamp(z, (float)num2, (float)num2 + 1f)));
			return nninfoInternal;
		}

		// Token: 0x06000477 RID: 1143 RVA: 0x00016008 File Offset: 0x00014208
		...
		// Token: 0x06000478 RID: 1144 RVA: 0x00016078 File Offset: 0x00014278
		public override NNInfoInternal GetNearestForce(Vector3 position, NNConstraint constraint)
		{
			...
			for (int i = 0; i < layerCount; i++)
			{
				...
				{
					float num6 = (flag ? (this.nodeSize * this.nodeSize * (((float)num + 0.5f - x) * ((float)num + 0.5f - x) + ((float)num2 + 0.5f - z) * ((float)num2 + 0.5f - z))) : ((Vector3)gridNodeBase2.position - vector).sqrMagnitude);
					if (num6 <= num4)
					{
						num4 = num6;
					...
					for (int k = 0; k < num7; k++)
					{
						if (num8 >= 0 && num9 >= 0 && num8 < this.width && num9 < this.depth)
						{
							...
							for (int l = 0; l < layerCount; l++)
							{
								...
								{
									float num13 = (flag ? (this.nodeSize * this.nodeSize * (((float)num8 + 0.5f - x) * ((float)num8 + 0.5f - x) + ((float)num9 + 0.5f - z) * ((float)num9 + 0.5f - z))) : ((Vector3)gridNodeBase3.position - vector).sqrMagnitude);
									if (num13 <= num4)
									{
										num4 = num13;
			...
			if (gridNodeBase != null)
			{
				...
				nninfoInternal.node = gridNodeBase;
				nninfoInternal.clampedPosition = this.transform.Transform(new Vector3(Mathf.Clamp(x, (float)xcoordinateInGrid, (float)xcoordinateInGrid + 1f), this.transform.InverseTransform((Vector3)gridNodeBase.position).y, Mathf.Clamp(z, (float)zcoordinateInGrid, (float)zcoordinateInGrid + 1f)));
			}
			return nninfoInternal;
		}

		// Token: 0x06000479 RID: 1145 RVA: 0x000163E0 File Offset: 0x000145E0
		...
		// Token: 0x0600047A RID: 1146 RVA: 0x00016570 File Offset: 0x00014770
		...
		// Token: 0x0600047B RID: 1147 RVA: 0x00016580 File Offset: 0x00014780
		...
		// Token: 0x0600047C RID: 1148 RVA: 0x00016590 File Offset: 0x00014790
		public virtual void RecalculateCell(int x, int z, bool resetPenalties = true, bool resetTags = true)
		{
			...
			bool flag;
			Vector3 vector = this.collision.CheckHeight((Vector3)gridNodeBase.position, out raycastHit, out flag);
		...
		// Token: 0x0600047D RID: 1149 RVA: 0x0001670C File Offset: 0x0001490C
		...
		// Token: 0x0600047E RID: 1150 RVA: 0x00016760 File Offset: 0x00014960
		...
		// Token: 0x0600047F RID: 1151 RVA: 0x0001677A File Offset: 0x0001497A
		...
		// Token: 0x06000480 RID: 1152 RVA: 0x000167A4 File Offset: 0x000149A4
		...
		// Token: 0x06000481 RID: 1153 RVA: 0x0001688F File Offset: 0x00014A8F
		public virtual void ErodeWalkableArea()
		{
			this.ErodeWalkableArea(0, 0, this.Width, this.Depth);
		}

		// Token: 0x06000482 RID: 1154 RVA: 0x000168A8 File Offset: 0x00014AA8
		public void ErodeWalkableArea(int xmin, int zmin, int xmax, int zmax)
		{
			...
			IntRect intRect = new IntRect(xmin, zmin, xmax - 1, zmax - 1);
			List<GraphNode> nodesInRegion = this.GetNodesInRegion(intRect);
		...
		// Token: 0x06000483 RID: 1155 RVA: 0x00016A08 File Offset: 0x00014C08
		public virtual bool IsValidConnection(GridNodeBase node1, GridNodeBase node2)
		{
			...
			Vector3 vector2 = (Vector3)node2.position;
			Vector3 vector3 = this.transform.WorldUpAtGraphPosition(vector);
			return Math.Abs(Vector3.Dot(vector3, vector) - Vector3.Dot(vector3, vector2)) <= this.maxClimb;
		}
		...
		// Token: 0x06000485 RID: 1157 RVA: 0x00016B28 File Offset: 0x00014D28
		...
		// Token: 0x06000486 RID: 1158 RVA: 0x00016B3C File Offset: 0x00014D3C
		...
		// Token: 0x06000487 RID: 1159 RVA: 0x00016B68 File Offset: 0x00014D68
		...
		// Token: 0x06000488 RID: 1160 RVA: 0x00016B74 File Offset: 0x00014D74
		public virtual void CalculateConnections(int x, int z)
		{
			...
			if (this.neighbours == NumNeighbours.Four || this.neighbours == NumNeighbours.Eight)
			{
				...
				for (int i = 0; i < 4; i++)
				{
					...
					{
						GridNodeBase gridNodeBase = this.nodes[nodeInGridIndex + this.neighbourOffsets[i]];
						if (this.IsValidConnection(gridNode, gridNodeBase))
						{
							num |= 1 << i;
						}
					}
				...
				if (this.neighbours == NumNeighbours.Eight)
				{
					if (this.cutCorners)
					{
						for (int j = 0; j < 4; j++)
						{
							if ((((num >> j) | (num >> j + 1) | (num >> j + 1 - 4)) & 1) != 0)
							{
								...
								{
									GridNodeBase gridNodeBase2 = this.nodes[nodeInGridIndex + this.neighbourOffsets[num5]];
									if (this.IsValidConnection(gridNode, gridNodeBase2))
									{
										num4 |= 1 << num5;
									}
								}
					...
					else
					{
						for (int k = 0; k < 4; k++)
						{
							...
							{
								GridNodeBase gridNodeBase3 = this.nodes[nodeInGridIndex + this.neighbourOffsets[k + 4]];
								if (this.IsValidConnection(gridNode, gridNodeBase3))
								{
									num4 |= 1 << k + 4;
								}
							}
			...
			for (int l = 0; l < GridGraph.hexagonNeighbourIndices.Length; l++)
			{
				...
				{
					GridNodeBase gridNodeBase4 = this.nodes[nodeInGridIndex + this.neighbourOffsets[num8]];
					gridNode.SetConnectionInternal(num8, this.IsValidConnection(gridNode, gridNodeBase4));
				}
			}
		}

		// Token: 0x06000489 RID: 1161 RVA: 0x00016E00 File Offset: 0x00015000
		...
		// Token: 0x0600048A RID: 1162 RVA: 0x0001712C File Offset: 0x0001532C
		...
		// Token: 0x0600048B RID: 1163 RVA: 0x00017564 File Offset: 0x00015764
		public IntRect GetRectFromBounds(Bounds bounds)
		{
			bounds = this.transform.InverseTransform(bounds);
			Vector3 min = bounds.min;
			Vector3 max = bounds.max;
			int num = Mathf.RoundToInt(min.x - 0.5f);
			int num2 = Mathf.RoundToInt(max.x - 0.5f);
			int num3 = Mathf.RoundToInt(min.z - 0.5f);
			int num4 = Mathf.RoundToInt(max.z - 0.5f);
		...
		// Token: 0x0600048C RID: 1164 RVA: 0x00017600 File Offset: 0x00015800
		...
		// Token: 0x0600048D RID: 1165 RVA: 0x00017609 File Offset: 0x00015809
		[Obsolete("This method has been renamed to GetNodesInRegion", true)]
		...
		// Token: 0x0600048E RID: 1166 RVA: 0x00017612 File Offset: 0x00015812
		[Obsolete("This method has been renamed to GetNodesInRegion", true)]
		...
		// Token: 0x06000492 RID: 1170 RVA: 0x00017708 File Offset: 0x00015908
		...
		// Token: 0x06000493 RID: 1171 RVA: 0x000177C8 File Offset: 0x000159C8
		...
		// Token: 0x06000494 RID: 1172 RVA: 0x00017886 File Offset: 0x00015A86
		...
		// Token: 0x06000495 RID: 1173 RVA: 0x000178B5 File Offset: 0x00015AB5
		GraphUpdateThreading IUpdatableGraph.CanUpdateAsync(GraphUpdateObject o)
		{
			return GraphUpdateThreading.UnityThread;
		}

		// Token: 0x06000496 RID: 1174 RVA: 0x000178B8 File Offset: 0x00015AB8
		void IUpdatableGraph.UpdateAreaInit(GraphUpdateObject o)
		{
		}

		// Token: 0x06000497 RID: 1175 RVA: 0x000178BA File Offset: 0x00015ABA
		void IUpdatableGraph.UpdateAreaPost(GraphUpdateObject o)
		{
		}

		// Token: 0x06000498 RID: 1176 RVA: 0x000178BC File Offset: 0x00015ABC
		protected void CalculateAffectedRegions(GraphUpdateObject o, out IntRect originalRect, out IntRect affectRect, out IntRect physicsRect, out bool willChangeWalkability, out int erosion)
		{
			...
			int num = Mathf.RoundToInt(vector.x - 0.5f);
			int num2 = Mathf.RoundToInt(vector2.x - 0.5f);
			int num3 = Mathf.RoundToInt(vector.z - 0.5f);
			int num4 = Mathf.RoundToInt(vector2.z - 0.5f);
			originalRect = new IntRect(num, num3, num2, num4);
		...
		// Token: 0x06000499 RID: 1177 RVA: 0x00017A88 File Offset: 0x00015C88
		void IUpdatableGraph.UpdateArea(GraphUpdateObject o)
		{
			...
			bool flag;
			int num;
			this.CalculateAffectedRegions(o, out intRect, out intRect2, out intRect3, out flag, out num);
			IntRect intRect4 = new IntRect(0, 0, this.width - 1, this.depth - 1);
			IntRect intRect5 = IntRect.Intersection(intRect2, intRect4);
			for (int i = intRect5.ymin; i <= intRect5.ymax; i++)
			{
				for (int j = intRect5.xmin; j <= intRect5.xmax; j++)
				{
			...
			if (o.updatePhysics && !o.modifyWalkability)
			{
				...
				for (int k = intRect5.ymin; k <= intRect5.ymax; k++)
				{
			...
			if (flag && num > 0)
			{
				...
				for (int num5 = intRect7.xmin; num5 <= intRect7.xmax; num5++)
				{
					for (int num6 = intRect7.ymin; num6 <= intRect7.ymax; num6++)
					{
						...
						if (!intRect6.Contains(num5, num6))
						{
							gridNodeBase2.TmpWalkable = walkable;
						}
					}
				}
				for (int num8 = intRect7.xmin; num8 <= intRect7.xmax; num8++)
				{
					for (int num9 = intRect7.ymin; num9 <= intRect7.ymax; num9++)
					{
						this.CalculateConnections(num8, num9);
					}
				}
				this.ErodeWalkableArea(intRect7.xmin, intRect7.ymin, intRect7.xmax + 1, intRect7.ymax + 1);
				for (int num10 = intRect7.xmin; num10 <= intRect7.xmax; num10++)
				{
					for (int num11 = intRect7.ymin; num11 <= intRect7.ymax; num11++)
					{
						if (!intRect6.Contains(num10, num11))
						{
		...
		// Token: 0x0600049A RID: 1178 RVA: 0x00017E90 File Offset: 0x00016090
		...
		// Token: 0x0600049B RID: 1179 RVA: 0x00017EAC File Offset: 0x000160AC
		...
		// Token: 0x0600049C RID: 1180 RVA: 0x00017EC4 File Offset: 0x000160C4
		[Obsolete("The hint parameter is deprecated")]
		...
		// Token: 0x0600049D RID: 1181 RVA: 0x00017ED2 File Offset: 0x000160D2
		protected static long CrossMagnitude(Int2 a, Int2 b)
		{
			return (long)a.x * (long)b.y - (long)b.x * (long)a.y;
		}

		// Token: 0x0600049E RID: 1182 RVA: 0x00017EF4 File Offset: 0x000160F4
		...
		// Token: 0x0600049F RID: 1183 RVA: 0x000180B0 File Offset: 0x000162B0
		[Obsolete("The hint parameter is deprecated")]
		...
		// Token: 0x060004A0 RID: 1184 RVA: 0x000180C0 File Offset: 0x000162C0
		public bool Linecast(Vector3 from, Vector3 to, out GraphHitInfo hit, List<GraphNode> trace = null, Func<GraphNode, bool> filter = null)
		{
			...
			Vector2 vector5 = new Vector2((float)this.neighbourXOffsets[direction], (float)this.neighbourZOffsets[direction]);
			Vector2 vector6 = new Vector2((float)this.neighbourXOffsets[(direction - 1 + 4) & 3], (float)this.neighbourZOffsets[(direction - 1 + 4) & 3]);
			Vector2 vector7 = new Vector2((float)this.neighbourXOffsets[(direction + 1) & 3], (float)this.neighbourZOffsets[(direction + 1) & 3]);
		...
		// Token: 0x060004A1 RID: 1185 RVA: 0x0001830E File Offset: 0x0001650E
		...
		// Token: 0x060004A2 RID: 1186 RVA: 0x00018348 File Offset: 0x00016548
		...
		// Token: 0x060004A3 RID: 1187 RVA: 0x00018380 File Offset: 0x00016580
		...
		// Token: 0x060004A4 RID: 1188 RVA: 0x000184BC File Offset: 0x000166BC
		...
		// Token: 0x060004A5 RID: 1189 RVA: 0x00018534 File Offset: 0x00016734
		public bool Linecast(GridNodeBase fromNode, Int2 fixedNormalizedFromPoint, GridNodeBase toNode, Int2 fixedNormalizedToPoint, out GridHitInfo hit, List<GraphNode> trace = null, Func<GraphNode, bool> filter = null, bool continuePastEnd = false)
		{
			...
			if (fromNode != toNode)
			{
				Int2 int9 = int4 - (new Int2(fromNode.XCoordinateInGrid * 1024, fromNode.ZCoordinateInGrid * 1024) + new Int2(512, 512));
				if (Mathf.Abs(int9.x) == 512 && Mathf.Abs(int9.y) == 512)
				{
					Int2 int10 = new Int2(int9.x * 2 / 1024, int9.y * 2 / 1024);
					int num13 = -1;
					for (int k = 0; k < 4; k++)
					{
						if (this.neighbourXOffsets[k] + this.neighbourXOffsets[(k + 1) & 3] == int10.x && this.neighbourZOffsets[k] + this.neighbourZOffsets[(k + 1) & 3] == int10.y)
						{
							num13 = k;
							break;
						}
		...
		// Token: 0x060004A6 RID: 1190 RVA: 0x00018C10 File Offset: 0x00016E10
		...
		// Token: 0x060004A7 RID: 1191 RVA: 0x00018CB4 File Offset: 0x00016EB4
		...
		// Token: 0x060004A8 RID: 1192 RVA: 0x00018D0C File Offset: 0x00016F0C
		...
		// Token: 0x060004A9 RID: 1193 RVA: 0x00018D74 File Offset: 0x00016F74
		...
		// Token: 0x060004AA RID: 1194 RVA: 0x00018EF8 File Offset: 0x000170F8
		...
		{
			// Token: 0x06000A55 RID: 2645 RVA: 0x00040E38 File Offset: 0x0003F038
			...
			// Token: 0x06000A56 RID: 2646 RVA: 0x00040EB0 File Offset: 0x0003F0B0
			...
			// Token: 0x06000A57 RID: 2647 RVA: 0x00040F98 File Offset: 0x0003F198
