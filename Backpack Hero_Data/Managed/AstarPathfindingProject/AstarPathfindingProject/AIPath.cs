...
namespace Pathfinding
{
	...
	{
		// Token: 0x060000D6 RID: 214 RVA: 0x00004EDE File Offset: 0x000030DE
		...
		// (get) Token: 0x060000D7 RID: 215 RVA: 0x00004EF0 File Offset: 0x000030F0
		...
		// (get) Token: 0x060000D8 RID: 216 RVA: 0x00004F48 File Offset: 0x00003148
		...
		// (get) Token: 0x060000D9 RID: 217 RVA: 0x00004FFE File Offset: 0x000031FE
		// (set) Token: 0x060000DA RID: 218 RVA: 0x00005006 File Offset: 0x00003206
		public bool reachedEndOfPath { get; protected set; }

		// Token: 0x17000038 RID: 56
		// (get) Token: 0x060000DB RID: 219 RVA: 0x0000500F File Offset: 0x0000320F
		public bool hasPath
		{
			get
			{
		...
		// (get) Token: 0x060000DC RID: 220 RVA: 0x0000501C File Offset: 0x0000321C
		...
		// (get) Token: 0x060000DD RID: 221 RVA: 0x00005024 File Offset: 0x00003224
		...
		// (get) Token: 0x060000DE RID: 222 RVA: 0x00005045 File Offset: 0x00003245
		// (set) Token: 0x060000DF RID: 223 RVA: 0x0000504D File Offset: 0x0000324D
		...
		// (get) Token: 0x060000E0 RID: 224 RVA: 0x00005056 File Offset: 0x00003256
		// (set) Token: 0x060000E1 RID: 225 RVA: 0x0000505E File Offset: 0x0000325E
		...
		// (get) Token: 0x060000E2 RID: 226 RVA: 0x00005067 File Offset: 0x00003267
		// (set) Token: 0x060000E3 RID: 227 RVA: 0x0000506F File Offset: 0x0000326F
		...
		// (get) Token: 0x060000E4 RID: 228 RVA: 0x00005078 File Offset: 0x00003278
		// (set) Token: 0x060000E5 RID: 229 RVA: 0x00005080 File Offset: 0x00003280
		...
		// (get) Token: 0x060000E6 RID: 230 RVA: 0x00005089 File Offset: 0x00003289
		// (set) Token: 0x060000E7 RID: 231 RVA: 0x00005091 File Offset: 0x00003291
		...
		// Token: 0x060000E8 RID: 232 RVA: 0x0000509A File Offset: 0x0000329A
		...
		// Token: 0x060000E9 RID: 233 RVA: 0x000050CE File Offset: 0x000032CE
		...
		// Token: 0x060000EA RID: 234 RVA: 0x00005105 File Offset: 0x00003305
		...
		// Token: 0x060000EC RID: 236 RVA: 0x000052E4 File Offset: 0x000034E4
		...
		// Token: 0x060000ED RID: 237 RVA: 0x0000531C File Offset: 0x0000351C
		protected override void MovementUpdateInternal(float deltaTime, out Vector3 nextPosition, out Quaternion nextRotation)
		{
			...
			Vector2 vector = this.movementPlane.ToPlane(this.steeringTarget - simulatedPosition);
			float num2 = vector.magnitude + Mathf.Max(0f, this.interpolator.remainingDistance);
			...
			Vector2 vector2 = this.movementPlane.ToPlane(this.simulatedRotation * ((this.orientation == OrientationMode.YAxisForward) ? Vector3.up : Vector3.forward));
			...
			if (this.interpolator.valid && !flag)
			{
				...
				{
					this.velocity2D += MovementUtilities.CalculateAccelerationToReachPoint(vector, vector.normalized * this.maxSpeed, this.velocity2D, num, this.rotationSpeed, this.maxSpeed, vector2) * deltaTime;
				}
			}
			else
			{
			...
			this.velocity2D = MovementUtilities.ClampVelocity(this.velocity2D, this.maxSpeed, num3, this.slowWhenNotFacingTarget && this.enableRotation, vector2);
			base.ApplyGravity(deltaTime);
			if (this.rvoController != null && this.rvoController.enabled)
			{
				Vector3 vector3 = simulatedPosition + this.movementPlane.ToWorld(Vector2.ClampMagnitude(this.velocity2D, num2), 0f);
				this.rvoController.SetTarget(vector3, this.velocity2D.magnitude, this.maxSpeed);
			}
			Vector2 vector4 = (this.lastDeltaPosition = base.CalculateDeltaToMoveThisFrame(this.movementPlane.ToPlane(simulatedPosition), num2, deltaTime));
			nextPosition = simulatedPosition + this.movementPlane.ToWorld(vector4, this.verticalVelocity * this.lastDeltaTime);
			this.CalculateNextRotation(num3, out nextRotation);
		}

		// Token: 0x060000EE RID: 238 RVA: 0x00005600 File Offset: 0x00003800
		protected virtual void CalculateNextRotation(float slowdown, out Quaternion nextRotation)
		{
			if (this.lastDeltaTime > 1E-05f && this.enableRotation)
			{
				...
				if (this.rvoController != null && this.rvoController.enabled)
				{
					Vector2 vector = this.lastDeltaPosition / this.lastDeltaTime;
					vector2 = Vector2.Lerp(this.velocity2D, vector, 4f * vector.magnitude / (this.maxSpeed + 0.0001f));
				}
				else
				{
					vector2 = this.velocity2D;
				}
				float num = this.rotationSpeed * Mathf.Max(0f, (slowdown - 0.3f) / 0.7f);
				nextRotation = base.SimulateRotationTowards(vector2, num * this.lastDeltaTime);
				return;
			}
			nextRotation = base.rotation;
		}

		// Token: 0x060000EF RID: 239 RVA: 0x000056C8 File Offset: 0x000038C8
		...
		// Token: 0x060000F0 RID: 240 RVA: 0x000057C2 File Offset: 0x000039C2
		...
		// (get) Token: 0x060000F1 RID: 241 RVA: 0x000057E2 File Offset: 0x000039E2
		...
		// (get) Token: 0x060000F2 RID: 242 RVA: 0x000057EA File Offset: 0x000039EA
		// (set) Token: 0x060000F3 RID: 243 RVA: 0x000057F8 File Offset: 0x000039F8
		...
		// (get) Token: 0x060000F4 RID: 244 RVA: 0x00005807 File Offset: 0x00003A07
		// (set) Token: 0x060000F5 RID: 245 RVA: 0x0000580F File Offset: 0x00003A0F
		...
		// (get) Token: 0x060000F6 RID: 246 RVA: 0x00005818 File Offset: 0x00003A18
		...
		// Token: 0x060000F7 RID: 247 RVA: 0x00005843 File Offset: 0x00003A43
