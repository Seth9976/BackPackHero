...
namespace Pathfinding
{
	...
	{
		// Token: 0x0600028A RID: 650 RVA: 0x0000E180 File Offset: 0x0000C380
		...
		// Token: 0x0600028B RID: 651 RVA: 0x0000E232 File Offset: 0x0000C432
		public virtual void Reset()
		{
			this.lastRepathTime = float.NegativeInfinity;
		}

		// Token: 0x0600028C RID: 652 RVA: 0x0000E23F File Offset: 0x0000C43F
		...
		// Token: 0x0600028D RID: 653 RVA: 0x0000E254 File Offset: 0x0000C454
		public void DrawGizmos(Vector3 position, float radius)
		{
			if (this.visualizeSensitivity && !float.IsPositiveInfinity(this.lastDestination.x))
			{
				...
				Draw.Gizmos.CircleXZ(this.lastDestination, num, Color.magenta, 0f, 6.2831855f);
			}
		}
