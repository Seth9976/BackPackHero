...
namespace Pathfinding
{
	...
	public abstract class AIBase : VersionedMonoBehaviour
	{
		...
		// (get) Token: 0x0600005B RID: 91 RVA: 0x0000354D File Offset: 0x0000174D
		// (set) Token: 0x0600005C RID: 92 RVA: 0x0000355A File Offset: 0x0000175A
		...
		// (get) Token: 0x0600005D RID: 93 RVA: 0x00003568 File Offset: 0x00001768
		// (set) Token: 0x0600005E RID: 94 RVA: 0x00003578 File Offset: 0x00001778
		...
		// (get) Token: 0x0600005F RID: 95 RVA: 0x000035A3 File Offset: 0x000017A3
		// (set) Token: 0x06000060 RID: 96 RVA: 0x000035B1 File Offset: 0x000017B1
		...
		// (get) Token: 0x06000061 RID: 97 RVA: 0x000035C0 File Offset: 0x000017C0
		// (set) Token: 0x06000062 RID: 98 RVA: 0x000035CB File Offset: 0x000017CB
		...
		// (get) Token: 0x06000063 RID: 99 RVA: 0x000035DA File Offset: 0x000017DA
		...
		// (get) Token: 0x06000064 RID: 100 RVA: 0x000035F6 File Offset: 0x000017F6
		// (set) Token: 0x06000065 RID: 101 RVA: 0x00003612 File Offset: 0x00001812
		...
		// (get) Token: 0x06000066 RID: 102 RVA: 0x00003630 File Offset: 0x00001830
		// (set) Token: 0x06000067 RID: 103 RVA: 0x00003638 File Offset: 0x00001838
		protected bool usingGravity { get; set; }

		// Token: 0x17000017 RID: 23
		// (get) Token: 0x06000068 RID: 104 RVA: 0x00003644 File Offset: 0x00001844
		// (set) Token: 0x06000069 RID: 105 RVA: 0x0000366C File Offset: 0x0000186C
		...
		// (get) Token: 0x0600006A RID: 106 RVA: 0x000036CE File Offset: 0x000018CE
		// (set) Token: 0x0600006B RID: 107 RVA: 0x000036D6 File Offset: 0x000018D6
		public Vector3 destination { get; set; }

		// Token: 0x17000019 RID: 25
		// (get) Token: 0x0600006C RID: 108 RVA: 0x000036DF File Offset: 0x000018DF
		...
		// (get) Token: 0x0600006D RID: 109 RVA: 0x00003710 File Offset: 0x00001910
		...
		// (get) Token: 0x0600006E RID: 110 RVA: 0x00003747 File Offset: 0x00001947
		// (set) Token: 0x0600006F RID: 111 RVA: 0x0000374F File Offset: 0x0000194F
		public bool isStopped { get; set; }

		// Token: 0x1700001C RID: 28
		// (get) Token: 0x06000070 RID: 112 RVA: 0x00003758 File Offset: 0x00001958
		// (set) Token: 0x06000071 RID: 113 RVA: 0x00003760 File Offset: 0x00001960
		public Action onSearchPath { get; set; }

		// Token: 0x1700001D RID: 29
		// (get) Token: 0x06000072 RID: 114 RVA: 0x00003769 File Offset: 0x00001969
		...
		// Token: 0x06000073 RID: 115 RVA: 0x00003794 File Offset: 0x00001994
		protected AIBase()
		{
			this.destination = new Vector3(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity);
		}

		// Token: 0x06000074 RID: 116 RVA: 0x0000385C File Offset: 0x00001A5C
		...
		// Token: 0x06000075 RID: 117 RVA: 0x000038B1 File Offset: 0x00001AB1
		...
		// Token: 0x06000076 RID: 118 RVA: 0x000038E7 File Offset: 0x00001AE7
		...
		// Token: 0x06000077 RID: 119 RVA: 0x000038F6 File Offset: 0x00001AF6
		private void Init()
		{
			if (this.startHasRun)
			{
		...
		// Token: 0x06000078 RID: 120 RVA: 0x00003930 File Offset: 0x00001B30
		...
		// Token: 0x06000079 RID: 121 RVA: 0x0000399A File Offset: 0x00001B9A
		...
		// Token: 0x0600007A RID: 122 RVA: 0x000039C0 File Offset: 0x00001BC0
		...
		// Token: 0x0600007B RID: 123 RVA: 0x00003A2C File Offset: 0x00001C2C
		...
		// Token: 0x0600007C RID: 124 RVA: 0x00003AE4 File Offset: 0x00001CE4
		protected virtual void FixedUpdate()
		{
			if ((!(this.rigid == null) || !(this.rigid2D == null)) && this.canMove)
			{
				Vector3 vector;
				Quaternion quaternion;
				this.MovementUpdate(Time.fixedDeltaTime, out vector, out quaternion);
				this.FinalizeMovement(vector, quaternion);
			}
		}

		// Token: 0x0600007D RID: 125 RVA: 0x00003B2C File Offset: 0x00001D2C
		...
		// Token: 0x06000080 RID: 128 RVA: 0x00003B58 File Offset: 0x00001D58
		...
		// Token: 0x06000081 RID: 129 RVA: 0x00003BA6 File Offset: 0x00001DA6
		...
		// Token: 0x06000084 RID: 132 RVA: 0x00003BB0 File Offset: 0x00001DB0
		...
		// Token: 0x06000085 RID: 133 RVA: 0x00003C6C File Offset: 0x00001E6C
		...
		// Token: 0x06000086 RID: 134 RVA: 0x00003CE0 File Offset: 0x00001EE0
		...
		// Token: 0x06000087 RID: 135 RVA: 0x00003D43 File Offset: 0x00001F43
		...
		// Token: 0x06000088 RID: 136 RVA: 0x00003D58 File Offset: 0x00001F58
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00003DD6 File Offset: 0x00001FD6
		public virtual void Move(Vector3 deltaPosition)
		{
			this.accumulatedMovementDelta += deltaPosition;
		}

		// Token: 0x0600008A RID: 138 RVA: 0x00003DEA File Offset: 0x00001FEA
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00003E04 File Offset: 0x00002004
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00003E70 File Offset: 0x00002070
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00003FDF File Offset: 0x000021DF
		...
		// Token: 0x06000090 RID: 144 RVA: 0x00004097 File Offset: 0x00002297
		...
		// Token: 0x06000091 RID: 145 RVA: 0x000040A8 File Offset: 0x000022A8
		...
		// Token: 0x06000092 RID: 146 RVA: 0x000041D7 File Offset: 0x000023D7
		...
		// Token: 0x06000093 RID: 147 RVA: 0x000041E8 File Offset: 0x000023E8
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00004230 File Offset: 0x00002430
