...
namespace Pathfinding
{
	...
	{
		// Token: 0x06000154 RID: 340 RVA: 0x0000660B File Offset: 0x0000480B
		public RichPath()
		{
			this.Clear();
		}

		// Token: 0x06000155 RID: 341 RVA: 0x00006624 File Offset: 0x00004824
		public void Clear()
		{
			this.parts.Clear();
			this.currentPart = 0;
		...
		// Token: 0x06000156 RID: 342 RVA: 0x00006654 File Offset: 0x00004854
		public void Initialize(Seeker seeker, Path path, bool mergePartEndpoints, bool simplificationMode)
		{
			...
			for (int j = 0; j < path2.Count; j++)
			{
				...
				else if (NodeLink2.GetNodeLink(path2[j]) != null)
				{
					...
					if (j - num2 != 0)
					{
						RichSpecial richSpecial2 = ObjectPool<RichSpecial>.Claim().Initialize(nodeLink, path2[num2]);
		...
		// (get) Token: 0x06000157 RID: 343 RVA: 0x00006955 File Offset: 0x00004B55
		// (set) Token: 0x06000158 RID: 344 RVA: 0x0000695D File Offset: 0x00004B5D
		public Vector3 Endpoint { get; private set; }

		// Token: 0x17000071 RID: 113
		// (get) Token: 0x06000159 RID: 345 RVA: 0x00006966 File Offset: 0x00004B66
		...
		// (get) Token: 0x0600015A RID: 346 RVA: 0x0000697E File Offset: 0x00004B7E
		...
		// Token: 0x0600015B RID: 347 RVA: 0x00006998 File Offset: 0x00004B98
		public void NextPart()
		{
			this.currentPart = Mathf.Min(this.currentPart + 1, this.parts.Count);
		}

		// Token: 0x0600015C RID: 348 RVA: 0x000069B8 File Offset: 0x00004BB8
		...
		// Token: 0x0600015D RID: 349 RVA: 0x00006A14 File Offset: 0x00004C14
