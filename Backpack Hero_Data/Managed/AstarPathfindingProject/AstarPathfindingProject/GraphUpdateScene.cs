...
namespace Pathfinding
{
	...
	{
		// Token: 0x06000267 RID: 615 RVA: 0x0000C140 File Offset: 0x0000A340
		public void Start()
		{
		...
		// Token: 0x06000268 RID: 616 RVA: 0x0000C160 File Offset: 0x0000A360
		...
		// Token: 0x0600026A RID: 618 RVA: 0x0000C1C8 File Offset: 0x0000A3C8
		public void RecalcConvex()
		{
			this.convexPoints = (this.convex ? Polygon.ConvexHullXZ(this.points) : null);
		}

		// Token: 0x0600026B RID: 619 RVA: 0x0000C1E6 File Offset: 0x0000A3E6
		...
		// Token: 0x0600026C RID: 620 RVA: 0x0000C1E8 File Offset: 0x0000A3E8
		[Obsolete("The Y coordinate is no longer important. Use the position of the object instead", true)]
		public void LockToY()
		{
		}

		// Token: 0x0600026D RID: 621 RVA: 0x0000C1EC File Offset: 0x0000A3EC
		...
		// Token: 0x0600026E RID: 622 RVA: 0x0000C330 File Offset: 0x0000A530
		public void Apply()
		{
		...
		// Token: 0x0600026F RID: 623 RVA: 0x0000C5B4 File Offset: 0x0000A7B4
		private void OnDrawGizmos()
		{
			this.OnDrawGizmos(false);
		}

		// Token: 0x06000270 RID: 624 RVA: 0x0000C5BD File Offset: 0x0000A7BD
		private void OnDrawGizmosSelected()
		{
			this.OnDrawGizmos(true);
		}

		// Token: 0x06000271 RID: 625 RVA: 0x0000C5C8 File Offset: 0x0000A7C8
		private void OnDrawGizmos(bool selected)
		{
			...
			if (selected && array != null && array.Length != 0)
			{
				...
				for (int l = 0; l < array.Length; l++)
				{
					...
					Vector3 vector3 = matrix4x.MultiplyPoint3x4(array[num4] + Vector3.up * (num - array[num4].y));
					Vector3 vector4 = matrix4x.MultiplyPoint3x4(array[num4] + Vector3.up * (num2 - array[num4].y));
		...
		// Token: 0x06000272 RID: 626 RVA: 0x0000C9B4 File Offset: 0x0000ABB4
		...
		// Token: 0x06000273 RID: 627 RVA: 0x0000CA1B File Offset: 0x0000AC1B
