...
namespace Pathfinding
{
	...
	{
		// Token: 0x0600030A RID: 778 RVA: 0x00010B60 File Offset: 0x0000ED60
		...
		// (get) Token: 0x0600030B RID: 779 RVA: 0x00010B7C File Offset: 0x0000ED7C
		...
		// (get) Token: 0x0600030C RID: 780 RVA: 0x00010B84 File Offset: 0x0000ED84
		...
		// (get) Token: 0x0600030D RID: 781 RVA: 0x00010B8C File Offset: 0x0000ED8C
		// (set) Token: 0x0600030E RID: 782 RVA: 0x00010B94 File Offset: 0x0000ED94
		public PointNode startNode { get; private set; }

		// Token: 0x1700009E RID: 158
		// (get) Token: 0x0600030F RID: 783 RVA: 0x00010B9D File Offset: 0x0000ED9D
		// (set) Token: 0x06000310 RID: 784 RVA: 0x00010BA5 File Offset: 0x0000EDA5
		public PointNode endNode { get; private set; }

		// Token: 0x1700009F RID: 159
		// (get) Token: 0x06000311 RID: 785 RVA: 0x00010BAE File Offset: 0x0000EDAE
		...
		// (get) Token: 0x06000312 RID: 786 RVA: 0x00010BB6 File Offset: 0x0000EDB6
		...
		// Token: 0x06000313 RID: 787 RVA: 0x00010BBE File Offset: 0x0000EDBE
		public override void OnPostScan()
		{
			this.InternalOnPostScan();
		}

		// Token: 0x06000314 RID: 788 RVA: 0x00010BC8 File Offset: 0x0000EDC8
		...
		// Token: 0x06000315 RID: 789 RVA: 0x00010D48 File Offset: 0x0000EF48
		...
		// Token: 0x06000316 RID: 790 RVA: 0x00010DB0 File Offset: 0x0000EFB0
		...
		// Token: 0x06000317 RID: 791 RVA: 0x00010E18 File Offset: 0x0000F018
		...
		// Token: 0x06000318 RID: 792 RVA: 0x00010EEA File Offset: 0x0000F0EA
		private void RemoveConnections(GraphNode node)
		{
			node.ClearConnections(true);
		}

		// Token: 0x06000319 RID: 793 RVA: 0x00010EF3 File Offset: 0x0000F0F3
		...
		// Token: 0x0600031A RID: 794 RVA: 0x00010F04 File Offset: 0x0000F104
		public void Apply(bool forceNewCheck)
		{
			...
			this.startNode.AddConnection(this.endNode, num);
			this.endNode.AddConnection(this.startNode, num);
		...
		// Token: 0x0600031C RID: 796 RVA: 0x00011189 File Offset: 0x0000F389
		public void OnDrawGizmos()
		{
			this.OnDrawGizmos(false);
		}

		// Token: 0x0600031D RID: 797 RVA: 0x00011194 File Offset: 0x0000F394
		...
		// Token: 0x0600031E RID: 798 RVA: 0x00011310 File Offset: 0x0000F510
		...
		// Token: 0x0600031F RID: 799 RVA: 0x000113D8 File Offset: 0x0000F5D8
		internal static void DeserializeReferences(GraphSerializationContext ctx)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				if (!GraphModifier.usedIDs.TryGetValue(num2, out graphModifier))
				{
