...
namespace Pathfinding.Util
{
	...
	{
		// Token: 0x060008C1 RID: 2241 RVA: 0x0003B13C File Offset: 0x0003933C
		...
		// Token: 0x060008C2 RID: 2242 RVA: 0x0003B175 File Offset: 0x00039375
		...
		// Token: 0x060008C3 RID: 2243 RVA: 0x0003B185 File Offset: 0x00039385
		...
		// Token: 0x060008C4 RID: 2244 RVA: 0x0003B199 File Offset: 0x00039399
		...
		// Token: 0x060008C5 RID: 2245 RVA: 0x0003B1C2 File Offset: 0x000393C2
		public bool HasCachedMesh(RetainedGizmos.Hasher hasher)
		{
			return this.existingHashes.Contains(hasher.Hash);
		}

		// Token: 0x060008C6 RID: 2246 RVA: 0x0003B1D6 File Offset: 0x000393D6
		...
		// Token: 0x060008C7 RID: 2247 RVA: 0x0003B1F4 File Offset: 0x000393F4
		...
		// Token: 0x060008C8 RID: 2248 RVA: 0x0003B234 File Offset: 0x00039434
		public void FinalizeDraw()
		{
			this.RemoveUnusedMeshes(this.meshes);
			Plane[] array = GeometryUtility.CalculateFrustumPlanes(Camera.current);
			...
			for (int i = 0; i <= 1; i++)
			{
				...
				for (int j = 0; j < material.passCount; j++)
				{
					...
					{
						if (this.meshes[k].lines == (material == this.lineMaterial) && GeometryUtility.TestPlanesAABB(array, this.meshes[k].mesh.bounds))
						{
		...
		// Token: 0x060008C9 RID: 2249 RVA: 0x0003B338 File Offset: 0x00039538
		...
		// Token: 0x060008CA RID: 2250 RVA: 0x0003B374 File Offset: 0x00039574
		...
		{
			// Token: 0x06000B27 RID: 2855 RVA: 0x00045E4C File Offset: 0x0004404C
			...
			// Token: 0x06000B28 RID: 2856 RVA: 0x00045EEA File Offset: 0x000440EA
			public void AddHash(int hash)
			{
				this.hash = (1572869UL * this.hash) ^ (ulong)((long)hash);
			}

			// Token: 0x06000B29 RID: 2857 RVA: 0x00045F04 File Offset: 0x00044104
			...
			// (get) Token: 0x06000B2A RID: 2858 RVA: 0x00045F80 File Offset: 0x00044180
			public ulong Hash
			{
				get
				{
		...
		{
			// Token: 0x06000B2B RID: 2859 RVA: 0x00045F88 File Offset: 0x00044188
			...
			// Token: 0x06000B2C RID: 2860 RVA: 0x00045FC8 File Offset: 0x000441C8
			...
			// Token: 0x06000B2D RID: 2861 RVA: 0x000462F4 File Offset: 0x000444F4
			...
			// Token: 0x06000B2E RID: 2862 RVA: 0x00046338 File Offset: 0x00044538
			...
			// Token: 0x06000B2F RID: 2863 RVA: 0x00046358 File Offset: 0x00044558
			...
			// Token: 0x06000B30 RID: 2864 RVA: 0x000463C0 File Offset: 0x000445C0
			private void SubmitLines(RetainedGizmos gizmos, ulong hash)
			{
				...
				for (int i = 0; i < num; i++)
				{
					...
					{
						Vector3 vector = this.lines[j];
						list.Add(vector);
						list.Add(vector);
						Color32 color = this.lineColors[j];
						list2.Add(color);
						list2.Add(color);
					...
					{
						Vector3 vector2 = this.lines[k + 1] - this.lines[k];
						list3.Add(vector2);
						list3.Add(vector2);
						list3.Add(vector2);
						list3.Add(vector2);
			...
			// Token: 0x06000B31 RID: 2865 RVA: 0x00046623 File Offset: 0x00044823
