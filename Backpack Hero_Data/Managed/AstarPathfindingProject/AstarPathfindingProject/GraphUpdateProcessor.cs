...
namespace Pathfinding
{
	...
	internal class GraphUpdateProcessor
	{
		...
		// (add) Token: 0x060002AF RID: 687 RVA: 0x0000ECE8 File Offset: 0x0000CEE8
		// (remove) Token: 0x060002B0 RID: 688 RVA: 0x0000ED20 File Offset: 0x0000CF20
		public event Action OnGraphsUpdated;

		// Token: 0x1700008E RID: 142
		// (get) Token: 0x060002B1 RID: 689 RVA: 0x0000ED55 File Offset: 0x0000CF55
		...
		// (get) Token: 0x060002B2 RID: 690 RVA: 0x0000ED65 File Offset: 0x0000CF65
		...
		// Token: 0x060002B3 RID: 691 RVA: 0x0000ED70 File Offset: 0x0000CF70
		public GraphUpdateProcessor(AstarPath astar)
		{
			this.astar = astar;
		}

		// Token: 0x060002B4 RID: 692 RVA: 0x0000EDDA File Offset: 0x0000CFDA
		...
		// Token: 0x060002B5 RID: 693 RVA: 0x0000EDFC File Offset: 0x0000CFFC
		...
		// Token: 0x060002B6 RID: 694 RVA: 0x0000EE6C File Offset: 0x0000D06C
		...
		// Token: 0x060002B7 RID: 695 RVA: 0x0000EEBD File Offset: 0x0000D0BD
		public void AddToQueue(GraphUpdateObject ob)
		{
			this.graphUpdateQueue.Enqueue(ob);
		}

		// Token: 0x060002B8 RID: 696 RVA: 0x0000EECC File Offset: 0x0000D0CC
			...
			while (this.graphUpdateQueue.Count > 0)
			{
				...
				else
				{
					...
					foreach (object obj in this.astar.data.GetUpdateableGraphs())
					{
						...
						if (graphUpdateObject.nnConstraint == null || graphUpdateObject.nnConstraint.SuitableGraph(this.astar.data.GetGraphIndex(navGraph), navGraph))
						{
							GraphUpdateProcessor.GUOSingle guosingle = default(GraphUpdateProcessor.GUOSingle);
							guosingle.order = GraphUpdateProcessor.GraphUpdateOrder.GraphUpdate;
		...
		// Token: 0x060002B9 RID: 697 RVA: 0x0000EFE4 File Offset: 0x0000D1E4
		...
		// Token: 0x060002BA RID: 698 RVA: 0x0000F048 File Offset: 0x0000D248
		private bool ProcessRegularUpdates(bool force)
		{
			while (this.graphUpdateQueueRegular.Count > 0)
			{
				...
				else
				{
					...
					{
						string text = "Error while updating graphs\n";
						Exception ex2 = ex;
		...
		// Token: 0x060002BB RID: 699 RVA: 0x0000F188 File Offset: 0x0000D388
		...
		// Token: 0x060002BC RID: 700 RVA: 0x0000F1B4 File Offset: 0x0000D3B4
		private void ProcessPostUpdates()
		{
			while (this.graphUpdateQueuePost.Count > 0)
			{
				...
				if ((guosingle.graph.CanUpdateAsync(guosingle.obj) & GraphUpdateThreading.UnityPost) != GraphUpdateThreading.UnityThread)
				{
					...
					{
						string text = "Error while updating graphs (post step)\n";
						Exception ex2 = ex;
						Debug.LogError(text + ((ex2 != null) ? ex2.ToString() : null));
					}
				}
		...
		// Token: 0x060002BD RID: 701 RVA: 0x0000F248 File Offset: 0x0000D448
		private void ProcessGraphUpdatesAsync()
		{
			AutoResetEvent[] array = new AutoResetEvent[] { this.graphUpdateAsyncEvent, this.exitAsyncThread };
			for (;;)
			{
				WaitHandle[] array2 = array;
				if (WaitHandle.WaitAny(array2) == 1)
				{
					break;
				}
				while (this.graphUpdateQueueAsync.Count > 0)
				{
					...
					{
						string text = "Exception while updating graphs:\n";
						Exception ex2 = ex;
						Debug.LogError(text + ((ex2 != null) ? ex2.ToString() : null));
					}
				}
