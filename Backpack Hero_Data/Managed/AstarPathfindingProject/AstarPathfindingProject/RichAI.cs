...
namespace Pathfinding
{
	...
	public class RichAI : AIBase, IAstarAI
	{
		...
		// (get) Token: 0x0600011C RID: 284 RVA: 0x000058B4 File Offset: 0x00003AB4
		// (set) Token: 0x0600011D RID: 285 RVA: 0x000058BC File Offset: 0x00003ABC
		public bool traversingOffMeshLink { get; protected set; }

		// Token: 0x17000057 RID: 87
		// (get) Token: 0x0600011E RID: 286 RVA: 0x000058C5 File Offset: 0x00003AC5
		...
		// (get) Token: 0x0600011F RID: 287 RVA: 0x000058E4 File Offset: 0x00003AE4
		...
		// (get) Token: 0x06000120 RID: 288 RVA: 0x00005900 File Offset: 0x00003B00
		...
		// (get) Token: 0x06000121 RID: 289 RVA: 0x000059B1 File Offset: 0x00003BB1
		public bool hasPath
		{
			get
			{
		...
		// (get) Token: 0x06000122 RID: 290 RVA: 0x000059C1 File Offset: 0x00003BC1
		...
		// (get) Token: 0x06000123 RID: 291 RVA: 0x000059D3 File Offset: 0x00003BD3
		// (set) Token: 0x06000124 RID: 292 RVA: 0x000059DB File Offset: 0x00003BDB
		public Vector3 steeringTarget { get; protected set; }

		// Token: 0x1700005D RID: 93
		// (get) Token: 0x06000125 RID: 293 RVA: 0x000059E4 File Offset: 0x00003BE4
		// (set) Token: 0x06000126 RID: 294 RVA: 0x000059EC File Offset: 0x00003BEC
		...
		// (get) Token: 0x06000127 RID: 295 RVA: 0x000059F5 File Offset: 0x00003BF5
		// (set) Token: 0x06000128 RID: 296 RVA: 0x000059FD File Offset: 0x00003BFD
		...
		// (get) Token: 0x06000129 RID: 297 RVA: 0x00005A06 File Offset: 0x00003C06
		// (set) Token: 0x0600012A RID: 298 RVA: 0x00005A0E File Offset: 0x00003C0E
		...
		// (get) Token: 0x0600012B RID: 299 RVA: 0x00005A17 File Offset: 0x00003C17
		// (set) Token: 0x0600012C RID: 300 RVA: 0x00005A1F File Offset: 0x00003C1F
		...
		// (get) Token: 0x0600012D RID: 301 RVA: 0x00005A28 File Offset: 0x00003C28
		// (set) Token: 0x0600012E RID: 302 RVA: 0x00005A30 File Offset: 0x00003C30
		...
		// (get) Token: 0x0600012F RID: 303 RVA: 0x00005A39 File Offset: 0x00003C39
		...
		// (get) Token: 0x06000130 RID: 304 RVA: 0x00005A53 File Offset: 0x00003C53
		...
		// Token: 0x06000131 RID: 305 RVA: 0x00005A6C File Offset: 0x00003C6C
		public override void Teleport(Vector3 newPosition, bool clearPath = true)
		{
			...
			newPosition = this.movementPlane.ToWorld(this.movementPlane.ToPlane((nninfo.node != null) ? nninfo.position : newPosition), num);
			base.Teleport(newPosition, clearPath);
		}

		// Token: 0x06000132 RID: 306 RVA: 0x00005ADE File Offset: 0x00003CDE
		...
		// (get) Token: 0x06000133 RID: 307 RVA: 0x00005AF3 File Offset: 0x00003CF3
		...
		// Token: 0x06000134 RID: 308 RVA: 0x00005B08 File Offset: 0x00003D08
		...
		// Token: 0x06000135 RID: 309 RVA: 0x00005B20 File Offset: 0x00003D20
		...
		// Token: 0x06000136 RID: 310 RVA: 0x00005C58 File Offset: 0x00003E58
		...
		// Token: 0x06000137 RID: 311 RVA: 0x00005C84 File Offset: 0x00003E84
		...
		// Token: 0x06000138 RID: 312 RVA: 0x00005CD0 File Offset: 0x00003ED0
		public void GetRemainingPath(List<Vector3> buffer, out bool stale)
		{
			this.richPath.GetRemainingPath(buffer, this.simulatedPosition, out stale);
		}

		// Token: 0x06000139 RID: 313 RVA: 0x00005CE5 File Offset: 0x00003EE5
		protected virtual void OnTargetReached()
		{
		}

		// Token: 0x0600013A RID: 314 RVA: 0x00005CE8 File Offset: 0x00003EE8
		...
		// Token: 0x0600013B RID: 315 RVA: 0x00005D34 File Offset: 0x00003F34
		...
		// Token: 0x0600013C RID: 316 RVA: 0x00005E38 File Offset: 0x00004038
		...
		// Token: 0x0600013D RID: 317 RVA: 0x00006074 File Offset: 0x00004274
		private void FinalMovement(Vector3 position3D, float deltaTime, float distanceToEndOfPath, float slowdownFactor, out Vector3 nextPosition, out Quaternion nextRotation)
		{
			...
			this.velocity2D = MovementUtilities.ClampVelocity(this.velocity2D, this.maxSpeed, slowdownFactor, this.slowWhenNotFacingTarget && this.enableRotation, vector);
			...
			if (this.rvoController != null && this.rvoController.enabled)
			{
				...
				this.rvoController.SetTarget(vector2, this.velocity2D.magnitude, this.maxSpeed);
			}
			Vector2 vector3 = (this.lastDeltaPosition = base.CalculateDeltaToMoveThisFrame(this.movementPlane.ToPlane(position3D), distanceToEndOfPath, deltaTime));
			float num = (this.approachingPartEndpoint ? Mathf.Clamp01(1.1f * slowdownFactor - 0.1f) : 1f);
			nextRotation = (this.enableRotation ? base.SimulateRotationTowards(vector3, this.rotationSpeed * num * deltaTime) : this.simulatedRotation);
		...
		// Token: 0x0600013F RID: 319 RVA: 0x00006298 File Offset: 0x00004498
		...
		// Token: 0x06000140 RID: 320 RVA: 0x000063EB File Offset: 0x000045EB
		...
		// Token: 0x06000141 RID: 321 RVA: 0x00006401 File Offset: 0x00004601
		...
		// Token: 0x06000142 RID: 322 RVA: 0x00006418 File Offset: 0x00004618
		protected override void OnDrawGizmos()
		{
			...
			if (this.tr != null)
			{
				...
				{
					Gizmos.DrawLine(vector, this.nextCorners[i]);
					vector = this.nextCorners[i];
				}
			}
		}

		// Token: 0x06000143 RID: 323 RVA: 0x0000647F File Offset: 0x0000467F
		...
		// Token: 0x06000144 RID: 324 RVA: 0x000064A6 File Offset: 0x000046A6
		...
		// (get) Token: 0x06000145 RID: 325 RVA: 0x000064AE File Offset: 0x000046AE
		...
		// (get) Token: 0x06000146 RID: 326 RVA: 0x000064B6 File Offset: 0x000046B6
		...
		// (get) Token: 0x06000147 RID: 327 RVA: 0x000064BE File Offset: 0x000046BE
		...
		// (set) Token: 0x06000149 RID: 329 RVA: 0x000064CE File Offset: 0x000046CE
		...
		// (get) Token: 0x0600014A RID: 330 RVA: 0x000064D7 File Offset: 0x000046D7
		...
		// (get) Token: 0x0600014B RID: 331 RVA: 0x000064DF File Offset: 0x000046DF
		...
		// (get) Token: 0x0600014C RID: 332 RVA: 0x000064E7 File Offset: 0x000046E7
		...
		// (get) Token: 0x0600014D RID: 333 RVA: 0x000064EF File Offset: 0x000046EF
		...
		// (get) Token: 0x0600014E RID: 334 RVA: 0x000064F7 File Offset: 0x000046F7
		...
		// (get) Token: 0x0600014F RID: 335 RVA: 0x000064FF File Offset: 0x000046FF
		...
		// (get) Token: 0x06000150 RID: 336 RVA: 0x00006508 File Offset: 0x00004708
		// (set) Token: 0x06000151 RID: 337 RVA: 0x00006530 File Offset: 0x00004730
