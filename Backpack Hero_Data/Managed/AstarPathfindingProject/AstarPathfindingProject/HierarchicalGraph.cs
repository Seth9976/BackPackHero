...
namespace Pathfinding
{
	...
	public class HierarchicalGraph
	{
		...
		// (get) Token: 0x060002C1 RID: 705 RVA: 0x0000F8FD File Offset: 0x0000DAFD
		// (set) Token: 0x060002C2 RID: 706 RVA: 0x0000F905 File Offset: 0x0000DB05
		public int version { get; private set; }

		// Token: 0x060002C3 RID: 707 RVA: 0x0000F910 File Offset: 0x0000DB10
		...
		// Token: 0x060002C4 RID: 708 RVA: 0x0000F99C File Offset: 0x0000DB9C
		private void Grow()
		{
		...
		// Token: 0x060002C5 RID: 709 RVA: 0x0000FA6D File Offset: 0x0000DC6D
		...
		// Token: 0x060002C6 RID: 710 RVA: 0x0000FA90 File Offset: 0x0000DC90
		...
		// Token: 0x060002C7 RID: 711 RVA: 0x0000FAE8 File Offset: 0x0000DCE8
		public void AddDirtyNode(GraphNode node)
		{
			if (!node.IsHierarchicalNodeDirty)
			{
				...
				for (int i = this.numDirtyNodes - 1; i >= 0; i--)
				{
					...
					{
						num = Math.Max(num, this.dirtyNodes[i].NodeIndex);
					}
				}
				if (this.numDirtyNodes >= this.dirtyNodes.Length)
				{
		...
		// (get) Token: 0x060002C8 RID: 712 RVA: 0x0000FC1F File Offset: 0x0000DE1F
		// (set) Token: 0x060002C9 RID: 713 RVA: 0x0000FC27 File Offset: 0x0000DE27
		public int NumConnectedComponents { get; private set; }

		// Token: 0x060002CA RID: 714 RVA: 0x0000FC30 File Offset: 0x0000DE30
		public uint GetConnectedComponent(int hierarchicalNodeIndex)
		{
			return (uint)this.areas[hierarchicalNodeIndex];
		}

		// Token: 0x060002CB RID: 715 RVA: 0x0000FC3C File Offset: 0x0000DE3C
		...
		// Token: 0x060002CC RID: 716 RVA: 0x0000FCF4 File Offset: 0x0000DEF4
		...
		// Token: 0x060002CD RID: 717 RVA: 0x0000FE0A File Offset: 0x0000E00A
		...
		// Token: 0x060002CE RID: 718 RVA: 0x0000FE30 File Offset: 0x0000E030
		...
		// Token: 0x060002CF RID: 719 RVA: 0x0000FF1C File Offset: 0x0000E11C
		...
		// Token: 0x060002D0 RID: 720 RVA: 0x0000FFC0 File Offset: 0x0000E1C0
