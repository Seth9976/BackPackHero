...
namespace Newtonsoft.Json.Utilities
{
	...
	internal class DictionaryWrapper<[Nullable(2)] TKey, [Nullable(2)] TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IWrappedDictionary, IDictionary, ICollection
	{
		...
		{
			// Token: 0x06000E8A RID: 3722 RVA: 0x00040BCF File Offset: 0x0003EDCF
			...
			// (get) Token: 0x06000E8B RID: 3723 RVA: 0x00040BE3 File Offset: 0x0003EDE3
			...
			// (get) Token: 0x06000E8C RID: 3724 RVA: 0x00040BF0 File Offset: 0x0003EDF0
			public object Key
			{
				get
				{
			...
			// (get) Token: 0x06000E8D RID: 3725 RVA: 0x00040C0C File Offset: 0x0003EE0C
			[Nullable(2)]
			public object Value
			{
				[NullableContext(2)]
			...
			// (get) Token: 0x06000E8E RID: 3726 RVA: 0x00040C28 File Offset: 0x0003EE28
			...
			// Token: 0x06000E8F RID: 3727 RVA: 0x00040C6F File Offset: 0x0003EE6F
			public bool MoveNext()
			{
				return this._e.MoveNext();
			}

			// Token: 0x06000E90 RID: 3728 RVA: 0x00040C7C File Offset: 0x0003EE7C
			public void Reset()
			{
				this._e.Reset();
			}
